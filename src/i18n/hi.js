const hi = {
  ...
  login: {
    ...
    liveRegisteredUsers: "पंजीकृत उपयोगकर्ता",
    liveActiveSessions: "सक्रिय सत्र",
    liveActiveUsers: "सक्रिय उपयोगकर्ता",
    liveTodayLogins: "आज के लॉगिन",
    liveSystemOverview: "लाइव सिस्टम अवलोकन",
    loadingUpdates: "लाइव आँकड़े लोड हो रहे हैं...",
    ...
    resending:      "OTP फिर से भेजा जा रहा है...",
    errBadAdmin:    "अमान्य एडमिन क्रेडेंशियल",
    captchaLabel:      "सुरक्षा जाँच",
    captchaPlaceholder: "दिखाए गए अक्षर दर्ज करें",
    captchaRefresh:    "नया कैप्चा प्राप्त करें",
    captchaImageAlt:   "कैप्चा चुनौती छवि",
    errNoCaptcha:      "कृपया कैप्चा अक्षर दर्ज करें",
