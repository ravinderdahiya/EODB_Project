import{n as e,t}from"./glsl-CZeEFwwf.js";import{t as n}from"./Texture2DPassUniform-DCwp0q5e.js";import{t as r}from"./ShaderBuilder-BD7C14Uw.js";import{t as i}from"./Float2BindUniform-BK0Wrw5L.js";import{t as a}from"./Float4BindUniform-BzrSQY4y.js";import{t as o}from"./Float4PassUniform-iUfyTgdX.js";import{t as s}from"./FloatBindUniform-n4-aKqpp.js";import{a as c,i as l,n as u}from"./AlphaCutoff-D6cnd-Fm.js";import{t as d}from"./Matrix4BindUniform-MGEAzz9Q.js";import{i as f,n as p,r as m}from"./View.glsl-CxBWIcJZ.js";import{c as h,l as g,s as _,t as v}from"./MarkerSizing.glsl-BLZZvNZD.js";import{t as y}from"./PositionOutsideClipSpace-Bm_C1Qyt.js";import{t as b}from"./TerrainDepthTest.glsl--gBh0EAm.js";import{t as x}from"./OutputColorHighlightOLID.glsl-Ddid31RH.js";function S(S){let C=new r,{space:w,anchor:T,hasTip:E,hasScreenSizePerspective:D}=S,O=w===2,k=w===1;C.include(g,S),C.include(v,S),C.include(b,S);let{vertex:A,fragment:j,varyings:M}=C;p(A,S),C.attributes.add(`position`,`vec3`),C.attributes.add(`previousDelta`,`vec4`),C.attributes.add(`uv0`,`vec2`),M.add(`vColor`,`vec4`),M.add(`vpos`,`vec3`,{invariant:!0}),M.add(`vUV`,`vec2`),M.add(`vSize`,`float`),E&&M.add(`vLineWidth`,`float`),A.uniforms.add(new i(`nearFar`,({camera:e})=>e.nearFar),new a(`viewport`,({camera:e})=>e.fullViewport)).code.add(e`vec4 projectAndScale(vec4 pos) {
