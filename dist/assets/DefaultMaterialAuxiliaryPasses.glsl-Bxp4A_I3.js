import{l as e}from"./mat3-CMvmoTJl.js";import{t}from"./mat3f64-g_wzqeq6.js";import{s as n}from"./vec3f64-ZsvGlTgL.js";import{r}from"./mat4f64-n7SXiDG4.js";import{i}from"./vec4f64-Es8dc9j1.js";import{j as a}from"./vec3-DXY1fyTv.js";import{r as o}from"./Emissions.glsl-D9qW6cHW.js";import{n as s,t as c}from"./glsl-CZeEFwwf.js";import{t as l}from"./FloatPassUniform-KxAVdYC6.js";import{t as u}from"./Texture2DPassUniform-DCwp0q5e.js";import{n as d,o as f,s as p}from"./MaterialUtil-fFsiyCIj.js";import{t as m}from"./Float3BindUniform-sv4UGxo1.js";import"./NoParameters-B4f79CN4.js";import{a as h,n as g,t as _}from"./AlphaCutoff-D6cnd-Fm.js";import{t as v}from"./Matrix4PassUniform-DsTlu458.js";import{t as y}from"./IntegerPassUniform-Cizr9Znn.js";import{t as b}from"./ObjectAndLayerIdColor.glsl-DgsRiF2c.js";import{a as x,n as S,r as C,t as w}from"./VisualVariables.glsl-CXkEeP3u.js";import{t as T}from"./Matrix3PassUniform-CqxUfccM.js";import{n as E,r as D}from"./View.glsl-CxBWIcJZ.js";import{a as O,i as k,n as A,o as j,r as M,t as N}from"./Transform.glsl-BJzODRDo.js";import{s as P}from"./SnowCover.glsl-Cwnuj8BL.js";function F(e,t){switch(e.fragment.code.add(s`vec3 screenDerivativeNormal(vec3 positionView) {
...
return normal;
      ...
      `);break}case 2:e.vertex.code.add(s`void forwardNormal() {}`);break;default:t.normalType;case 3:}}var L=class extends k{constructor(){super(...arguments),this.transformNormalViewFromGlobal=t()}},R=class extends M{constructor(){super(...arguments),this.transformNormalGlobalFromModel=t(),this.toMapSpace=i()}};function z(e){e.vertex.code.add(s`vec4 offsetBackfacingClipPosition(vec4 posClip, vec3 posWorld, vec3 normalWorld, vec3 camPosWorld) {
...
return color;
}`)}var V=t();function H(t,n){let{hasModelTransformation:i,instancedDoublePrecision:o,instanced:c,output:l,hasVertexTangents:u}=n;i&&(t.vertex.uniforms.add(new v(`model`,e=>e.modelTransformation??r)),t.vertex.uniforms.add(new T(`normalLocalOriginFromModel`,t=>(e(V,t.modelTransformation??r),V)))),c&&o&&(t.attributes.add(`instanceModelOriginHi`,`vec3`),t.attributes.add(`instanceModelOriginLo`,`vec3`),t.attributes.add(`instanceModel`,`mat3`),t.attributes.add(`instanceModelNormal`,`mat3`));let d=t.vertex;o&&(d.include(j,n),d.uniforms.add(new m(`viewOriginHi`,e=>f(a(U,e.camera.viewInverseTransposeMatrix[3],e.camera.viewInverseTransposeMatrix[7],e.camera.viewInverseTransposeMatrix[11]),U)),new m(`viewOriginLo`,e=>p(a(U,e.camera.viewInverseTransposeMatrix[3],e.camera.viewInverseTransposeMatrix[7],e.camera.viewInverseTransposeMatrix[11]),U)))),d.code.add(s`
    vec3 getVertexInLocalOriginSpace() {
      return ${i?o?`(model * vec4(instanceModel * localPosition().xyz, 1.0)).xyz`:`(model * localPosition()).xyz`:o?`instanceModel * localPosition().xyz`:`localPosition().xyz`};
    }
    ...
    vec3 dpNormal(vec4 _normal) {
      return normalize(${i?o?`normalLocalOriginFromModel * (instanceModelNormal * _normal.xyz)`:`normalLocalOriginFromModel * _normal.xyz`:o?`instanceModelNormal * _normal.xyz`:`_normal.xyz`});
    }
    `),l===2&&(D(d),d.code.add(s`
    vec3 dpNormalView(vec4 _normal) {
      return normalize((viewNormal * ${i?o?`vec4(normalLocalOriginFromModel * (instanceModelNormal * _normal.xyz), 1.0)`:`vec4(normalLocalOriginFromModel * _normal.xyz, 1.0)`:o?`vec4(instanceModelNormal * _normal.xyz, 1.0)`:`_normal`}).xyz);
    }
    `)),u&&d.code.add(s`
    vec4 dpTransformVertexTangent(vec4 _tangent) {
      ${i?o?`return vec4(normalLocalOriginFromModel * (instanceModelNormal * _tangent.xyz), _tangent.w);`:`return vec4(normalLocalOriginFromModel * _tangent.xyz, _tangent.w);`:o?`return vec4(instanceModelNormal * _tangent.xyz, _tangent.w);`:`return _tangent;`}
