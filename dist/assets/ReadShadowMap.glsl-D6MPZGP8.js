import{s as e}from"./vec3f64-ZsvGlTgL.js";import{l as t}from"./vec4-BvJ9kaiU.js";import{i as n}from"./vec4f64-Es8dc9j1.js";import{j as r}from"./vec3-DXY1fyTv.js";import{c as i}from"./Emissions.glsl-D9qW6cHW.js";import{n as a,t as o}from"./glsl-CZeEFwwf.js";import{t as s}from"./Uniform-DjJlclQi.js";import{t as c}from"./Float4BindUniform-BzrSQY4y.js";import{t as l}from"./Float3BindUniform-sv4UGxo1.js";import{t as u}from"./FloatBindUniform-n4-aKqpp.js";import"./NoParameters-B4f79CN4.js";import{r as d}from"./AlphaCutoff-D6cnd-Fm.js";import{t as f}from"./PiUtils.glsl-DXfhsELo.js";import{s as p}from"./Transform.glsl-BJzODRDo.js";var m=3e5,h=5e5;function g(e,n){let i=n.lightingSphericalHarmonicsOrder===void 0?2:n.lightingSphericalHarmonicsOrder;i===0?(e.uniforms.add(new l(`lightingAmbientSH0`,({lighting:e})=>r(_,e.sh.r[0],e.sh.g[0],e.sh.b[0]))),e.code.add(a`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
vec3 ambientLight = 0.282095 * lightingAmbientSH0;
return ambientLight * (1.0 - ambientOcclusion);
}`)):i===1?(e.uniforms.add(new c(`lightingAmbientSH_R`,({lighting:e})=>t(v,e.sh.r[0],e.sh.r[1],e.sh.r[2],e.sh.r[3])),new c(`lightingAmbientSH_G`,({lighting:e})=>t(v,e.sh.g[0],e.sh.g[1],e.sh.g[2],e.sh.g[3])),new c(`lightingAmbientSH_B`,({lighting:e})=>t(v,e.sh.b[0],e.sh.b[1],e.sh.b[2],e.sh.b[3]))),e.code.add(a`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
vec4 sh0 = vec4(
0.282095,
0.488603 * normal.x,
0.488603 * normal.z,
...
return ambientLight * (1.0 - ambientOcclusion);
}`)):i===2&&(e.uniforms.add(new l(`lightingAmbientSH0`,({lighting:e})=>r(_,e.sh.r[0],e.sh.g[0],e.sh.b[0])),new c(`lightingAmbientSH_R1`,({lighting:e})=>t(v,e.sh.r[1],e.sh.r[2],e.sh.r[3],e.sh.r[4])),new c(`lightingAmbientSH_G1`,({lighting:e})=>t(v,e.sh.g[1],e.sh.g[2],e.sh.g[3],e.sh.g[4])),new c(`lightingAmbientSH_B1`,({lighting:e})=>t(v,e.sh.b[1],e.sh.b[2],e.sh.b[3],e.sh.b[4])),new c(`lightingAmbientSH_R2`,({lighting:e})=>t(v,e.sh.r[5],e.sh.r[6],e.sh.r[7],e.sh.r[8])),new c(`lightingAmbientSH_G2`,({lighting:e})=>t(v,e.sh.g[5],e.sh.g[6],e.sh.g[7],e.sh.g[8])),new c(`lightingAmbientSH_B2`,({lighting:e})=>t(v,e.sh.b[5],e.sh.b[6],e.sh.b[7],e.sh.b[8]))),e.code.add(a`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
vec3 ambientLight = 0.282095 * lightingAmbientSH0;
vec4 sh1 = vec4(
0.488603 * normal.x,
0.488603 * normal.z,
