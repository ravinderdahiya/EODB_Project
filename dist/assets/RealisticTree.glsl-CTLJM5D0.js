import{c as e,r as t}from"./Emissions.glsl-D9qW6cHW.js";import{n,t as r}from"./glsl-CZeEFwwf.js";import{t as i}from"./Float3PassUniform-Ds5PNw16.js";import{t as a}from"./FloatPassUniform-KxAVdYC6.js";import{t as o}from"./Texture2DPassUniform-DCwp0q5e.js";import{t as s}from"./ShaderBuilder-BD7C14Uw.js";import{n as c}from"./MaterialUtil-fFsiyCIj.js";import{t as l}from"./Float4PassUniform-iUfyTgdX.js";import{a as u,t as d}from"./AlphaCutoff-D6cnd-Fm.js";import{a as f,i as p,t as m}from"./VisualVariables.glsl-CXkEeP3u.js";import{n as h,t as g}from"./View.glsl-CxBWIcJZ.js";import{t as _}from"./MixExternalColor.glsl-DwWNg--g.js";import{t as v}from"./TerrainDepthTest.glsl--gBh0EAm.js";import{t as y}from"./OutputColorHighlightOLID.glsl-Ddid31RH.js";import{r as b}from"./VerticalOffset.glsl-Bo2jTuvH.js";import{t as x}from"./Transform.glsl-BJzODRDo.js";import{t as S}from"./VertexColor.glsl-CNUI8W2h.js";import{a as C,i as w,n as T,o as E,r as D,t as O,u as k}from"./DefaultMaterialAuxiliaryPasses.glsl-Bxp4A_I3.js";import{a as A,i as j,n as ee,o as M,r as N,t as P}from"./SnowCover.glsl-Cwnuj8BL.js";import{a as F,c as I,n as L,s as R,t as z}from"./ReadShadowMap.glsl-D6MPZGP8.js";function B(B){let V=new s,{attributes:H,vertex:U,fragment:W,varyings:G}=V,{output:K,offsetBackfaces:q,pbrMode:J,snowCover:Y,spherical:X}=B,Z=J===1||J===2;if(h(U,B),H.add(`position`,`vec3`),G.add(`vpos`,`vec3`,{invariant:!0}),V.include(m,B),V.include(w,B),V.include(b,B),V.include(v,B),!e(K))return V.include(O,B),V;g(V.vertex,B),V.include(k,B),V.include(x),q&&V.include(E),G.add(`vNormalWorld`,`vec3`),G.add(`localvpos`,`vec3`,{invariant:!0}),V.include(t,B),V.include(D,B),V.include(C,B),V.include(S,B),U.include(f),U.include(p),U.uniforms.add(new l(`externalColor`,e=>e.externalColor,{supportsNaN:!0})),G.add(`vcolorExt`,`vec4`),V.include(B.instancedDoublePrecision?L:z,B),U.main.add(n`
    forwardVertexColor();
