import{r as e}from"./tslib.es6-DgcZaHPs.js";import{t}from"./uid-CHKGnCFt.js";import{W as n}from"./BufferView-DJSECair.js";import{r}from"./Util-BttsHn2D.js";import{n as i,t as a}from"./glsl-CZeEFwwf.js";import{t as o}from"./Uniform-DjJlclQi.js";import{t as s}from"./ShaderBuilder-BD7C14Uw.js";import{t as c}from"./Float4PassUniform-iUfyTgdX.js";import{t as l}from"./FloatBindUniform-n4-aKqpp.js";import{a as u,c as d,i as f,l as p}from"./AlphaCutoff-D6cnd-Fm.js";import{n as m}from"./InterleavedLayout-DCnrC1lH.js";import{d as h}from"./FloatsPassUniform-Bi2BtJqH.js";import{t as g}from"./DefaultTechniqueConfiguration-CbSI3IZp.js";import{t as ee}from"./ObjectAndLayerIdColor.glsl-DgsRiF2c.js";import{t as te}from"./VisualVariables.glsl-CXkEeP3u.js";import{n as _,t as v}from"./View.glsl-CxBWIcJZ.js";import{t as y}from"./TerrainDepthTest.glsl--gBh0EAm.js";import{t as b}from"./OutputColorHighlightOLID.glsl-Ddid31RH.js";import{t as x}from"./Transform.glsl-BJzODRDo.js";import{t as S}from"./VertexColor.glsl-CNUI8W2h.js";import{t as C}from"./TextureBackedBufferLayout-Dty1mSKZ.js";var w=class extends g{constructor(){super(...arguments),this.cullFace=0,this.style=0,this.hasVertexColors=!1,this.polygonOffset=!1,this.hasOccludees=!1,this.enableOffset=!0,this.terrainDepthTest=!1,this.cullAboveTerrain=!1,this.hasVVColor=!1,this.draped=!1,this.textureCoordinateType=0,this.emissionSource=0,this.discardInvisibleFragments=!0,this.writeDepth=!0,this.occlusionPass=!1,this.hasVVInstancing=!1,this.hasVVSize=!1,this.hasVVOpacity=!1,this.overlayEnabled=!1,this.snowCover=!1}};function T(e,t,n,r){return e.draped?null:e.hasVVColor?r:e.hasVertexColors?n:t}e([p({count:3})],w.prototype,`cullFace`,void 0),e([p({count:6})],w.prototype,`style`,void 0),e([p()],w.prototype,`hasVertexColors`,void 0),e([p()],w.prototype,`polygonOffset`,void 0),e([p()],w.prototype,`hasOccludees`,void 0),e([p()],w.prototype,`enableOffset`,void 0),e([p()],w.prototype,`terrainDepthTest`,void 0),e([p()],w.prototype,`cullAboveTerrain`,void 0),e([p()],w.prototype,`hasVVColor`,void 0),e([p()],w.prototype,`draped`,void 0);function E(e){let t=m().vec3f(`position`).vec4f(`uvMapSpace`);return e.draped?e.hasVVColor?t.f32(`colorFeatureAttribute`):e.hasVertexColors&&t.vec4u8(`color`,{glNormalized:!0}):t.u32(`textureElementIndex`,{integer:!0}),h()&&t.vec4u8(`olidColor`),t.freeze()}var D=[{type:`mat3f32`,name:`boundingRect`}],O=new C(D),k=new C([...D,{type:`vec4unorm8`,name:`color`}]),A=new C([...D,{type:`f32`,name:`colorFeatureAttribute`}]);function ne(e){return T(e,O,k,A)}function re(e){switch(e.elementType){case`float`:switch(e.elementCount){case 1:return i`float`;case 2:return i`vec2`;case 3:return i`vec3`;case 4:return i`vec4`;case 9:return i`mat3`;default:e.elementCount}break;case`int`:switch(e.elementCount){case 1:return i`int`;case 2:return i`ivec2`;case 3:return i`ivec3`;case 4:return i`ivec4`;case 9:throw Error(`Invalid element count 9 for type int`);default:e.elementCount}break;case`uint`:switch(e.elementCount){case 1:return i`uint`;case 2:return i`uvec2`;case 3:return i`uvec3`;case 4:return i`uvec4`;case 9:throw Error(`Invalid element count 9 for type uint`);default:e.elementCount}break;default:e.elementType}throw Error(`unsupported field`)}var j=new l(`const_NaN`,()=>NaN,{supportsNaN:!0}),M=class extends d{constructor(e){super(),this.supportNaN=e}};function N(e,t){let n=t?.supportNaN;n&&(e.uniforms.add(j),e.code.add(i`bool bitsEncodeFloat16NaN(highp uint bits) {
