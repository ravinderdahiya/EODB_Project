import{t as e}from"./Error-79tAgsas.js";import{P as t}from"./typedArrayUtil-BImOrzpw.js";import{r as n}from"./tslib.es6-DgcZaHPs.js";import{r,s as i}from"./vec3f64-ZsvGlTgL.js";import{t as a}from"./mat4f64-n7SXiDG4.js";import{x as o}from"./mat4-ZV3cCRdK.js";import{j as s,r as c,x as l,y as u}from"./vec3-DXY1fyTv.js";import{n as d}from"./glsl-CZeEFwwf.js";import{t as f}from"./Uniform-DjJlclQi.js";import{t as p}from"./Float3DrawUniform-u0T7dNdr.js";import{t as m}from"./Texture2DBindUniform-D_NEwgVg.js";import{t as h}from"./NoParameters-B4f79CN4.js";import{t as g}from"./HighlightReadBitmap.glsl-DU0RGns5.js";var _=class{constructor(e){this._bits=[...e]}equals(e){return t(this._bits,e.bits)}get code(){return this._code??=String.fromCharCode(...this._bits),this._code}get bits(){return this._bits}},v=class extends h{constructor(){super(),this._parameterBits=this._parameterBits?.map(()=>0)??[],this._parameterNames??=[]}get key(){return this._key??=new _(this._parameterBits),this._key}decode(e=this.key){let t=this._parameterBits;this._parameterBits=[...e.bits];let n=this._parameterNames.map(e=>`    ${e}: ${this[e]}`).join(`
`);return this._parameterBits=t,n}};function y(t={}){return(n,r)=>{n.hasOwnProperty(`_parameterNames`)||Object.defineProperty(n,`_parameterNames`,{value:n._parameterNames?.slice()??[],configurable:!0,writable:!0}),n.hasOwnProperty(`_parameterBits`)||Object.defineProperty(n,`_parameterBits`,{value:n._parameterBits?.slice()??[0],configurable:!0,writable:!0}),n._parameterNames.push(r);let i=t.count||2,a=Math.ceil(Math.log2(i)),o=n._parameterBits,s=0;for(;o[s]+a>16;)s++,s>=o.length&&o.push(0);let c=o[s],l=(1<<a)-1<<c;o[s]+=a,t.count?Object.defineProperty(n,r,{get(){return(this._parameterBits[s]&l)>>c},set(n){let i=this._parameterBits[s];if((i&l)>>c!==n){if(this._key=null,this._parameterBits[s]=i&~l|+n<<c&l,typeof n!=`number`)throw new e(`internal:invalid-shader-configuration`,`Configuration value for ${r} must be a number, got ${typeof n}`);if(t.count==null)throw new e(`internal:invalid-shader-configuration`,`Configuration value for ${r} must provide a count option`)}}}):Object.defineProperty(n,r,{get(){return!!((this._parameterBits[s]&l)>>c)},set(t){let n=this._parameterBits[s];if(!!((n&l)>>c)!==t&&(this._key=null,this._parameterBits[s]=n&~l|+t<<c,typeof t!=`boolean`))throw new e(`internal:invalid-shader-configurationx`,`Configuration value for ${r} must be boolean, got ${typeof t}`)}})}}var b=class extends v{constructor(){super(...arguments),this.output=0,this.hasEmission=!1}};n([y({count:10})],b.prototype,`output`,void 0),n([y()],b.prototype,`hasEmission`,void 0);var x=class extends b{constructor(){super(...arguments),this.instancedDoublePrecision=!1,this.hasModelTransformation=!1}},S=class extends x{constructor(){super(...arguments),this.hasSlicePlane=!1,this.hasSliceTranslatedView=!1}};n([y()],S.prototype,`hasSlicePlane`,void 0);function C(e,t){D(e,t,new p(`slicePlaneOrigin`,(e,n)=>j(t,e,n)),new p(`slicePlaneBasis1`,(e,n)=>M(t,e,n,n.slicePlane?.basis1)),new p(`slicePlaneBasis2`,(e,n)=>M(t,e,n,n.slicePlane?.basis2)))}function w(e,t){E(e,t,new p(`slicePlaneOrigin`,(e,n)=>j(t,e,n)),new p(`slicePlaneBasis1`,(e,n)=>M(t,e,n,n.slicePlane?.basis1)),new p(`slicePlaneBasis2`,(e,n)=>M(t,e,n,n.slicePlane?.basis2)))}var T=d`struct SliceFactors {
float front;
float side0;
float side1;
float side2;
