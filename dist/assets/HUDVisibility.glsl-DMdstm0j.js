import{n as e}from"./glsl-CZeEFwwf.js";import{t}from"./FloatPassUniform-KxAVdYC6.js";import{t as n}from"./Float4BindUniform-BzrSQY4y.js";import{t as r}from"./Texture2DBindUniform-D_NEwgVg.js";import{t as i}from"./FloatBindUniform-n4-aKqpp.js";import{n as a,t as o}from"./ScreenSizePerspective.glsl-DlGz_vE5.js";import{i as s,n as c,r as l,t as u}from"./View.glsl-CxBWIcJZ.js";import{n as d}from"./VerticalOffset.glsl-Bo2jTuvH.js";import{t as f}from"./BooleanBindUniform-6vKkzZHD.js";var p=.5;function m(r,f){r.include(a),r.attributes.add(`position`,`vec3`),r.attributes.add(`normal`,`vec3`),r.attributes.add(`centerOffsetAndDistance`,`vec4`);let p=r.vertex;c(p,f),u(p,f),p.uniforms.add(new n(`viewport`,e=>e.camera.fullViewport),new t(`polygonOffset`,e=>e.shaderPolygonOffset),new i(`aboveGround`,e=>e.camera.aboveGround?1:-1)),f.hasVerticalOffset&&d(p),p.code.add(e`struct ProjectHUDAux {
vec3 posModel;
vec3 posView;
vec3 vnormal;
