...
import { n as slotChangeHasContent, t as toAriaBoolean } from "../../chunks/dom.js";
const SLOTS = {
  input: "input"
};
const CSS = {
...
class SegmentedControlItem extends LitElement {
  ...
  static {
    this.properties = { hasSlottedContent: [16, {}, { state: true }], appearance: 1, checked: [7, {}, { reflect: true, type: Boolean }], iconEnd: [3, { type: String }, { reflect: true }], iconFlipRtl: [7, {}, { reflect: true, type: Boolean }], iconStart: [3, { type: String }, { reflect: true }], layout: 1, scale: 1, value: 1 };
  }
  static {
    this.styles = styles;
  }
