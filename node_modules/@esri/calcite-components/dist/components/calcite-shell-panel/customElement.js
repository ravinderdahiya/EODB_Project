    ...
    switch (key) {
      case "ArrowUp":
        this.updateSizeInternal({
          block: rect.height + (layout === "horizontal" && position === "end" ? stepValue : -stepValue)
        });
      ...
      case "ArrowLeft":
        this.updateSizeInternal({
          inline: rect.width + (layout === "vertical" && position === "end" ? stepValue : -stepValue) * invertRTL
        });
        event.preventDefault();
        break;
      case "ArrowRight":
        ...
        break;
      case "Home":
        this.updateSizeInternal(layout === "horizontal" ? { block: minBlockSize } : { inline: minInlineSize });
        event.preventDefault();
        break;
      case "End":
        this.updateSizeInternal(layout === "horizontal" ? { block: maxBlockSize } : { inline: maxInlineSize });
        event.preventDefault();
        break;
    }
  }
