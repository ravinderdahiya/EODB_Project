...
import { a as dateToISO } from "../../chunks/date.js";
import { c as closestElementCrossShadowBoundary, t as toAriaBoolean } from "../../chunks/dom.js";
...
class DatePickerDay extends LitElement {
  ...
  render() {
    ...
    return this.interactiveContainer({ disabled: this.disabled, children: html`<div aria-hidden=true class=${safeClassMap(CSS.dayWrapper)}><span class=${safeClassMap(CSS.day)}><span class=${safeClassMap(CSS.text)}>${formattedDay}</span></span></div>` });
  }
}
