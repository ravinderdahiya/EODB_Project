...
import { b as getSupportedNumberingSystem, c as getDateFormatSupportedLocale, n as numberStringFormatter } from "../../chunks/locale.js";
import { t as toggleOpenClose } from "../../chunks/openCloseComponent.js";
import { g as getValueAsDateRange, a as applyLocaleOverride, b as getLocaleData } from "../../chunks/utils3.js";
...
class InputDatePicker extends LitElement {
  ...
  handleDateTimeFormatChange() {
    ...
    this.dateTimeFormat = new Intl.DateTimeFormat(getDateFormatSupportedLocale(applyLocaleOverride(this.messages._lang)), formattingOptions);
  }
  setReferenceEl() {
