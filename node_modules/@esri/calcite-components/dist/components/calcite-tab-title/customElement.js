...
import { o as nodeListToArray, g as getElementDir, t as toAriaBoolean } from "../../chunks/dom.js";
...
class TabTitle extends LitElement {
  ...
  renderCloseButton() {
    ...
    return closable ? keyed("close-button", html`<calcite-action class=${safeClassMap(CSS.close)} icon=x @click=${this.closeClickHandler} .scale=${this.scale} .text=${messages.close} ${ref(this.closeButtonRef)}></calcite-action>`) : null;
  }
}
