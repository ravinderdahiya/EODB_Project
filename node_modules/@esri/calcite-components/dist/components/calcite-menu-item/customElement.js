...
class MenuItem extends LitElement {
  ...
  clickHandler(event) {
    if (this.href && event.target === this.dropdownActionRef.value || !this.href && this.hasSubmenu) {
      this.open = !this.open;
    }
