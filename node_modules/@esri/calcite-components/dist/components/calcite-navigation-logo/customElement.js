...
class NavigationLogo extends LitElement {
  ...
  static {
    this.properties = { active: [7, {}, { reflect: true, type: Boolean }], description: 1, heading: 1, headingLevel: [11, {}, { type: Number, reflect: true }], href: [3, {}, { reflect: true }], icon: [3, { type: String }, { reflect: true }], iconFlipRtl: [7, {}, { reflect: true, type: Boolean }], label: 1, rel: [3, {}, { reflect: true }], target: [3, {}, { reflect: true }], thumbnail: 1 };
  }
  static {
  ...
  async setFocus(options) {
    return this.focusSetter(() => this.href ? this.el : void 0, options);
  }
  renderIcon() {
