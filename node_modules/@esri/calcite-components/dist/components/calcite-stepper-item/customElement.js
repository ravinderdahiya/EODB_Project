...
class StepperItem extends LitElement {
  ...
  async setFocus(options) {
    return this.focusSetter(() => this.layout === "vertical" ? this.el : this.headerRef.value, options);
  }
  async load() {
