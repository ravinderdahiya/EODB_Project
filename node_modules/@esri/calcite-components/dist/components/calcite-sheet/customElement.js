...
import { A as ensureId, g as getElementDir, a as getStylePixelValue } from "../../chunks/dom.js";
...
class Sheet extends LitElement {
  ...
  willUpdate(changes) {
    if (changes.has("opened") && (this.hasUpdated || this.opened !== false) && this.transitionRef.value) {
