...
import { y as p } from "./promiseUtils-DQTPPyja.js";
...
import { t as n } from "./DynamicDataLayer-DN9XqYSf.js";
import { t as R } from "./Query-f0pWdGs2.js";
import { i as d } from "./infoFor3D-BQtb6xJV.js";
import { n as f } from "./utils-CH9U4ZW0.js";
import { n as m$1, r as m, t as i } from "./executeForIds-B6_WZie_.js";
import { t as n$1 } from "./executeQueryJSON-C_0-BHOn.js";
import { t as n$2 } from "./executeQueryPBF-HnbU6Lbq.js";
...
var S = class extends b {
	...
	async featureSetFromJSON(e, t, r) {
		...
		const { meshFeatureSetFromJSON: s } = await p(import("./meshFeatureSet-Czax5kEo.js"), r);
	...
	async executeRelationshipQuery(e, t) {
		const [{ default: r }, { executeRelationshipQuery: s }] = await p(Promise.all([import("./RelationshipQuery-CMSxuIv0.js").then((n) => n.t), import("./executeRelationshipQuery-s7NEzVak.js")]), t);
		let i = r.from(e);
	...
	async executeRelationshipQueryForCount(e, t) {
		const [{ default: r }, { executeRelationshipQueryForCount: s }] = await p(Promise.all([import("./RelationshipQuery-CMSxuIv0.js").then((n) => n.t), import("./executeRelationshipQuery-s7NEzVak.js")]), t);
		let i = r.from(e);
		return (this.gdbVersion || this.dynamicDataSource) && (i = i.clone(), i.gdbVersion = i.gdbVersion || this.gdbVersion, i.dynamicDataSource = i.dynamicDataSource || this.dynamicDataSource), s(this.url, i, t);
	}
	async executeAttachmentQuery(e, t) {
		const { executeAttachmentQuery: r, fetchAttachments: s, processAttachmentQueryResult: i } = await p(import("./queryAttachments-Db-zob79.js"), t), u = f(this.url);
		return i(u, await (this.queryAttachmentsSupported ? r(u, e, t) : s(u, e, t)));
	}
	async executeAttributeBinsQuery(e, t) {
		const { executeAttributeBinsQuery: r } = await p(import("./executeAttributeBinsQuery-DPuFufil.js"), t);
		return r(this.parsedUrl, e, t);
	}
	async executePivotQuery(e, t) {
		const { executePivotQuery: r } = await p(import("./executePivotQuery-BKucLrWa.js"), t);
		return r(this.parsedUrl, e, t);
	}
	async executeTopFeaturesQuery(e, t) {
		const { executeTopFeaturesQuery: r } = await p(import("./executeTopFeaturesQuery-C74Id4NE.js"), t);
		return r(this.parsedUrl, e, this.sourceSpatialReference, t);
	}
	async executeForTopIds(e, t) {
		const { executeForTopIds: r } = await p(import("./executeForTopIds-buaFA_db.js"), t);
		return r(this.parsedUrl, e, t);
	}
	async executeForTopExtents(e, t) {
		const { executeForTopExtents: r } = await p(import("./executeForTopExtents-CqwvhNoZ.js"), t);
		return r(this.parsedUrl, e, t);
	}
	async executeForTopCount(e, t) {
		const { executeForTopCount: r } = await p(import("./executeForTopCount-BQppt8Bg.js"), t);
		return r(this.parsedUrl, e, t);
	}
	_normalizeQuery(e) {
		let t = R.from(e);
...
//# sourceMappingURL=QueryTask-BnfB0si_.js.map