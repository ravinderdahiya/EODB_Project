import { m as has, t as s$2 } from "./config-C57gEaHo.js";
import "./typedArrayUtil-BNfmp42K.js";
import { n as n$4, t as r$2 } from "./Error-DugVwGnI.js";
import { A as l$2, E as o$1, L as e$3, S as w$2, U as t$1, b as s$3, d as a$5, f as d$2, m as h$2, r as C, t as $, x as u$3 } from "./promiseUtils-CsEq-Eti.js";
import { t as t$2 } from "./nextTick-yG_NrwYs.js";
import { H as N, O as c$3, Q as _$1, T as r$3, k as e$4, t as f$2 } from "./request-D8neOagW.js";
import { t as n$5 } from "./assets-C7dYNrpc.js";
import { t as s$4 } from "./Queue-CXHcmbxi.js";
import { s as z } from "./intl-CUhw_iYT.js";
...
var r$1 = {
	CSVSourceWorker: () => import("./CSVSourceWorker-BM11BZLJ.js"),
	EdgeProcessingWorker: () => import("./EdgeProcessingWorker-BtLFKtFi.js"),
	ElevationSamplerWorker: () => import("./ElevationSamplerWorker-B7ndSAWd.js"),
	FeaturePipelineWorker: () => import("./FeaturePipelineWorker-Pp7G72hS.js"),
	FeatureServiceSnappingSourceWorker: () => import("./FeatureServiceSnappingSourceWorker-CBn0p78z.js"),
	FlowWorker: () => import("./FlowWorker-Cc-F7HaO.js"),
	GaussianSplatSortWorker: () => import("./GaussianSplatSortWorker-93AWHSwG.js"),
	MeasurementWorker: () => import("./MeasurementWorker-CNI2Ff8P.js"),
	GeoJSONSourceWorker: () => import("./GeoJSONSourceWorker-Cqg__NNL.js"),
	LercWorker: () => import("./LercWorker-Y9VPtdty.js"),
	Lyr3DWorker: () => import("./Lyr3DWorker-CBaB9Qmx.js").then((n) => n.t),
	MemorySourceWorker: () => import("./MemorySourceWorker-IdKqBuL_.js"),
	PBFDecoderWorker: () => import("./PBFDecoderWorker-DdX0G49Q.js"),
	PanoramicMeshWorker: () => import("./PanoramicMeshWorker-BLZtfICM.js"),
	ParquetSourceWorker: () => import("./ParquetSourceWorker-AY8nMG8q.js"),
	PointCloudWorker: () => import("./PointCloudWorker-YTsuJWph.js"),
	RasterWorker: () => import("./RasterWorker-C2GWPNC_.js"),
	SceneLayerSnappingSourceWorker: () => import("./SceneLayerSnappingSourceWorker-CW1XlQ7u.js"),
	SceneLayerWorker: () => import("./SceneLayerWorker-cZNAbJA_.js"),
	TextureCompressionWorker: () => import("./TextureCompressionWorker-B72w22g7.js"),
	WFSSourceWorker: () => import("./WFSSourceWorker-CGF7MRhp.js"),
	WorkerTileHandler: () => import("./WorkerTileHandler-BeYdG3Hw.js"),
	arcadeGeometryOperatorsWorker: () => import("./operatorsWorker-CsJVhwD2.js"),
	statsWorker: () => import("./statsWorker-CyqgBRJQ.js").then((n) => n.i),
	ImageMeasurementWorker: () => import("./ImageMeasurementWorker-D1ivUrN9.js")
};
//#endregion
...
var O = class O {
	...
	apply(e, t, o) {
		...
		return new Promise((s, o) => {
			if (a$5(h)) return this._processWork(), void o(u$3());
			const _ = {
				resolve: s,
				reject: o,
				abortHandle: w$2(h, () => {
	...
	on(e, s) {
		...
		return this._port.postMessage({
			...
			eventType: e,
			port: t.port2
		}, [t.port2]), t.port1.addEventListener("message", n), t.port1.start(), e$3(() => {
...
//# sourceMappingURL=workers-BMHFWey_.js.map