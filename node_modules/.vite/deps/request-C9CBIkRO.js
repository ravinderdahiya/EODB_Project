import { c as a$4, m as has, t as s$3 } from "./config-BvnHHLFh.js";
import { n as n$4, t as r$2 } from "./Error-BBuf4ybn.js";
import { T as N$2 } from "./typedArrayUtil-BAuNmygZ.js";
import { S as w$4, d as a$5, f as d$4, x as u } from "./promiseUtils-DQTPPyja.js";
...
async function H(r) {
	...
	if (L && "HTMLFormElement" in globalThis && (i instanceof FormData ? l = i : i instanceof HTMLFormElement && (l = new FormData(i))), "string" == typeof i && (u = i), r.fetchOptions = {
		...
		const { getApiKey: e, getSessionToken: t } = await import("./apiKeyUtils-CnsmN3MW.js").then((n) => n.t), a = await t(s) ?? e(s);
...
async function R() {
	s$1 || await import("./IdentityManager-BiXCEKW2.js");
}
function N(e) {
...
async function a(t) {
	...
	if (!s) return null;
	const { QueueProcessor: c, SharedConcurrency: i } = await import("./QueueProcessor-DCzIBy49.js").then((n) => n.t);
...
async function h() {
	has("host-webworker") && (!d && globalThis.invokeStaticMessage ? d = await import("./request-PjirKWmm.js") : e$3.isForeignWorker = !0);
}
...
//# sourceMappingURL=request-C9CBIkRO.js.map