...
import { r as o$1 } from "./uuid-Dis-U6Ct.js";
...
async function i(e, r, n = !1) {
	...
	if (o) {
		for (const [s, i] of o) if (i.name === r) {
			...
			if (!e && n) {
				const [{ deleteForwardEdits: e }, { default: r }] = await Promise.all([import("./deleteForwardEdits-DfGk4dwC.js"), import("./DeleteForwardEditsParameters-A_TXimbX.js")]), n = await e(a, s, new r({
					sessionId: t,
					moment: i.moment
				}));
...
//# sourceMappingURL=versionManagementUtils-BvkfqKhL.js.map