...
import { c as a, m as has } from "./config-BvnHHLFh.js";
import { n, t as r } from "./Error-BBuf4ybn.js";
import { T as l, b as r$1, x as t } from "./Accessor-C495Hp5e.js";
import { b as s$2 } from "./promiseUtils-DQTPPyja.js";
import { A as m, E as D, N as w, a as o, i as r$2, j as s$3, n as c, r as m$1, t as a$1 } from "./decorators-DNvoMvUC.js";
import { u as n$1 } from "./tracking-DYGZck8O.js";
import { t as e$2 } from "./MapUtils-5RtEogNt.js";
import { d as m$2, j as A, q as V, t as f$1 } from "./request-C9CBIkRO.js";
import { t as q } from "./Collection-YvtsTsOX.js";
import { a as o$1 } from "./sql-D5tftSMw.js";
import { U as y } from "./fieldUtils-Du6qy8H2.js";
import { i as q$1 } from "./getPopupProvider-I-yhoKFY.js";
import { t as o$2 } from "./Identifiable-CpyzTL2k.js";
import { t as e$3 } from "./MultiOriginJSONSupport-DRCpqaWb.js";
import { t as m$3 } from "./Field-Tv6GBBbl.js";
import { t as S$1 } from "./SpatialReference-CmWpkrZX.js";
import { n as o$3, t as s$4 } from "./GraphicOrigin-DV97YwNn.js";
...
import { o as S$2 } from "./typeUtils-BaBWbmRW.js";
import { n as i$2, t as n$2 } from "./DynamicDataLayer-DN9XqYSf.js";
import { t as R } from "./Query-f0pWdGs2.js";
import { c as l$2, f as u$1, g as d } from "./commonProperties-BAS6ewmU.js";
import { n as s$5, t as s$6 } from "./Relationship-CQLx--HO.js";
import { N as p$1, S as ie$1 } from "./featureLayerUtils-C3V8KY68.js";
import { t as s$7 } from "./LayerFloorInfo-Cpau2zql.js";
import { t as C } from "./serviceCapabilitiesUtils-DkXwbvqT.js";
import { n as a$2 } from "./portalItemUtils-COVFoHh2.js";
import { r as A$1, t as c$1 } from "./labelingInfo-DiiKH6X6.js";
import { n as u$2, t as m$4 } from "./typeUtils-nkilkmae.js";
import { t as r$3 } from "./Version-Rd6nrXR-.js";
import { t as _ } from "./FieldsIndex-gV6bzOg0.js";
import { t as p$2 } from "./OrderByInfo-DzYkEw2I.js";
import { r as i$3 } from "./OrderedLayer-dx3psDUw.js";
import { t as n$3 } from "./FeatureType-DEd2yhBA.js";
import { t as d$1 } from "./popupUtils-DDIeK_ye.js";
import { t as l$3 } from "./CollectionFlattener-XzP_ikUG.js";
import { n as f$2 } from "./utils-CH9U4ZW0.js";
import { t as S$3 } from "./QueryTask-BnfB0si_.js";
import { n as n$4 } from "./sublayerUtils-CGjZyL2M.js";
...
var h$1 = (h) => {
	...
	let v = class extends b {
		...
		async fetchSublayerInfo(e, r) {
			...
			if ("data-layer" === s.type) a = (await f$1(i, {
				...
				if (i && e.originIdOf("url") > 2) try {
					const e = await this._fetchAllLayersAndTablesFromService(i), t = m$2(i)?.sublayer ?? s.mapLayerId, r = structuredClone(e.get(t));
					if (null != r) {
						for (const t of [
							"drawingInfo",
							"maxScale",
		...
		async _fetchAllLayersAndTablesFromService(e, a) {
			...
			const l$4 = m$2(e), n = await e$2(this._allLayersAndTablesMap, l$4?.url.path, () => f$1(V(l$4?.url.path, "/layers"), { query: {
				f: "json",
				...this.customParameters,
				token: this.apiKey
			} }).then(async (e) => {
	...
	})], v.prototype, "legendEnabled", void 0), __decorate([a$1(l$2)], v.prototype, "popupEnabled", void 0), __decorate([a$1({ type: S$1 })], v.prototype, "spatialReference", void 0), __decorate([a$1({ readOnly: !0 })], v.prototype, "version", void 0), __decorate([o("service", "version", [
		"currentVersion",
		"capabilities",
		"tables",
...
var ne = class extends e$3(o$2(u)) {
	static {
		Y = this;
	}
	constructor(e) {
	...
	async createFeatureLayer() {
		...
		const e = (await import("./@arcgis_core_layers_FeatureLayer__js.js")).default, { layer: r$5, url: t } = this;
		let i;
	...
	toExportImageJSON(e) {
		...
		}, t = o$1(e, this.definitionExpression);
		...
		if (Object.keys(i).some((e) => i[e] > 2)) {
			...
			if (i.renderer > 2 && (e.renderer = this.renderer ? this.renderer.toJSON() : null), i.labelsVisible > 2 && (e.showLabels = this.labelsVisible), this.labelsVisible && i.labelingInfo > 2) if (this.labelingInfo) {
				...
				null != this.geometryType && (r = c$1(this.labelingInfo, y$1.toJSON(this.geometryType))), e.showLabels = !0, e.labelingInfo = r.filter((e) => e.labelPlacement).map((e) => e.toJSON({
					origin: "service",
					layer: this.layer
				}));
			} else e.showLabels = !1;
...
__decorate([a$1({
...
})], ne.prototype, "labelingInfo", null), __decorate([r$2("labelingInfo")], ne.prototype, "writeLabelingInfo", null), __decorate([a$1({
	type: Boolean,
	value: !0,
	json: {
...
})], ne.prototype, "opacity", null), __decorate([o("opacity", ["layerDefinition.drawingInfo.transparency", "layerDefinition.transparency"])], ne.prototype, "readOpacity", null), __decorate([r$2("opacity")], ne.prototype, "writeOpacity", null), __decorate([a$1({
	value: null,
	type: [p$2],
	json: {
...
} })], ne.prototype, "parent", void 0), __decorate([r$2("parent")], ne.prototype, "writeParent", null), __decorate([a$1({
	type: Boolean,
	value: !0,
	json: {
		read: {
	...
	cast(e) {
		if (e) {
			if ("mapLayerId" in e) return m(i$2, e);
			if ("dataSource" in e) return m(n$2, e);
		}
		return e;
	},
	json: {
...
})], ne.prototype, "sublayers", null), __decorate([m$1("sublayers")], ne.prototype, "castSublayers", null), __decorate([r$2("sublayers")], ne.prototype, "writeSublayers", null), __decorate([a$1({
	type: String,
	json: {
		name: "name",
...
})], ne.prototype, "visible", null), __decorate([r$2("visible")], ne.prototype, "writeVisible", null), ne = Y = __decorate([c("esri.layers.support.Sublayer")], ne);
//#endregion
...
var S = (S) => {
	...
	let v = class extends m {
		constructor(...e) {
			super(...e), this.allSublayers = new l$3({
		...
		readSublayers(e, r) {
			if (!r || !e) return;
			const { sublayersSourceJSON: s } = this, t = r$1(r.origin);
			if (t < 2) return;
			if (s[t] = {
				context: r,
		...
		createSublayersForOrigin(e) {
			let r;
			const s = r$1("web-document" === e ? "web-map" : e);
...
//# sourceMappingURL=SublayersOwner-CkYR5LyC.js.map