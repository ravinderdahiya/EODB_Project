import { M as d, P as h } from "./typedArrayUtil-BNfmp42K.js";
import "./Error-DugVwGnI.js";
import { d as m } from "./request-D8neOagW.js";
import { d as U$1 } from "./layerUtils-BkgD8Sxn.js";
import { c as u, o as l, r as c, s, t as E$1 } from "./portalItemUtils-DqDIRUzJ.js";
import { n as o } from "./jsonContext-CBAXZMYk.js";
import { n as u$1, t as n } from "./fetchService-D_Lt_Dei.js";
import { n as P$1, t as $$1 } from "./utils-DLUZsqPP.js";
...
async function H(e) {
	...
	e.forEach(({ type: e }) => {
		switch (u$1(e)) {
			case "CatalogLayer":
				r.push(import("./CatalogLayer-nv5BZPgs.js").then((e) => e.default));
				break;
			case "FeatureLayer":
				r.push(import("./@arcgis_core_layers_FeatureLayer__js.js").then((e) => e.default));
				break;
			case "OrientedImageryLayer": r.push(import("./OrientedImageryLayer-sGrQ5e0y.js").then((e) => e.default));
		}
	});
...
//# sourceMappingURL=featureLayerUtils-of1HEILa.js.map