import { S as u, l as b, y as p } from "./aaBoundingRect-DXOOBtNm.js";
import { d as t } from "./curveUtils-BIVZ_WWm.js";
import { o as f } from "./zmUtils-DTQ57DZp.js";
import { a as o, t as e } from "./jsonTypeUtils-xyRzaxWi.js";
import { a as E } from "./utils-BZAeWa0g.js";
import { n as L } from "./densifyCurvedGeometry-Qi20d0ES.js";
import { c as at, i as _, u as mt } from "./CIMSymbolHelper-DcKQIRxE.js";
import { t as i } from "./CIMResourceManager-B659wmZA.js";
import { n as T, t as R } from "./rasterizingUtils-B7_s7egV.js";
import { n as v } from "./OverrideHelper-VOT7Qg7H.js";
import { i as t$1 } from "./densificationConstants-Dhk0jPOM.js";
//#region node_modules/@arcgis/core/symbols/support/densifyForPreview.js
function n(t, o, r, e) {
	const { height: n, width: p } = e ?? m(t);
	return L(t, { maxDeviation: Math.min(p / o, n / r) * t$1() });
}
function m(i) {
	const s = f(u(), i);
	return {
...
function d(e, t$2, r, s) {
	const h = t(e) ? n(e, r, s) : e;
	if ("esriGeometryPolygon" === t$2) return { rings: R(T(h.rings, {
		xmin: 0,
		ymin: 0,
		width: r,
		height: s
	}), -1 * r / 2, -1 * s / 2) };
	if ("esriGeometryPolyline" === t$2) return { paths: R(T(h.paths, {
		xmin: 0,
		ymin: 0,
		width: r,
		height: s
...
//#endregion
export { y as CIMSymbolRasterizer };

//# sourceMappingURL=CIMSymbolRasterizer-C12DXmGd.js.map