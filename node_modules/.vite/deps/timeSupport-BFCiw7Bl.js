import { K as r$2 } from "./typedArrayUtil-BNfmp42K.js";
import { t as r$3 } from "./Error-DugVwGnI.js";
import { u as U } from "./spatialReferenceUtils-BtA22Tuk.js";
import { a as z, c as r$4, i as o$2, l as t$1 } from "./Extent-BU6jY2-x.js";
import { a as o$3, i as n$2, l as u$2 } from "./jsonTypeUtils-BSoxwy98.js";
import { b as rt, p as Z, s as J, t as A, y as nt } from "./featureConversionUtils-DbUOyYaF.js";
...
var g = {
	esriSpatialRelIntersects: () => import("./intersectsOperator-zoVM_ob1.js"),
	esriSpatialRelContains: () => import("./containsOperator-Cll1YkgP.js"),
	esriSpatialRelCrosses: () => import("./crossesOperator-D8-IkT0s.js"),
	esriSpatialRelDisjoint: () => import("./disjointOperator-DAJValHU.js"),
	esriSpatialRelEnvelopeIntersects: null,
	esriSpatialRelIndexIntersects: null,
	esriSpatialRelOverlaps: () => import("./overlapsOperator-xPoDCwBp.js"),
	esriSpatialRelTouches: () => import("./touchesOperator-bvJ8eWkv.js"),
	esriSpatialRelWithin: () => import("./withinOperator-CoQL9eat.js"),
...
async function I(r, t, i) {
	...
	if (s) {
		if (!R(o)) throw new r$3(c, "Unsupported query spatial relationship", { query: r });
		if (U(s.spatialReference) && U(i)) {
			if (!S(s)) throw new r$3(c, "Unsupported query geometry type", { query: r });
			if (!j(t)) throw new r$3(c, "Unsupported layer geometry type", { query: r });
...
async function n(n, l) {
	...
	if (r && e) await l.forEach((n) => {
		const l = u.getAttribute(r$2(n), r), s = u.getAttribute(r$2(n), e);
		null == l || isNaN(l) || (i = Math.min(i, l)), null == s || isNaN(s) || (o = Math.max(o, s));
	});
	else {
		const n = r || e;
		await l.forEach((l) => {
			const r = u.getAttribute(r$2(l), n);
...
//# sourceMappingURL=timeSupport-BFCiw7Bl.js.map