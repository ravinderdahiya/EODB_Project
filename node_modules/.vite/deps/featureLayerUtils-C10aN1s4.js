...
import { d as m } from "./request-C9CBIkRO.js";
import { d as U$1 } from "./layerUtils-DqdiS7uu.js";
import { c as u, o as l, r as c, s, t as E$1 } from "./portalItemUtils-COVFoHh2.js";
import { n as o } from "./jsonContext-Bl8OQjFu.js";
import { n as u$1, t as n } from "./fetchService-Gb7qWKEj.js";
import { n as P$1, t as $$1 } from "./utils-BUXoYsYP.js";
...
async function H(e) {
	...
	e.forEach(({ type: e }) => {
		switch (u$1(e)) {
			case "CatalogLayer":
				r.push(import("./CatalogLayer-C4m7mJ_p.js").then((e) => e.default));
				break;
			case "FeatureLayer":
				r.push(import("./@arcgis_core_layers_FeatureLayer__js.js").then((e) => e.default));
				break;
			case "OrientedImageryLayer": r.push(import("./OrientedImageryLayer-wiK4yoJp.js").then((e) => e.default));
		}
	});
...
//# sourceMappingURL=featureLayerUtils-C10aN1s4.js.map