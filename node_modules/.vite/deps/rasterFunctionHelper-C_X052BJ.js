...
import { c as a$24 } from "./config-BvnHHLFh.js";
import { t as r$6 } from "./Error-BBuf4ybn.js";
import { a as o$15, i as r$8, n as c$24, o as r$7, r as m$10, t as a$25 } from "./decorators-DNvoMvUC.js";
import { n as n$25 } from "./JSONSupport-BWDaFwRT.js";
import { n as o$16 } from "./jsonMap-DEVWHgIV.js";
import { v as q$1 } from "./mathUtils-Dq5Y4VHb.js";
import { t as m$11 } from "./Field-Tv6GBBbl.js";
import { n as u$19 } from "./jsonUtils-Ctwrsphe.js";
import { o as s$11 } from "./typeUtils-EwYDasZD.js";
import { n as p$17, t as m$12 } from "./colorRamps-BWMotyx7.js";
import { t as m$13 } from "./RasterInfo-C-HMqsIq.js";
import { c as r$9, i as f$4, l as u$20, n as l$19, o as i$21, r as c$26, t as c$25 } from "./PixelBlock-bC_q_hQ4.js";
import { A as o$17, E as h$4, S as c$27, T as g$4, b as U$1, d as A$2, g as M$2, j as s$12, k as m$14, x as a$26 } from "./vectorFieldUtils-D1lAufML.js";
import { n as C$1 } from "./colorUtils-B1quUh3Q.js";
import { d as D$3, g as n$26, h as m$15, l as B$3, m as d$7, n as a$27, v as w$3 } from "./dataUtils-ENO41TbO.js";
import { a as l$20, d as z$2, l as w$4, n as b$2, s as u$21 } from "./stretchUtils-B0Da6Kwp.js";
import { a as h$5, c as r$10, i as f$5, l as u$22, n as c$28, o as n$27, r as d$8, s as o$18 } from "./RasterSymbolizer-Cp6Daz44.js";
import { a as Q$1, r as H$2 } from "./rasterProjectionHelper-nFkxLe05.js";
import { n as l$21 } from "./clipUtils-DNhwPV7X.js";
...
function i$18(t, e, r) {
	const [o, s] = t, a = o.length, l = c$25.createEmptyBand(r, a);
	for (let n = 0; n < a; n++) e && !e[n] || (l[n] = o[n] + s[n]);
	return l;
}
function u$16(t, e, r) {
	const [o] = t, s = o.length, a = c$25.createEmptyBand("f32", s);
	return a.set(o), a;
}
function h$2(t, e, r) {
	const [o] = t, s = o.length, a = c$25.createEmptyBand(r, s);
...
function M$1(t, e, r, s) {
	const a = t[0], l = a.length, c = c$25.createEmptyBand(r, l);
	if (s === p$16.atanh) {
...
function B$1(t, e, r, o) {
	const [s] = t, a = s.length, l = c$25.createEmptyBand(r, a);
	for (let n = 0; n < a; n++) e && !e[n] || (l[n] = o(s[n]));
	return l;
}
function I$1(t, e, r, o) {
	const [s, a] = t, l = s.length, c = c$25.createEmptyBand(r, l);
...
function F$1(t, e, r, o) {
	const [s] = t, a = s.length, l = c$25.createEmptyBand(r, a), c = o === Math.E;
...
function W(t, e, r) {
	const [o, s] = t, a = o.length, l = c$25.createEmptyBand(r, a), c = new Uint8Array(a);
...
function Y(t, e, r) {
	const [o, s, a] = t, l = o.length, c = c$25.createEmptyBand(r, l);
...
function rt(t, e, r) {
	const o = t.length;
	if (o < 2) return t[0];
	const s = Math.floor(o / 2), [a] = t, l = a.length, c = c$25.createEmptyBand(r, l), f = new Float32Array(o), i = o % 2 == 1;
...
function ot(t, e, r) {
	const [o, s] = t;
	if (null == s) return o;
	const a = o.length, l = c$25.createEmptyBand(r, a);
...
function st(t, e, r) {
	...
	const s = t[0].length, a = c$25.createEmptyBand(r, s), l = /* @__PURE__ */ new Map();
...
function lt(t, e, r) {
	const o = t.length;
	if (o < 2) return t[0];
	const [s] = t, a = s.length, l = c$25.createEmptyBand(r, a), c = /* @__PURE__ */ new Set();
	for (let n = 0; n < a; n++) if (!e || e[n]) {
		let e;
		c.clear();
...
function gt(l, c, i = {}) {
	...
	for (let f = 0; f < p; f++) {
		...
		if (d && c !== s$10.isNull && !a$20.has(c)) {
			const r = c$25.createEmptyBand(h, p.length);
			u || (u = new Uint8Array(p.length).fill(255)), f$4(p, u), c$26(p, u, h, r), p = r;
		}
		m.push(p);
	}
	const d = l[0];
...
function s$8(t, i) {
	...
	q ? (I = new Uint8Array(t.width * t.height), I.set(q)) : T && (I = new Uint8Array(t.width * t.height).fill(255)), T && (M = M.map((t) => {
		const n = c$25.createEmptyBand(B, t.length);
		return c$26(t, I, B, n), n;
	}));
	const P = new c$25({
		width: t.width,
		height: t.height,
...
function i$12(e, n, s, i) {
	const [f, h] = e, p = r$9(s) && !r$9(f.pixelType) && !r$9(h.pixelType), u = [f.mask, h.mask].filter((e) => e), m = c$25.combineBandMasks(u), g = e.map((e) => e.pixels[0]), { width: k, height: x } = f, b = c$25.createEmptyBand(s, k * x);
	switch (n) {
		case "difference":
...
function s$4(s, i, n, h) {
	const { pixels: o, width: a, height: l } = s, r = o.length, p = n.startsWith("f"), c = !p, [d, f] = u$20(n), m = a * l, g = c$25.createEmptyBand(n, m);
	for (let t = 0; t < l; t++) {
		let e = t * a;
...
function i$7(t, i, n) {
	const { width: h, height: o, mask: a, bandMasks: l } = t, r = l?.length ? c$25.combineBandMasks(l) : a, c = new c$25({
		width: h,
		height: o,
		pixels: [s$4(t, i, n, r)],
		pixelType: n,
...
function n$12(t, i, n) {
	const { width: h, height: o, mask: a, bandMasks: l } = t, r = l?.length ? c$25.combineBandMasks(l) : a, p = [], c = t.pixels.length;
...
function a$2(t, n) {
	...
	for (let j = 0; j < y; j++) {
		const t = f[j], d = c$25.createEmptyBand(A, k);
		c && d.set(t);
	...
	let B = x[0] ?? a;
	x.length !== y && (x.length = 0), y > 1 && m?.length && (B = c$25.combineBandMasks(m));
	const N = new c$25({
		pixelType: A,
		width: h,
		height: u,
...
//# sourceMappingURL=rasterFunctionHelper-C_X052BJ.js.map