...
import { S as u$2, b as r$1, t as b } from "./Accessor-C495Hp5e.js";
import { P as h } from "./typedArrayUtil-BAuNmygZ.js";
import { H as s$1, U as u$3, V as o, b as n$3, l, x as r$2, y as i$1 } from "./decorators-DNvoMvUC.js";
import { f as u$4, u as n$4 } from "./tracking-DYGZck8O.js";
...
function u$1(t, o, n = c$1) {
	...
	for (const r of Object.getOwnPropertyNames(d)) {
		...
		let c;
		c = f && "string" == typeof f ? u$3(o, f) : o[r], a?.reader && (c = a.reader.call(t, c, o, n)), void 0 !== c && i.set(r, c);
	}
...
function p(r$3, o$1, s, u, l, a) {
	...
	if (!l.ignoreOrigin && a?.origin && o$1.store.multipleOriginsSupported) {
		if (o$1.store.originOf(s) < r$1(a.origin)) return !1;
	}
	return !0;
}
...
function c(r, e, t, i) {
	const o = n$4(r), n = o.metadata, s = r$2(n[e], i);
...
function g(r, e, t) {
	...
	for (const u in f) {
		...
		Object.keys(d).length > 0 && (e = u$4(e, d), t?.resources?.pendingOperations?.length && t.resources.pendingOperations.push(Promise.all(t.resources.pendingOperations).then(() => u$4(e, d, () => "replace-arrays"))), t?.writtenProperties && t.writtenProperties.push({
			target: r,
			propName: u,
			oldOrigin: u$2(n.store.originOf(u)),
			newOrigin: t.origin
		}));
	}
	return e;
...
//# sourceMappingURL=JSONSupport-BWDaFwRT.js.map