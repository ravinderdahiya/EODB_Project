...
import { a as n$1, c as a } from "./config-BvnHHLFh.js";
import { n as n$2 } from "./Error-BBuf4ybn.js";
import { T as N$1 } from "./typedArrayUtil-BAuNmygZ.js";
import { M as u, N as w, a as o, i as r$1, n as c, o as r, p as i, r as m, t as a$1 } from "./decorators-DNvoMvUC.js";
import { n as l$2 } from "./Clonable-DA_4iBES.js";
import { v as m$1, y as p$2 } from "./request-C9CBIkRO.js";
import { n as n$3 } from "./JSONSupport-BWDaFwRT.js";
import { G as e, L as v, V as x } from "./fieldUtils-Du6qy8H2.js";
import { s as l$3 } from "./reactiveUtils-Bd9X7q7v.js";
import { m as c$1, p as z } from "./typeUtils-BaBWbmRW.js";
import { t as M$1 } from "./Portal-CGQ-0P7E.js";
import { a as m$3, d as a$3, i as y, n as m$2, r as n$4, t as a$2 } from "./commonProperties-Dj1YMGeo.js";
import { r as y$1 } from "./diffUtils-CklYQeyO.js";
import { t as u$1 } from "./RendererLegendOptions-lsbIpwpa.js";
import { n as i$1 } from "./styleUtils-BouxamFb.js";
//#region node_modules/@arcgis/core/renderers/support/UniqueValue.js
var l$1 = class extends l$2(n$3) {
	constructor(o) {
...
var $ = E = class extends m$3(a$3) {
	...
	writeField(e, t, i$2, o) {
		"string" == typeof e ? t[i$2] = e : o?.messages ? i(o, "UniqueValueRenderer.field", "set to a function cannot be written to JSON") : n$2.getLogger(this).error(".field: cannot write field to JSON since it's not a string value");
	}
	set field2(e) {
	...
	writeStyleOrigin(e, t, s, i) {
		e.styleName ? t.styleName = e.styleName : e.styleUrl && (t.styleUrl = m$1(e.styleUrl, i));
	}
	set uniqueValueGroups(e) {
		this.styleOrigin ? n$2.getLogger(this).error("#uniqueValueGroups=", "Cannot modify unique value groups of a UniqueValueRenderer created from a web style") : (this._set("uniqueValueGroups", e), this._updateInfosFromGroups(), this._isInfosSource = !1, this._watchUniqueValueGroups());
	}
	set uniqueValueInfos(e) {
		this.styleOrigin ? n$2.getLogger(this).error("#uniqueValueInfos=", "Cannot modify unique value infos of a UniqueValueRenderer created from a web style") : (this._set("uniqueValueInfos", e), this._updateValueInfoMap(), this._updateGroupsFromInfos(), this._isInfosSource = !0, this._watchUniqueValueInfos());
	}
	addUniqueValueInfo(e, t) {
		if (this.styleOrigin) return void n$2.getLogger(this).error("#addUniqueValueInfo()", "Cannot modify unique value infos of a UniqueValueRenderer created from a web style");
		let i;
	...
	removeUniqueValueInfo(e) {
		if (this.styleOrigin) return void n$2.getLogger(this).error("#removeUniqueValueInfo()", "Cannot modify unique value infos of a UniqueValueRenderer created from a web style");
	...
	getSymbol(e, t) {
		if (this.valueExpression && null == t?.arcade) return void n$2.getLogger(this).error("#getSymbol()", "Please use getSymbolAsync if valueExpression is used");
	...
	_watchUniqueValueGroups() {
		...
		if (e) {
			const t = [];
			for (const s of e) {
				t.push(l$3(() => ({ classes: s.classes }), (e, t) => {
					e !== t && (this._updateInfosFromGroups(), this._isInfosSource = !1);
				}, { sync: !0 }));
				for (const e of s.classes ?? []) t.push(l$3(() => ({
					symbol: e.symbol,
					values: e.values,
					label: e.label,
	...
	static fromPortalStyle(e, t) {
		...
		return o.catch((t) => {
			n$2.getLogger(this.prototype).error(`#fromPortalStyle('${e}'[, ...])`, "Failed to create unique value renderer from style name", t);
		}), o;
	}
	static fromStyleUrl(e, t) {
		...
		const o = i.populateFromStyle();
		return o.catch((t) => {
			n$2.getLogger(this.prototype).error(`#fromStyleUrl('${e}'[, ...])`, "Failed to create unique value renderer from style URL", t);
		}), o;
	}
};
__decorate([a$1({ readOnly: !0 })], $.prototype, "_cache", null), __decorate([r({ uniqueValue: "unique-value" })], $.prototype, "type", void 0), __decorate([a$1(n$4)], $.prototype, "backgroundFillSymbol", void 0), __decorate([a$1({
...
})], $.prototype, "field", null), __decorate([m("field")], $.prototype, "castField", null), __decorate([r$1("field")], $.prototype, "writeField", null), __decorate([a$1({
	type: String,
	value: null,
	json: { write: !0 }
	...
	type: String,
	json: { write: !0 }
})], $.prototype, "defaultLabel", void 0), __decorate([a$1(n$1({ ...y }, { json: {
...
//# sourceMappingURL=UniqueValueRenderer-WslDfkHh.js.map