...
import { k as e$1 } from "./promiseUtils-DQTPPyja.js";
import { n as c, t as a$1 } from "./decorators-DNvoMvUC.js";
import { b as s } from "./mathUtils-Dq5Y4VHb.js";
import { t as g } from "./Color-DUA_J43M.js";
import { M as te, g as ae } from "./units-XYZmVlT8.js";
import { r as a$2, s as l$1 } from "./reactiveUtils-Bd9X7q7v.js";
import { C as u, _ as l$2, d as b$1, u as _, w as v, y as o } from "./vec2-DD9Lt6SG.js";
import { c as h$2, d as l$3, i as p$1, m as h$1, n as d, x as p } from "./curveExtent-1Dkpx_J0.js";
import { a as i, c as o$1, n as c$1, p as v$1, r as e$2 } from "./curveUtils-BIVZ_WWm.js";
import { a as g$1 } from "./coordsUtils-BlKQSNvr.js";
import { t as y } from "./Polyline-BEScFVSf.js";
import { i as f } from "./screenUtils-BMK0toVx.js";
import { t as f$1 } from "./messages-DIpQNPWC.js";
import { r as R$1 } from "./intl-ClN2k9ah.js";
import { o as w } from "./asyncUtils-CF4XM__w.js";
import "./projector-DCLeBVgo.js";
import { i as n$2 } from "./vec2f64-DBnievnq.js";
import { c as b$2, m as k } from "./elevationInfoUtils-C1mGP2nk.js";
import { r as D, s as P } from "./colorUtils-B1quUh3Q.js";
import { t as e$3 } from "./getDefaultUnitForView-DnyW1kuv.js";
import { a as U } from "./quantityFormatUtils-CmVvWu0u.js";
import { t as i$1 } from "./vec3-BGHdIS7t.js";
...
function n$1(n, p$2, u) {
	...
	if (o$1(p$2)) return h$1(h$2(n, p$2), u);
...
var V = class extends b {
	...
	_update(e) {
		...
		const a = r.length;
		for (let l = 0; l < a; ++l) {
			const r = this.getRing(i, o, s, n, l), c = r.map((e) => i$1(e) ? e : n.arrayToXYZ(v$1(e)));
	...
	_addLabel(e, t, s, o$2, r, i, n, a = !1) {
		...
		if (!a || !h) {
			const s = !r || e$2(r) ? e.automaticLengthMeasurementUtils.autoDistance2D(t, o$2, m) : e.automaticLengthMeasurementUtils.autoLength2D(new y({
				spatialReference: m,
		...
		if (n ? o(q, -u$1, d) : o(q, u$1, -d), v(q, q), l$2(q, q, this._edgeDistancePixels), r && !e$2(r)) {
	...
	_refreshMessages() {
		this._messageUnitsTask?.abort(), this._messageUnitsTask = w(() => f$1("esri/core/t9n/Units"));
	}
};
function G(e, t, s, o) {
...
var H = s(5), q = n$2(), z = n$2(), F = f(), X = f();
//#endregion
export { V as t };

//# sourceMappingURL=SegmentLabels-Lu1AUsUv.js.map