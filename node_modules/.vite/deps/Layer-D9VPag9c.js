...
import { r as n$1 } from "./Evented-BHes3AIJ.js";
...
async function o(o) {
	const a = "portalItem" in o ? o : { portalItem: o }, { fromItem: e } = await import("./portalLayers-DQPsC6p7.js").then((n) => n.n);
	try {
		return await e(a);
	} catch (p) {
...
var c = 0, b = class extends n$1(o$1(u)) {
	...
	static async fromArcGISServerUrl(t) {
		...
		return (await import("./arcgisLayers-CfcgVZ06.js")).fromUrl(e);
	}
...
//# sourceMappingURL=Layer-D9VPag9c.js.map