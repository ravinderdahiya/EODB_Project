import { c as a$8, m as has, t as s$13 } from "./config-BvnHHLFh.js";
import { n as n$20, t as r$13 } from "./Error-BBuf4ybn.js";
import { W as t$18 } from "./typedArrayUtil-BAuNmygZ.js";
import { L as e$18 } from "./decorators-DNvoMvUC.js";
import { b as s$14 } from "./mathUtils-Dq5Y4VHb.js";
import { t as S } from "./SpatialReference-CmWpkrZX.js";
import { S as u$7, b as q$1, f as f$3, h as j$2, l as b$1, o as N$1, v as o$7, y as p$3 } from "./aaBoundingRect-DXOOBtNm.js";
import { c as S$1, y as o$8 } from "./vec2-DD9Lt6SG.js";
import { l as x$1, o as f$4 } from "./zmUtils-DTQ57DZp.js";
import { i as l$6, l as n$21, n as I, r as N$2, t as j$3, u as t$19 } from "./Polygon-DVpFKUwp.js";
import { o as h$9 } from "./coordsUtils-BlKQSNvr.js";
import { a as o$9, c as t$20, i as n$22, n as i$11, t as e$19 } from "./jsonTypeUtils-xyRzaxWi.js";
import { f as u$8, r as e$20 } from "./screenUtils-BMK0toVx.js";
import { n as y$3 } from "./TextSymbol-DM_BCJOt.js";
import { s as u$9 } from "./defaults-BGU3lydW.js";
import { t as o$10 } from "./defaultCIMValues-sJh5sEan.js";
import { A as j$4, B as v$2, E as ee$1, H as x$2, M as le, O as g$2, V as w$2, W as z$1, _ as U$1, g as T$2, k as h$10, l as I$1, m as P$1, o as F, s as G$1, t as A$2, u as L$1 } from "./utils-BZAeWa0g.js";
import { i as e$21, l as s$15, s as i$12, t as M$1 } from "./mat2d-7UUi8-nE.js";
import { n as n$23, t as e$22 } from "./mat2df32-DrzpywWA.js";
import { r as n$24 } from "./vec2f32-96NmDgkW.js";
import { c as xt } from "./definitions-CmF_5RKN.js";
import { n as i$13, t as h$11 } from "./TileClipper-Ct09XYp2.js";
import { p as r$14 } from "./GeometryUtils-DRdSQORC.js";
import { n as _$3, t as l$7 } from "./labelPoint-Cm3BdUhA.js";
import { o as p$4 } from "./rasterizingUtils-B7_s7egV.js";
import { t as t$21 } from "./Rect-BrjHLmss.js";
import { t as i$14 } from "./BoundingBox-Clab_HE6.js";
import { t as C } from "./BidiEngine-DRgUWSx0.js";
//#region node_modules/@arcgis/core/core/fontUtils.js
var t$17 = "arial-unicode-ms", n$19 = "woff2", r$12 = /* @__PURE__ */ new Map(), o$6 = /* @__PURE__ */ new Set();
var s$12 = class {
	constructor(e, t) {
		this.fontFace = e, this.promise = t;
	}
};
async function c$3(t) {
	const c = l$5(t), a = f$2(t), i = r$12.get(c);
	if (i) return i.promise;
	const u = new FontFace(t.family, `url('${s$13.fontsUrl}/woff2/${a}.${n$19}') format('${n$19}')`, {
		style: t.style,
		weight: t.weight
	}), d = document.fonts;
	if (d.has(u) && "loading" === u.status) return u.loaded;
	const h = u.load().then(() => (d.add(u), u));
	return r$12.set(c, new s$12(u, h)), o$6.add(u), h;
}
function i$10(e) {
	return o$6.has(e);
}
...
function f$2(e) {
	const t = d(e) + h$8(e);
	return u$6(e.family) + (t.length > 0 ? t : "-regular");
}
function l$5(e) {
	const n = d(e) + h$8(e);
...
var o$5 = P$1(() => import("./bufferOperator-HS_lAf0l.js")), s$11 = P$1(() => import("./convexHullOperator-MGsUWXYo.js")), m$2 = P$1(() => import("./lengthOperator-Bokyy9YE.js")), n$18 = P$1(() => import("./generalizeOperator-DTPy7_md.js")), i$9 = P$1(() => import("./graphicBufferOperator-AzMsaFf8.js")), p$2 = P$1(() => import("./offsetOperator-BBFbgRHA.js")), f$1 = P$1(() => import("./simplifyOperator-KKYxRRXC.js")), a$7 = P$1(() => import("./jsonConverter-CY-KIMiO.js").then((n) => n.s)), c$2 = 512;
var l$4;
function g$1(e) {
	switch (e.type) {
...
var h$7 = class extends s$10 {
	...
	_constructSimpleArrow(t, r, n) {
		...
		const u = n$21(i), h = this._constructOffset(u, -c);
		if (!h) return;
	...
	_constructCrossedArrow(t, r) {
		...
		const p = n$21(l), a = this._constructOffset(p, c);
		if (!a) return;
	...
	next() {
		...
		for (; n = this._inputGeometries.next();) {
			...
			if ("esriGeometryEnvelope" === n.geometryType) {
				if (this._size > 0) {
					const i = _$3.createEmptyOptimizedCIM(n.geometryType), s = t$19(n)[0], r = this._curveHelper.offset(s, this._size, "Rounded", 4, this._offsetFlattenError);
...
var r$11 = class {
	...
	next() {
		...
		for (; i = this._inputGeometries.next();) {
			const h = this._processGeom(t$19(i));
	...
	_processGeom(s) {
		...
		const t = [];
		for (const e of s) {
			const s = e.length > 1 && h$9(e) < this._defaultSize;
		...
		for (; f = this._inputGeometries.next();) {
			...
			if ("esriGeometryEnvelope" === f.geometryType) {
				if ("Rounded" === this._method && this._offset > 0) {
					const r = n$21(f), s = this._curveHelper.offset(r, -this._offset, this._method, 4, this._offsetFlattenError);
					if (s) {
				...
				const r = f.asJSON();
				if (n$22(r) && Math.min(r.xmax - r.xmin, r.ymax - r.ymin) + 2 * this._offset > 0) return _$3.fromJSONCIM({
...
var r$7 = class {
	constructor(t, e, n) {
		this._inputGeometries = t, this._length = (void 0 !== e.length ? e.length : o$10.CIMGeometricEffectRadial.length) * n, this._angle = void 0 !== e.angle ? e.angle * Math.PI / 180 : o$10.CIMGeometricEffectRadial.angle, this._lx = Math.cos(this._angle) * this._length, this._ly = Math.sin(this._angle) * this._length;
	}
	next() {
...
var p$1 = () => n$20.getLogger("esri.symbols.cim.effects.EffectTaperedPolygon");
var y$1 = class y$1 {
	static {
		this.instance = null;
	}
...
var f = class extends s$10 {
	constructor(e, t, s) {
		super(e, !1, !0), this._slopeS = 0, this._slopeC = 1, this._lastTangent1 = new i$13(NaN, NaN), this._lastWidth = 0, this._geomUnitsPerPoint = s, this._halfFromWidth = Math.abs(void 0 !== t.fromWidth ? t.fromWidth : 0) * s * .5, this._halfToWidth = Math.abs(void 0 !== t.toWidth ? t.toWidth : 1) * s * .5, this._originalLength = (void 0 !== t.length ? t.length : 0) * s, this._length = 0;
	}
	processPath(t) {
		...
		const n = t.getCurrentPath().asJSON(), h = n$18.module.execute(n, .25 * this._geomUnitsPerPoint, { removeDegenerateParts: !0 }), y = null == h ? null : o$9(h) ? h.rings : e$19(h) ? h.paths : null;
		if (!y) return p$1().error(new r$13("mapview-bad-resource", "Unable to process geometry")), null;
	...
	_setFromOffset([[e, t], [s, o]], i, l) {
		const r = this._halfFromWidth, h = new i$13(s - e, o - t).normalize().scale(r);
	...
	_setToOffset([[e, t], [s, o]], i, l, r) {
		...
		const a = new i$13(s - e, o - t).normalize().scale(h);
	...
	_setOffset([[t, s], [o, i], [l, r]], h, a, c) {
		...
		const f = new i$13(o, i), m = new i$13(o - t, i - s).normalize(), x = new i$13(l - o, r - i).normalize(), d = i$13.sub(x, m), g = a.getPointCount(), u = c.getPointCount();
		m.leftPerpendicular(), x.leftPerpendicular();
		const T = m.x * x.x + m.y * x.y;
		if (T > .99) {
			const e = i$13.add(m, x).scale(y / 2), t = e.clone().rotate(this._slopeC, this._slopeS);
			...
			if (d.scale(1 / o), o < 0) {
				...
				const t = c.getXY(u - 1);
				t || p$1().error(new r$13("mapview-bad-resource", "Unable to process geometry, index out of scope"));
				const s = i$13.add(f, d).sub(i$13.fromArray(t));
			...
			if (o < 0) {
				...
				const o = a.getXY(g - 1);
				o || p$1().error(new r$13("mapview-bad-resource", "Unable to process geometry, index out of scope"));
				const i = i$13.add(f, _.clone().scale(this._lastWidth)), l = i$13.sub(i, i$13.fromArray(o)), r = m.x * l.y - m.y * l.x;
				if (!isNaN(this._lastTangent1.x) && !isNaN(this._lastTangent1.y) && r > 0) {
					const e = new i$13(t, s), o = this._lastTangent1.clone().scale(this._lastWidth);
...
var r$3 = class r$3 {
	constructor(e, h, n, _) {
		if (this._xMin = 0, this._xMax = 0, this._yMin = 0, this._yMax = 0, this._currentX = 0, this._currentY = 0, this._accelerationMap = null, this._testInsidePolygon = !1, this._verticalSubdivision = !0, this._stepX = Math.abs(h.stepX ?? 16) * n, this._stepY = Math.abs(h.stepY ?? 16) * n, this._stepX = Math.round(128 * this._stepX) / 128, this._stepY = Math.round(128 * this._stepY) / 128, 0 !== this._stepX && 0 !== this._stepY) {
			if (this._gridType = h.gridType ?? "Fixed", "Random" === this._gridType) this._randomLCG = new t$18((h.seed ?? 13) * 1), this._randomness = (h.randomness ?? 100) / 100, this._gridAngle = 0, this._shiftOddRows = !1, this._cosAngle = 1, this._sinAngle = 0, this._offsetX = 0, this._offsetY = 0, this._buildRandomValues();
			else {
...
var s$2 = class {
	...
	_computeTextWidth(t, i) {
		...
		const s = i.font;
		return ("italic" === s.style || "oblique" === s.style || "string" == typeof s.weight && ("bold" === s.weight || "bolder" === s.weight) || "number" == typeof s.weight && s.weight > 600) && (n += .3 * t.measureText("w").width), n += 2 * u$8(this._parameters.halo.size), Math.round(n);
	}
	...
	_computeLineHeight() {
		...
		return i && "underline" === i && (t *= 1.3), Math.round(t + 2 * u$8(this._parameters.halo.size));
	}
...
function r$2(t, i) {
	const n = Math.max(i.size, .5), s = i.font, r = `${s.style} ${s.weight} ${u$8(n).toFixed(1)}px ${s.family}, sans-serif`;
	let o;
...
var t$1 = () => n$20.getLogger("esri.views.2d.engine.webgl.alignmentUtils");
function r$1(e) {
	if (!e) return 0;
	switch (e) {
		case "Left":
...
var y = class {
	constructor(t, s, i, e) {
		this._rotationT = n$23(), this._xBounds = 0, this._yBounds = 0, this.minZoom = 0, this.maxZoom = 255, this._bounds = null;
	...
	get bounds() {
		if (!this._bounds) {
			...
			e$22(r, r, e$21(n$23(), this._rotationT, this._transform));
			...
			const _ = d - f, l = g - c;
			this._bounds = new i$14(f + _ / 2, c + l / 2, _, l);
		}
		return this._bounds;
	}
	setTransform(t) {
	...
	_setOffsets() {
		...
		const t = e$21(n$23(), this._rotationT, this._transform);
...
var M = class {
	...
	shapeBackground(t) {
		...
		return [new i$14(a, f, c + 2 * i, d + 2 * i), R];
	}
	get boundsT() {
		const t = this.bounds, s = o$8(n$24(), t.x, t.y);
		if (S$1(s, s, this._transform), this._hasRotation) {
			const i = Math.max(t.width, t.height);
			return new i$14(s[0], s[1], i, i);
		}
		return new i$14(s[0], s[1], t.width, t.height);
	}
	_createBounds(t) {
		...
		const h = e - s, n = o - i;
		return new i$14(s + h / 2, i + n / 2, h, n);
	}
	_createGlyphTransform(t, s) {
		const h = x * s.angle, n = n$23(), f = n$24();
		return i$12(n, n, o$8(f, s.xOffset, -s.yOffset)), s.useCIMAngleBehavior ? s$15(n, n, h) : (i$12(n, n, o$8(f, t.x, t.y)), s$15(n, n, h), i$12(n, n, o$8(f, -t.x, -t.y))), n;
	}
};
var R$1 = class {
...
function A$1(t, s) {
	const i = s.scale, e = new Array(), o = t.sdfPadding, { faceInfo: h, glyphs: n$25, isRightToLeft: r } = t, a = v$1(n$25, r, s), d = a.length ? j$1(a, s) : {
		y: 0,
		height: 0
...
var st = Math.PI / 180, ot = .5, nt = () => n$20.getLogger("esri.symbols.cim.CIMSymbolDrawHelper");
var at = class at {
	constructor(t) {
		this._t = t;
	}
...
var lt = class {
	...
	drawMarkerLayer(t, e) {
		...
		if (r) {
			...
			if (t$20(e)) r.tx = e.x, r.ty = e.y, this.drawMarker(t, r);
			else if (o$9(e)) {
				const i = l$6(e);
	...
	drawPictureMarker(t, e) {
		if (!t) return;
		const r = this._resourceManager.getResource(t.url), i = I$1(t.size, o$10.CIMPictureMarker.size);
	...
	drawVectorMarker(t, e) {
		...
		if (!r) return;
		const i = I$1(t.size, o$10.CIMVectorMarker.size), s = t.frame, o = s ? s.ymax - s.ymin : 0, n = i && o ? i / o : 1, a = at.createIdentity();
	...
	drawTextSymbol(t, e, r) {
		if (!t) return;
		if (!t$20(e)) return;
		if (I$1(t.height, o$10.CIMTextSymbol.height) <= 0) return;
...
var ht = class extends lt {
	...
	bounds() {
		return o$7(this._xmin, this._ymin, this._xmax, this._ymax);
	}
	drawSolidFill(t) {
		if (t && !(this._clipCount > 0)) if (o$9(t)) this._processPath(t.rings, 0);
	...
	drawSolidStroke(t, e, r) {
		...
		const i = Math.max(.5 * this.transformSize(I$1(r, o$10.CIMSolidStroke.width)), .5 * ot);
		if (o$9(t)) this._processPath(t.rings, i);
	...
	drawMarkerLayer(t, e) {
		o$9(e) && t.markerPlacement && ("CIMMarkerPlacementInsidePolygon" === t.markerPlacement.type || "CIMMarkerPlacementPolygonCenter" === t.markerPlacement.type && t.markerPlacement.clipAtBoundary) ? this._processPath(e.rings, 0) : super.drawMarkerLayer(t, e);
	}
	drawHatchFill(t, e) {
...
var ct = class extends lt {
	...
	hitTest(t, e, r, i, s, a) {
		...
		if (this._mapRotation = e && ("CIMPointSymbol" === e.type && "Map" !== e.angleAlignment || "CIMTextSymbol" === e.type) ? s : 0, !has("esri-mobile")) {
			...
			!(("CIMLineSymbol" === e?.type || "CIMPolygonSymbol" === e?.type) && e.symbolLayers?.some(h$10)) && "CIMMeshSymbol" !== e?.type && (U$1(e) ?? 0) < r && (this._searchDistPoint = t);
		}
	...
	drawText(t, e) {
		...
		const s$17 = s(I$1(t.height, o$10.CIMTextSymbol.height)), { lineGapType: o, lineGap: n } = t, a$10 = o ? _t(o, I$1(n), s$17) : 0, l = "CIMBackgroundCallout" === t.callout?.type, h = A$1(i.glyphMosaicItems, {
			scale: s$17 / 24,
			angle: 0,
			xOffset: 0,
			yOffset: 0,
	...
	_hittestSvgPath(t, e, r, i = 0) {
		const s = this.reverseTransformScalar(this._searchDistPoint) * this.prevGeomUnitsPerPoint(), o = this.reverseTransformPt(this._searchPoint), n = u$7();
		f$4(n, t);
		const a = {
			x: n[0],
			y: n[1],
	...
	_hitTestStroke(t, e) {
		...
		} else if (o$9(t)) r = t.rings;
		else {
			if (!e$19(t)) return;
			r = t.paths;
		}
		dt(this.reverseTransformPt(this._searchPoint), r, I$1(e, o$10.CIMSolidStroke.width) * this.geomUnitsPerPoint() / 2 + this.reverseTransformScalar(this._searchDistPoint) * this.prevGeomUnitsPerPoint()) && (this._earlyReturn = !0);
	}
};
var mt = class extends lt {
	...
	drawSolidFill(t, e) {
		if (!t) return;
		if (o$9(t)) this._buildPath(t.rings, !0);
		else if (e$19(t)) this._buildPath(t.paths, !0);
		else if (n$22(t)) this._buildPath(gt(t).rings, !0);
		else {
			if (!i$11(t)) return;
	...
	drawSolidStroke(t, e, r, i, s, o) {
		...
		if (o$9(t)) this._buildPath(t.rings, !0);
			...
			if (!n$22(t)) return void console.log("CanvasDrawHelper.drawSolidStroke isn't implemented!");
	...
	pushClipPath(t) {
		if (this._ctx.save(), o$9(t)) this._buildPath(t.rings, !0);
		else if (e$19(t)) this._buildPath(t.paths, !0);
		else {
			if (!n$22(t)) return;
			this._buildPath(gt(t).rings, !0);
	...
	drawPictureStroke(t, r) {
		...
		if (o$9(t)) f = t.rings;
			...
			if (!n$22(t)) return i$11(t) ? void console.log("CanvasDrawHelper.drawPictureStroke - No implementation!") : void 0;
			f = gt(t).rings;
		}
		c || (c = m.width);
		...
		const p = Math.max(this.transformSize(u$8(c)), .5), g = p / d.width, _ = this._ctx, w = _.createPattern(d, "repeat-y");
		let M, b;
	...
	drawGradientFill(t, e) {
		...
		if (o$9(t)) r = t.rings;
			...
			if (!n$22(t)) return void nt().error("Unable to draw gradient fill");
			r = gt(t).rings;
		}
		this._buildPath(r, !0);
		const { angle: s, gradientMethod: n, gradientSize: a, gradientSizeUnits: l } = e, h = o$10.CIMGradientFill, g = e.gradientType ?? h.gradientType, _ = -s$14(s ?? 0), w = N$1();
		for (const i of r) {
			const t = i ? i.length : 0;
			if (t > 1) for (let e = 0; e < t; e++) {
				let t = this.transformPt(i[e]);
				"Linear" !== n && "Rectangular" !== n || (t = t$4(t, -_)), f$3(w, t);
			}
		}
		...
		switch (C.save(), n) {
			case "Buffered":
				...
				break;
			case "Linear": {
				const t = (M + k) / 2, r = "Absolute" === l ? this.transformSize(u$8(a)) : ee$1(a, h.gradientSize) * (b - x), [i, s] = "Discrete" === g ? [b, b - r] : [x + r, x], n = t$4([i, t], _), c = t$4([s, t], _), m = C.createLinearGradient(n[0], n[1], c[0], c[1]);
				p$4(m, e), C.fillStyle = m, C.fill("evenodd");
				break;
			}
			case "Circular": {
				const t = j$2(w), r = q$1(w) / 2, i = "Absolute" === l ? this.transformSize(u$8(a)) : ee$1(a, h.gradientSize) * r, [s, n] = "Discrete" === g ? [r, r - i] : [i, 0], c = C.createRadialGradient(t[0], t[1], s, t[0], t[1], n);
				p$4(c, e), C.fillStyle = c, C.fill("evenodd");
				break;
			}
			case "Rectangular": {
				const r = j$2(w), i = r[0], s = r[1], n = t$4(r, _), c = (r, i, s, o, a, l, h, c) => {
				...
				let m = "Absolute" === l ? this.transformSize(u$8(a)) : ee$1(a, h.gradientSize) * (p$3(w) / 2), [p, y] = "Discrete" === g ? [b, b - m] : [i + m, i];
				c(p, s, y, s, b, M, b, k), [p, y] = "Discrete" === g ? [x, x + m] : [i - m, i], c(p, s, y, s, x, k, x, M), m = "Absolute" === l ? this.transformSize(u$8(a)) : ee$1(a, h.gradientSize) * (b$1(w) / 2);
	...
	drawGradientStroke(t, r) {
		...
		if (o$9(t)) m = t.rings;
			...
			if (!n$22(t)) return void nt().error("Unable to draw gradient stroke");
			m = gt(t).rings;
		}
		const f = r.gradientType ?? o$10.CIMGradientStroke.gradientType, u = Math.max(this.transformSize(u$8(c)), .5), d = this._ctx;
		let p, g;
		...
		for (let _ of m) {
			...
			const i = "Absolute" === a ? this.transformSize(u$8(n)) : ee$1(n, o$10.CIMGradientStroke.gradientSize) * ("AcrossLine" === s ? u : t);
			let l = 0;
			p = this.transformPt(_[0]);
			for (let e = 1; e < _.length; e++) {
				g = this.transformPt(_[e]);
...
function ft(t, e, r) {
	let i = I$1(t.separation, o$10.CIMHatchFill.separation) * r, s = I$1(t.rotation);
	if (0 === i) return null;
	i < 0 && (i = -i);
	let o = 0;
	const n = .5 * i;
	...
	for (; o < -n;) o += i;
	const a = u$7();
	f$4(a, e), a[0] -= n, a[1] -= n, a[2] += n, a[3] += n;
	const h = [
		[a[0], a[1]],
		[a[0], a[3]],
		[a[2], a[3]],
...
var z = Math.PI, D = z / 2, G = Math.PI / 180, T = 96 / 72, E = 1.4142135623730951, v = 2, A = 4, R = () => n$20.getLogger("esri.symbols.cim.CIMSymbolHelper");
function j(e) {
	let t;
	switch (e.type) {
...
var N = class {
	...
	static _vectorMarkerBounds(e, t, r, o) {
		...
		if (t?.markerGraphics) for (const s of t.markerGraphics) {
			...
			s.geometry && (f$4(i, s.geometry), t[0] = 0, t[1] = 0, t[2] = 0, t[3] = 0, this.getSymbolInflateSize(t, s.symbol, r, 0, o), i[0] += t[0], i[1] += t[1], i[2] += t[2], i[3] += t[3], a ? (e[0] = i[0], e[1] = i[1], e[2] = i[2], e[3] = i[3], a = !1) : (e[0] = Math.min(e[0], i[0]), e[1] = Math.min(e[1], i[1]), e[2] = Math.max(e[2], i[2]), e[3] = Math.max(e[3], i[3])));
		}
		return e;
	}
			...
			switch (l.type) {
				...
				case "CIMPictureMarker": {
					...
					if (e.rotateClockwise && (n = -n), o && (n -= o), n) {
						const e = G * n, r = Math.cos(e), o = Math.sin(e), a = u$7([
							r$14,
							r$14,
							-r$14,
							-r$14
						]);
						f$3(a, [t[0] * r - t[1] * o, t[0] * o + t[1] * r]), f$3(a, [t[0] * r - t[3] * o, t[0] * o + t[3] * r]), f$3(a, [t[2] * r - t[1] * o, t[2] * o + t[1] * r]), f$3(a, [t[2] * r - t[3] * o, t[2] * o + t[3] * r]), t = a;
					}
	...
	static _getTextInflatedSize(e, t, r) {
		const o = s(t.height ?? o$10.CIMTextSymbol.height);
		if (e[0] = -o / 2, e[1] = -o / 2, e[2] = o / 2, e[3] = o / 2, !r) return e;
		const a$9 = r.get(t);
		if (!a$9) return e;
		if (!a$9.glyphMosaicItems.glyphs.length) return e;
		const { lineGapType: s$16, lineGap: i } = t, n = s$16 ? _t(s$16, i ?? 0, o) : 0, l = "CIMBackgroundCallout" === t.callout?.type, c = A$1(a$9.glyphMosaicItems, {
			scale: o / 24,
			angle: I$1(t.angle),
...
var _ = class _ {
	...
	static fromCIMHatchFill(e, r) {
		const o = r * (e.separation ?? o$10.CIMHatchFill.separation), a = o / 2, s = a$8(e.lineSymbol);
	...
	static fromCIMInsidePolygon(e) {
		...
		if ("Random" === t.gridType) {
			...
			const h = new t$18(t.seed), u = n * s / 1.5, M = n * i / 1.5;
			f = [];
...
//#endregion
export { g$1 as C, i$10 as D, f$2 as E, u$6 as O, P as S, c$3 as T, n$1 as _, j as a, O$1 as b, at as c, m as d, A$1 as f, e as g, s$1 as h, _ as i, ct as l, c as m, V as n, q as o, a$1 as p, Z as r, t as s, N as t, mt as u, t$2 as v, y$2 as w, w$1 as x, t$3 as y };

//# sourceMappingURL=CIMSymbolHelper-DcKQIRxE.js.map