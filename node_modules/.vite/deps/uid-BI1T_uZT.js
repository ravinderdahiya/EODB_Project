import { c as a$8, m as has, n as e$7 } from "./config-C57gEaHo.js";
import { m as o$11, n as n$9, t as r$7 } from "./Error-DugVwGnI.js";
import { t as e$8 } from "./MapUtils-JZJyk-b6.js";
import { c as e$9, d as o$12, f as u$5, t as a$9, u as n$10 } from "./tracking--iwQUXaz.js";
import { n as o$13 } from "./jsonMap-C92NlAVM.js";
//#region node_modules/@arcgis/core/core/accessorSupport/ensureType.js
var t$6 = () => n$9.getLogger("esri.core.accessorSupport.ensureTypes");
function r$6(e) {
	if (null == e) return e;
	const n = new Date(e);
	return isNaN(n.getTime()) ? (t$6().error("Accessor#set", `Invalid date value: '${e}', falling back to current date`), /* @__PURE__ */ new Date()) : n;
}
function o$10(e) {
	return null == e ? e : !!e;
}
...
function g$1(e, n) {
	return !!i$6(n) && (t$6().error("Accessor#set", "Assigning an instance of '" + (n.declaredClass || "unknown") + "' which is not a subclass of '" + h$1(e) + "'"), !0);
}
function m$3(e, n) {
...
function b$1(e) {
	switch (e) {
		case Number: return (e) => a$7(e);
		case D: return s$7;
		case Boolean: return o$10;
		case String: return u$4;
		case Date: return r$6;
		case _: return c$5;
...
function S(e, n) {
	...
	return (e, n) => {
		...
		return l && (r.has(e) || u.some((e) => "string" === c && e === String || "number" === c && e === Number)) || "object" === c && u.some((n) => !f$4(n, e)) ? e : (l && o.length ? (a || (a = o.map((e) => "string" == typeof e ? `'${e}'` : `${e}`).join(", ")), t$6().error("Accessor#set", `'${e}' is not a valid value for this property, only the following values are valid: ${a}`)) : "object" == typeof e && u.length ? (s || (s = u.map((e) => h$1(e)).join(", ")), t$6().error("Accessor#set", `'${e}' is not a valid value for this property, value must be one of ${s}`)) : t$6().error("Accessor#set", `'${e}' is not a valid value for this property`), n && (n.valid = !1), null);
	};
}
function x(e, n) {
	...
	return (n) => {
		...
		if (!u) return t$6().error("Accessor#set", `Invalid property value, value needs to be one of ${a()}, or a plain object that can autocast (having .type = ${s()})`), null;
		if (!f$4(e.typeMap[o], n)) return n;
		if ("string" == typeof e.key && !i$6(n)) {
			const t = {};
...
function F(e) {
	let n = null;
	return (r, o) => O(r, e) ? r : (n ??= L(e), t$6().error("Accessor#set", `Invalid property value, value needs to be of type ${n}`), o && (o.valid = !1), null);
}
function L(e) {
	switch (e.type) {
...
function e$6(t, n, r) {
	if (null == t) return t;
	const u = i$5(n[r], t);
	return !u && r < n.length - 1 ? void 0 : r === n.length - 1 ? u : e$6(u, n, r + 1);
}
function u$3(n, r, u = 0) {
	return "string" != typeof r || r.includes(".") ? e$6(n, o$12(r), u) : i$5(r, n);
}
function o$9(t, n) {
	return u$3(t, n);
}
function s$6(t, n) {
	return void 0 !== u$3(n, t);
}
//#endregion
...
var a$6 = /^(?:[^.]+\.)?(?:value|type|(?:json\.type|json\.origins\.[^.]\.type))$/;
function n$8(t) {
	return a$6.test(t) ? "replace" : "merge";
}
//#endregion
...
function n$7(r, t) {
	if (has("esri-unknown-property-errors") && !e$5(r, t)) throw new r$7("set:unknown-property", s$5(r, t));
}
function e$5(o, r) {
...
function m$2(n = {}) {
	return (s, i) => {
		...
		c$4(c, n), n.range && (c.cast = l$4(c.cast, n.range));
	};
}
function j$1(t, e, r) {
	const o = o$8(t, r);
...
var r$4 = Object.prototype.toString;
function o$6(n) {
	...
	return function(...t) {
		...
		return e$4.apply(this, t);
	};
}
function e$4(t, r, o, e) {
	o$8(t, r).cast = e;
}
function i$4(t) {
	return (r, o) => {
...
function s$4(...t) {
	if (3 !== t.length || "string" != typeof t[1]) return 1 === t.length && "[object Function]" === r$4.call(t[0]) ? o$6(t[0]) : 1 === t.length && "string" == typeof t[0] ? i$4(t[0]) : void 0;
}
//#endregion
//#region node_modules/@arcgis/core/core/accessorSupport/beforeDestroy.js
var o$5 = Symbol("Accessor-beforeDestroy");
//#endregion
...
function n$5(n, i) {
	return o$4(n, "any", i?.origin);
}
function i$3(n, i) {
	return o$4(n, "read", i?.origin);
}
function r$3(n, i) {
	return o$4(n, "write", i?.origin);
}
function o$4(n, i, r) {
	let o = n?.json;
	if (o?.origins && r) {
...
].map((e) => `${e}:unsupported`), n$4 = new Set(o$3);
function t$3(e, r, o) {
	if (!e) return;
...
function a$5(o, n, t, i, s) {
	o && o?.messages?.push(l$3("warning" === n ? t$4 : r$7, t, i, s));
}
function p$4(r, o, n) {
...
function u$2(t, r, o) {
	t && (!o && !r.read || r.read?.reader || !1 === r.read?.enabled || m$1(t) && e$7("read.reader", s$2(t), r));
}
function s$2(t) {
...
function b(t, e, o) {
	const i = Object.values(e)[0], p = r$5(i.prototype)[t], s = i$3(p, o)?.read?.source;
	return s && "string" == typeof s ? s : t;
}
function A(t) {
	const e = {};
	for (const o in t.typeMap) {
		const n = t.typeMap[o], i = r$5(n.prototype);
...
function e$2(e) {
	if (e.json || (e.json = {}), o$2(e.json), n$3(e.json), r$2(e.json), e.json.origins) for (const t in e.json.origins) o$2(e.json.origins[t]), n$3(e.json.origins[t]), r$2(e.json.origins[t]);
	return !0;
}
function r$2(e) {
...
function o$1(r, t) {
	...
	r && (1 === n || "type" in r && e$3(r.type)) ? t.write.writer = a$3 : n > 1 ? t.write.writer = l$1(n) : t.types ? Array.isArray(t.types) ? t.write.writer = f$2(t.types[0]) : t.write.writer = i$1(t.types) : t.write.writer = s$1;
}
function i$1(r) {
	return (t, e, n, o) => t ? u$1(t, r, o) ? s$1(t, e, n, o) : void 0 : s$1(t, e, n, o);
}
function u$1(t, e, o) {
...
function f$2(r) {
	return (t, e, n, o) => {
		if (!t || !Array.isArray(t)) return s$1(t, e, n, o);
		return s$1(t.filter((t) => u$1(t, r, o)), e, n, o);
	};
}
function s$1(r, e, n, o) {
	e$7(n, p$2(r, o), e);
}
function p$2(r, t) {
...
function s(r) {
	...
	if (r.json.origins) for (const o in r.json.origins) {
		...
		u$2(n, s, !1), s.types && !s.write && r.json.write?.enabled && (s.write = { ...r.json.write }), o$1(n, s);
	}
	u$2(e, r.json, !0), o$1(e, r.json);
}
function n$2(r) {
...
function l(e) {
	return (s) => {
				...
				if (super(...e), this.constructor === u && "function" == typeof this.postscript) {
					if (i.length && Object.defineProperty(this, "initialize", {
						...
						Object.defineProperty(this, "destroy", {
							...
							value() {
								if (!e) {
									this.__accessor__.lifecycle = I.DESTROYING, e = !0, o.call(this);
		...
		u.__accessorMetadata__ = r$5(s.prototype), u.prototype.declaredClass = e;
...
function f(e, t) {
	return t.readOnly && t.constructOnly ? function(o) {
		...
		if (s) {
			if (s.mutable) return s.initialized && t.readOnly ? y("read-only", e) : s.lifecycle === I.CONSTRUCTED && t.constructOnly ? y("construct-only", e) : void s.set(e, o);
		} else u(this, e, o);
		...
		const s = this.__accessor__;
		if (s) {
			if (s.mutable) return s.lifecycle === I.CONSTRUCTED && t.constructOnly ? y("construct-only", e) : void s.set(e, o);
		} else u(this, e, o);
	} : function(t) {
		const r = this.__accessor__;
...
var e$1 = class e$1 {
	...
	acquire(...t) {
		let s;
		if (e$1.test.disabled) s = this._creator();
		else {
		...
		return this._acquireFunction ? this._acquireFunction(s, ...t) : i(s) && s.acquire(...t), s;
	}
	release(i) {
		i && !e$1.test.disabled && (this._releaseFunction ? this._releaseFunction(i) : t$1(i) && i.release(), this._pool.push(i));
	}
...
//#endregion
export { r$5 as A, m$3 as B, I as C, m$2 as D, j$1 as E, B as F, u$4 as H, D as I, _ as L, s$6 as M, u$3 as N, t$5 as O, A$1 as P, a$7 as R, r$3 as S, s$4 as T, w as U, s$7 as V, x as W, s$3 as _, m as a, i$3 as b, o as c, y$2 as d, s$2 as f, p$4 as g, n$4 as h, c as i, o$9 as j, o$8 as k, r$1 as l, i$2 as m, e$1 as n, r as o, a$5 as p, a as r, n as s, e as t, l as u, t$3 as v, o$5 as w, n$5 as x, t$4 as y, l$4 as z };

//# sourceMappingURL=uid-BI1T_uZT.js.map