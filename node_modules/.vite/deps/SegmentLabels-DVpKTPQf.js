...
import { L as e$1 } from "./promiseUtils-CsEq-Eti.js";
import { t as b } from "./Accessor-CPmfB7ST.js";
import { M as te, g as ae } from "./units-BF_YTgze.js";
import { a as i, c as o, n as c$1, p as v, r as e$2 } from "./curveUtils-BmykpmD9.js";
import { a as g } from "./coordsUtils-DpHTo7QO.js";
import { b as s } from "./mathUtils-P0nOPmqm.js";
import { C as u, _ as l$1, d as b$1, u as _, w as v$1, y as o$1 } from "./vec2-bUkL91WX.js";
import { c as h$2, d as l$2, i as p$1, m as h$1, n as d, x as p } from "./curveExtent-DCdbsSAV.js";
import { t as g$1 } from "./Color-BP7Uz-ie.js";
import { r as a$2, s as l$3 } from "./reactiveUtils-COPg0EH3.js";
import { t as y } from "./Polyline-BReR2xtn.js";
import { i as f } from "./screenUtils-BxUp6TCn.js";
import { t as f$1 } from "./messages-56_mB6Yo.js";
import { r as R$1 } from "./intl-CUhw_iYT.js";
import { o as w } from "./asyncUtils-CkOE2Ohe.js";
import "./projector-C24GfQsA.js";
import { i as n$2 } from "./vec2f64-ZzLQFmIC.js";
import { c as b$2, m as k } from "./elevationInfoUtils-DoncPS25.js";
import { r as D, s as P } from "./colorUtils-D-6ViMqd.js";
import { t as e$3 } from "./getDefaultUnitForView-BlIiebfm.js";
import { a as U } from "./quantityFormatUtils-BF2W6v9w.js";
import { t as i$1 } from "./vec3-Cx41MNjq.js";
...
function n$1(n, p$2, u) {
	...
	if (c$1(p$2)) return h$1(l$2(n, p$2), u);
...
var n = class extends b {
	...
	constructor(t) {
		super(t), this.x = 0, this.y = 0, this.text = "-", this.fontSize = 14, this.anchor = "center", this.visible = !0, this.isDecoration = !0, this.backgroundColor = new g$1([
			0,
			0,
			0,
			.6
		]), this.textColor = new g$1([
			255,
			255,
			255
...
var V = class extends b {
	...
	initialize() {
		this.addHandles([
			...
			l$3(() => this._colors, (e) => this._updateStyle(e)),
	...
	get _colors() {
		const e = this.context?.view.effectiveTheme.textColor ?? g$1.fromArray([
			255,
			255,
			255
		]);
	...
	_addLabel(e, t, s, o, r, i, n, a = !1) {
		...
		if (n ? o$1(q, -u$1, d) : o$1(q, u$1, -d), v$1(q, q), l$1(q, q, this._edgeDistancePixels), r && !e$2(r)) {
...
//# sourceMappingURL=SegmentLabels-DVpKTPQf.js.map