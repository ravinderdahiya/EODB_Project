import { C as html, D as css, T as nothing, a as getConfig, b as createEvent, d as setAttribute, l as safeClassMap, m as ref, p as createRef, r as customElement, s as LitElement } from "./runtime-Cllue3Uy.js";
import { t as guid } from "./guid-TwSvx4rK.js";
import { n as makeGenericController } from "./controllers-4WzZHAd5.js";
import { t as useT9n } from "./useT9n-Cp25OQfM.js";
import { b as toAriaBoolean, d as isKeyboardTriggeredClick, f as isPrimaryPointerButton, m as queryElementRoots, n as focusElement, y as tabbableOptions } from "./dom-B3xBdYim.js";
import { t as createObserver } from "./observers-CGkOrAXK.js";
import { t as keyed } from "./keyed-CcORvDF2.js";
import { t as useSetFocus } from "./useSetFocus-EUcI8hiR.js";
import { n as isAction } from "./calcite-action-CJGsZPg3.js";
import { c as filterValidFlipPlacements, l as hideFloatingUI, n as FloatingCSS, o as defaultOffsetDistance, r as connectFloatingUI, s as disconnectFloatingUI, t as useTopLayer, u as reposition } from "./useTopLayer-Db1crgVB.js";
import { t as toggleOpenClose } from "./openCloseComponent-BPU6LX5N.js";
import { n as literal, r as unsafeStatic, t as html$1 } from "./static-html-DLijWxA2.js";
import { t as FloatingArrow } from "./FloatingArrow-DR8VHEP1.js";
import { t as isActivationKey } from "./key--aSnSprE.js";
...
var Popover = class extends LitElement {
	...
	renderCloseButton() {
		...
		return closable ? keyed(CSS$1.closeButtonContainer, html`<div class=${safeClassMap(CSS$1.closeButtonContainer)}><calcite-action class=${safeClassMap(CSS$1.closeButton)} icon=x @click=${this.hide} .scale=${this.scale} .text=${messages.close}></calcite-action></div>`) : null;
	}
	renderHeader() {
		...
		return headingNode ? keyed(CSS$1.header, html`<div class=${safeClassMap(CSS$1.header)}>${headingNode}${this.renderCloseButton()}</div>`) : null;
	}
	render() {
		...
		this.el.role = "dialog";
		return html`<div class=${safeClassMap(CSS$1.positionContainer)} popover=manual ${ref(this.setFloatingEl)}><div class=${safeClassMap({
		...
		})}>${this.renderHeader()}<div class=${safeClassMap(CSS$1.content)}><slot></slot></div>${!heading ? this.renderCloseButton() : null}</div></div></div>`;
	}
};
customElement("calcite-popover", Popover);
//#endregion
//#region node_modules/@esri/calcite-components/dist/chunks/array.js
...
//#endregion
export { useFocusTrap as n, Heading as r, SLOTS as t };

//# sourceMappingURL=calcite-action-menu-BiOiOPAS.js.map