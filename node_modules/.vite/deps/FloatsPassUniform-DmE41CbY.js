...
import { r as n, s as u } from "./guards-DodfP_K1.js";
import { y as r$2 } from "./mathUtils-Dq5Y4VHb.js";
import { f as n$1 } from "./mat3-DxOI3d8W.js";
import { t as e$2 } from "./mat3f64-1IXmfvk0.js";
import { c as o$1, i as c$1, s as n$2 } from "./vec3f64-C0R7gEMc.js";
import { t as e$3 } from "./mat4f64-BL2UM2bh.js";
import { C as l, E as o$2, T as n$3, h as c$2, j as x, k as r$3, v as f, w as m, x as i } from "./mat4-Tm-zK1-H.js";
import { t as m$1 } from "./lengthUtils-CXfxvg7s.js";
import { f as r$4 } from "./vec4-BUvMTBW6.js";
import { r as i$1 } from "./vec4f64-CNVTVVzP.js";
import { O as o$3, j as u$1 } from "./vec3-BsfrqlWE.js";
import { t as i$2 } from "./Uniform-DOkQwI5P.js";
...
function D(t, o, e, s, i) {
	const r = t.minSize, n$4 = t.maxSize;
	if (t.useSymbolValue) {
		const t = s.symbolSize[e];
		return o.minSize[e] = t, o.maxSize[e] = t, o.offset[e] = o.minSize[e], o.factor[e] = 0, o.type[e] = 1, !0;
	}
	return P(t.field) || P(t.valueExpression) ? P(t.stops) ? 2 === t.stops.length && n(t.stops[0].size) && n(t.stops[1].size) ? (F(t.stops[0].size, t.stops[1].size, t.stops[0].value, t.stops[1].value, o, e), o.type[e] = 1, !0) : (T(i, "Could not convert size info: stops only supported with 2 elements"), !1) : n(r) && n(n$4) && P(t.minDataValue) && P(t.maxDataValue) ? (F(r, n$4, t.minDataValue, t.maxDataValue, o, e), o.type[e] = 1, !0) : "unknown" === t.valueUnit ? (T(i, "Could not convert size info: proportional size not supported"), !1) : null != m$1[t.valueUnit] ? (o.minSize[e] = -Infinity, o.maxSize[e] = Infinity, o.offset[e] = 0, o.factor[e] = 1 / m$1[t.valueUnit], o.type[e] = 1, !0) : (T(i, "Could not convert size info: scale-dependent size not supported"), !1) : t.stops?.[0] && n(t.stops[0].size) ? (o.minSize[e] = t.stops[0].size, o.maxSize[e] = t.stops[0].size, o.offset[e] = o.minSize[e], o.factor[e] = 0, o.type[e] = 1, !0) : n(r) ? (o.minSize[e] = r, o.maxSize[e] = r, o.offset[e] = r, o.factor[e] = 0, o.type[e] = 1, !0) : (T(i, "Could not convert size info: unsupported variant of sizeInfo"), !1);
}
...
function Y(t, i) {
	const r = new X(t);
	return r.vvSize && (r.vvSymbolAnchor = i.anchor, o$2(nt), U(i.rotation[2], i.rotation[0], i.rotation[1], nt), r.vvSymbolRotationMatrix = r.vvSymbolRotationMatrix || e$2(), n$1(r.vvSymbolRotationMatrix, nt)), r;
}
function Z(t, o, e) {
...
//# sourceMappingURL=FloatsPassUniform-DmE41CbY.js.map