...
import { r as i$1 } from "./config-BvnHHLFh.js";
import { t as b$1 } from "./Accessor-C495Hp5e.js";
import { C as L$1, E as O$1, P as h } from "./typedArrayUtil-BAuNmygZ.js";
import { k as e$2 } from "./promiseUtils-DQTPPyja.js";
import { n as c, t as a$2 } from "./decorators-DNvoMvUC.js";
import { i as r$3 } from "./Evented-BHes3AIJ.js";
import { b as s$4, y as r$4 } from "./mathUtils-Dq5Y4VHb.js";
import { i as G } from "./spatialReferenceUtils-DFtdTnNk.js";
import { t as _$1 } from "./Point-IZafMjJg.js";
import { D as z$3, S as r$5, g as k$2, h as j$1, i as I, l as T$1, p as e$3, u as _$2, v as m$3, w as v$2 } from "./vec2-DD9Lt6SG.js";
import { _ as M$4, c as h$1, d as l$2, f as u, i as p$1, l as n$4, s as x$2 } from "./curveExtent-1Dkpx_J0.js";
import { g as s$5 } from "./mat3-DxOI3d8W.js";
import { t as e$4 } from "./mat3f64-1IXmfvk0.js";
import { a as i$2, c as o$2, n as c$1, p as v$3, r as e$5, u as s$6 } from "./curveUtils-BIVZ_WWm.js";
import { t as m$4 } from "./Multipoint-BMd1GRBO.js";
import { t as j$2 } from "./Polygon-DVpFKUwp.js";
import { t as y$2 } from "./Polyline-BEScFVSf.js";
import { d as t$5, f as u$1, l as r$6, s as n$5 } from "./vec3f64-C0R7gEMc.js";
import { n as n$6 } from "./uuid-Dis-U6Ct.js";
import { f as r$7, o as j$3, r as O$2 } from "./vec4-BUvMTBW6.js";
import { a as r$8, c as u$2, i as n$7 } from "./vec4f64-CNVTVVzP.js";
import { a as o$3, i as n$8, o as r$9 } from "./vec2f64-DBnievnq.js";
import { N as x$3, O as o$4, P as y$3, _ as _$3, a as G$1, i as F$1, j as u$3, k as p$2, l as P$1, s as I$1, t as A$1, y as c$2 } from "./vec3-BsfrqlWE.js";
import { E as m$5, T as f$1, b as q$1, c as O$3, d as R$3, g as X$1, i as J, m as U$1, w as y$4, x as v$4 } from "./plane-BksdM5qJ.js";
import { d as p$3, g as z$4, i as c$3, l as k$3, o as f$2, p as s$7, s as g, t as C$1 } from "./quantity-DzPNPHKG.js";
import { r as F$2 } from "./quantityFormatUtils-CmVvWu0u.js";
import { t as M$5 } from "./geometry2dUtils-o1zUUjW2.js";
import { d as B, f as C$2, g as w$2, m as J$1, p as H$1, u as A$2 } from "./SketchTooltipInfo-Bh4BPG1u.js";
import { o as w$3, t as M$6 } from "./angularMeasurementUtils-BjMHIz1m.js";
import { t as c$4 } from "./rotate-Dmb29R2H.js";
import { n as m$6, t as c$5 } from "./curveOperationUtils-DGGPQ9Nu.js";
//#region node_modules/@arcgis/core/views/interactive/tooltip/fields/TooltipField.js
var s$3 = class extends b$1 {
	constructor(t) {
		super(t), this.actual = null, this.lockable = !0, this.id = n$6(), this.inputValue = null, this.name = null, this.readOnly = !1, this.suffix = null, this.visible = !0, this.invalid = !1, this.unlockOnVertexPlacement = !0, this.displayOrder = 0;
	}
	get committed() {
	...
	_toPolygon() {
		...
		for (const i of this.parts) {
			...
			if (i.autoClose && n.length > 1) {
				const e = n.at(-1), r = v$3(n[0]), i = v$3(e);
				2 === n.length && e$5(e) || h(r, i) || n.push(r);
			}
			e.push(n);
		}
		return new j$2({
...
function C(t, e, r, h) {
	...
	if ("point" === r) {
		const e = t.at(0)?.at(0);
		return e ? h.arrayToPoint(v$3(e)) : null;
	}
	return "polygon" === r ? new j$2({
		rings: e ? void 0 : t,
		...
		spatialReference: a,
		points: t.flatMap((t) => t.map((t) => v$3(t))),
		hasM: h.hasM(),
		hasZ: h.hasZ()
	}) : new y$2({
		paths: e ? void 0 : t,
...
function S$1(r, i) {
	...
	for (const p of r.parts) {
		...
		s && p.autoClose && m && r === v && g === d && (u.length > 2 || 2 === u.length && !e$5(m)) && g?.pos && !h(v$3(m), g.pos) && u.push([...g.pos]), n.push(u);
	}
	return {
		parts: n,
		hasCurves: a
...
function R(e, r, i, s) {
	...
	for (let p = 0; p < l.length; ++p) {
		...
		r.length > 1 && h(v$3(r[r.length - 1]), a?.pos) ? c && a && s.segments.push(_(s, c, a, r[r.length - 1])) : c = P(s, h$3, c, r[r.length - 1]);
	}
}
...
var r$1 = class {
	...
	apply() {
		...
		const h = d.getLastVertex(), a = n.coordinateHelper.arrayToVector(v$3(l));
...
var a = class a {
	...
	undo() {
		...
		t && this._originalPosition && this._replaceEdge(t, this._vertex, this._originalPosition), this._vertex.pos = this._editGeometry.coordinateHelper.arrayToVector(v$3(this._originalPosition)), this._editGeometry.notifyChanges({
			operation: "undo",
	...
	_apply(n) {
		this._vertex.pos = this._editGeometry.coordinateHelper.arrayToVector(v$3(this._pos));
		const a = this._pos, c = this._vertex.leftSegment;
		switch (c?.type) {
			case void 0: break;
			case "line":
				e$5(a) || this._replaceEdge(c, this._vertex, a);
				break;
			case "bezier":
			...
			case "elliptic-arc-4":
				...
				break;
			case "elliptic-arc-7": s$6(a) ? (c.curveDefinition.centerPoint = a.a[1], c.curveDefinition.sweep = a.a[2], c.curveDefinition.orientation = a.a[3], c.curveDefinition.rotation = a.a[4], c.curveDefinition.semiMajorAxisLength = a.a[5], c.curveDefinition.minorMajorAxisRatio = a.a[6]) : this._replaceEdge(c, this._vertex, a);
		}
...
var M = class M {
	...
	_initializeNeighbors() {
		...
		this._edgeDirection = G$1(n$5(), t, e), i ? (this._left = this._computeNeighbor(t, i, this._edgeDirection), this._right = this._computeNeighbor(e, s, this._edgeDirection, this._left)) : (this._right = this._computeNeighbor(e, s, this._edgeDirection), this._left = this._computeNeighbor(t, i, this._edgeDirection, this._right));
	}
	_toXYZ(t) {
	...
	_bisectVectorsPerpendicular(t, i) {
		const e = A$1(t, i) < 0 ? t : y$3(n$5(), t), s = Math.abs(A$1(e, i));
	...
	_computeNormalDirection(t) {
		const i = P$1(n$5(), t.direction, this._edgeDirection);
		_$3(i, i);
		const e = P$1(n$5(), this._edgeDirection, i);
	...
	_updateIntersectDistanceConstraint(t) {
		const i = y$4(t), h = this._edgeDirection, o = c$2(n$5(), this._left.start, this._left.direction), a = c$2(n$5(), this._right.start, this._right.direction), _ = this._pointInBasis2D(n$8(), i, h, this._left.start), l = this._pointInBasis2D(n$8(), i, h, o), p = this._pointInBasis2D(n$8(), i, h, this._right.start), d = this._pointInBasis2D(n$8(), i, h, a), [m] = M$5({
			start: l,
			end: _,
			type: 1
		}, {
		...
		const u = e$3(n$8(), _, l);
		v$2(u, u);
		const x = j$1(u, e$3(n$8(), m, l)), N = X$1(t, c$2(n$5(), o, x$3(n$5(), this._left.direction, -x)));
	...
	_offset(t, i) {
		...
		const e = (t, i, e) => null != i && J(this._offsetPlane, t, c$2(n$5(), t, i), e), s = n$5();
	...
	clampedStartAndEnd(i) {
		const e = this._helper.toXYZ(this._helper.pointToVector(i)), s = R$3(this._plane, e, n$5()), n = X$1(this._plane, e);
	...
	clone() {
		...
		return q$1(t._plane, this._plane), q$1(t._offsetPlane, this._offsetPlane), t._maxDistance = this._maxDistance, t._minDistance = this._minDistance, t._left = this._cloneNeighbor(this._left), t._right = this._cloneNeighbor(this._right), t._edgeDirection = o$4(n$5(), this._edgeDirection), t;
	}
...
function m(t, a, l, m, h, p, u) {
	switch (t?.type) {
		...
		case "elliptic-arc-7": {
			if (!u) return;
			const r = t.leftVertex.pos, x$4 = c$5(a[0], a[1], l[0], l[1], m[0], m[1], h, p), g = s$5(e$4(), x$4), j = g ? z$3(n$8(), [r[0], r[1]], g) : r, [, y, _, v, b, d, A] = m$6(u, [j[0], j[1]], t, a, l, m, h, p).a;
...
//# sourceMappingURL=SnappingContext-CZLh-PMj.js.map