import { r as M$2 } from "./mathUtils-Dq5Y4VHb.js";
import { A as re } from "./units-XYZmVlT8.js";
import { t as _ } from "./Point-IZafMjJg.js";
import { C as o$1, _ as M$3, a as q$1, c as h$2, d as l, f as u$1, h as u, i as p$1, l as n, p as f$2, r as g$2, s as x$1, v as b, y as d$2 } from "./curveExtent-1Dkpx_J0.js";
import { a as i$1, c as o$2, n as c, o as l$1, p as v$3, r as e$1 } from "./curveUtils-BIVZ_WWm.js";
import { t as j$1 } from "./Polygon-DVpFKUwp.js";
import { t as u$2 } from "./closestPointOnCurve-BFCiB9jF.js";
...
function f(f, n, p = 1) {
	...
	if (c(n)) {
		const r = l(f, n);
		return r.isInvalid ? Math.sqrt(o$1(f, n.c[0])) : f$2(r);
	}
	if (o$2(n)) {
		const r = h$2(f, n);
		return r.isInvalid ? Math.sqrt(o$1(f, n.a[0])) : f$2(r);
	}
	return g$2(f, n, p);
}
//#endregion
...
function v$1(t, i, s, e) {
	const u$3 = l(t, i);
	if (u$3.isInvalid) return [l$1(i)];
	const { t: f, distance: l$2 } = u(u$3, s);
	return l$2 <= e ? u$1(u$3, i, f) : [l$1(i)];
}
function A(t, i, n$1, o) {
	const s = h$2(t, i);
	if (s.isInvalid) return [l$1(i)];
	const { t: e, distance: u$4 } = u(s, n$1);
	return u$4 <= o ? n(s, i, e) : [l$1(i)];
}
function I$1(t, i, r, n) {
	const o = p$1(t, i);
	if (o.isInvalid) return [l$1(i)];
	const { t: s, distance: e } = q$1(o, r);
	return e <= n ? x$1(o, i, s) : [l$1(i)];
}
function h(t, i, r, n) {
	return e$1(i) ? [l$1(i)] : i$1(i) ? U(t, i, r, n) : c(i) ? v$1(t, i, r, n) : o$2(i) ? A(t, i, r, n) : I$1(t, i, r, n);
}
//#endregion
...
//# sourceMappingURL=measures-BvVeqEEh.js.map