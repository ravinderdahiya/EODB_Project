import { P as h$1, _ as t$1, a as a$2, c as e$2, g as s$1, h as r, l as f$1, m as o$1, o as c, v as u$1 } from "./typedArrayUtil-BAuNmygZ.js";
//#region node_modules/@arcgis/core/core/has.js
var e$1 = globalThis, a$1 = { ...e$1.esriConfig?.has };
function has(d) {
	return "function" == typeof a$1[d] ? a$1[d] = a$1[d](e$1) : a$1[d];
}
has.add = (e, d, r, t) => {
	...
	has.add("host-webworker", void 0 !== e$1.WorkerGlobalScope && self instanceof e$1.WorkerGlobalScope);
	...
	if (has.add("host-browser", a), has.add("host-node", !("object" != typeof e$1.process || !e$1.process.versions?.node || !e$1.process.versions.v8)), has.add("dom", a), has("host-browser")) {
	...
	has.add("esri-wasm", "WebAssembly" in e$1), has.add("esri-performance-mode-frames-between-render", 20), has.add("esri-force-performance-mode", !1), has.add("esri-shared-array-buffer", () => {
		const a = "SharedArrayBuffer" in e$1, d = !1 === e$1.crossOriginIsolated;
		return a && !d;
	}), has.add("wasm-simd", () => {
	...
	}), has.add("esri-atomics", "Atomics" in e$1), has.add("esri-workers", "Worker" in e$1), has.add("web-feat:cache", "caches" in e$1), has.add("esri-workers-arraybuffer-transfer", !has("safari") || Number(has("safari")) >= 12), has.add("workers-pool-size", 8), has.add("featurelayer-simplify-thresholds", [
		.5,
		.5,
		.5,
		.5
...
function l$1(t, n) {
	let e;
	if (n) for (e in t) t.hasOwnProperty(e) && (void 0 === t[e] ? delete t[e] : t[e] instanceof Object && l$1(t[e], !0));
...
function O(t) {
	if (r(t) || t$1(t) || u$1(t) || o$1(t) || c(t) || e$2(t) || a$2(t) || f$1(t) || s$1(t)) return t.slice();
...
function h(n, e) {
	return n === e || (null == n || "string" == typeof n ? n === e : "number" == typeof n ? n === e || "number" == typeof e && isNaN(n) && isNaN(e) : n instanceof Date ? e instanceof Date && n.getTime() === e.getTime() : Array.isArray(n) ? Array.isArray(e) && h$1(n, e) : n instanceof Set ? e instanceof Set && N(n, e) : n instanceof Map ? e instanceof Map && T(n, e) : !!g(n) && g(e) && w(n, e));
}
function w(t, n) {
...
function i(r, n) {
	...
	if ("object" == typeof r) {
		...
		for (const t in r) if (i(r[t], n[t])) return !0;
		return !1;
	}
	return r !== n;
}
...
function f(n, t, e) {
	return t ? Object.keys(t).reduce((n, i) => {
		...
		}) : n[i] = o.slice())) : o && "object" == typeof o ? n[i] = f(u, o, e) : n.hasOwnProperty(i) && !t.hasOwnProperty(i) || (n[i] = o), n);
	}, n || {}) : n;
}
function o(r, n) {
...
if (globalThis.esriConfig && (n(s, globalThis.esriConfig, !0), delete s.has), !s.assetsPath) {
	s.assetsPath = `https://js.arcgis.com/5.0.16/@arcgis/core/assets`;
	s.defaultAssetsPath = s.assetsPath;
}
//#endregion
export { n as a, a as c, l$1 as d, p as f, l as i, h as l, has as m, e as n, o, y as p, i as r, t as s, s as t, j as u };

//# sourceMappingURL=config-BvnHHLFh.js.map