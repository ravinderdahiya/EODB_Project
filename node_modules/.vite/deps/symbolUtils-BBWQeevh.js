...
import { G as e } from "./fieldUtils-Du6qy8H2.js";
import "./Color-DUA_J43M.js";
import "./assets-BLKGLVcU.js";
import { o as S } from "./typeUtils-BaBWbmRW.js";
import "./layerUtils-DqdiS7uu.js";
import "./Widget-Dsg84Cmh.js";
import { t as i } from "./projector-DCLeBVgo.js";
import "./mat2d-7UUi8-nE.js";
import "./mat2df32-DrzpywWA.js";
import "./colorUtils-B1quUh3Q.js";
import { i as N, n as L$1, r as M } from "./utils-Q_wIklXV.js";
import "./webStyleSymbolUtils-j9-cOMe1.js";
has("android");
has("chrome");
i();
//#endregion
//#region node_modules/@arcgis/core/widgets/Legend/styles/support/relationshipUtils.js
var b = "esri-relationship-ramp", m = `${b}--diamond`, u = `${b}--square`;
`${m}`, `${m}`, `${m}`, `${m}`, `${m}`, `${m}`, `${u}`, `${u}`, `${u}`, `${u}`, `${u}`, `${u}`, `${u}`, `${u}`;
//#endregion
...
async function R(e$2, t) {
	...
	const { getColor: n, getOpacity: f, getAllSizes: y, getRotationAngle: h } = await import("./visualVariableUtils-3yW1nOtv.js").then((n) => n.i), m = [], d = [], b = [], g = [];
...
function j(e) {
	return !S(e) || "water" !== e.symbolLayers.at(0)?.type;
}
function I(e) {
...
//# sourceMappingURL=symbolUtils-BBWQeevh.js.map