...
import { t as n$1 } from "./assets-BLKGLVcU.js";
import { t as S$1 } from "./SpatialReference-CmWpkrZX.js";
import { a as u, n as f } from "./DoubleArray-Q5q-x--Z.js";
import { n as c, t as i$1 } from "./MeshLocalVertexSpace-BRygsolF.js";
import { n as d$1, o as n$2 } from "./vec3-BIWz5Ipa.js";
import { i as h$1, t as a } from "./SceneLayerWorkerHandle-DtO_O5vS.js";
//#region node_modules/@arcgis/core/libs/i3s/I3SModule.js
function s() {
	return n ??= (async () => {
		return await (await import("./i3s-mgdXA7c6.js")).default({ locateFile: (s) => n$1(`esri/libs/i3s/${s}`) });
	})(), n;
}
function i() {
	n = null;
...
async function g(e) {
	...
	let y;
	const [{ projectBuffer: h }, { initializeProjection: d }] = await Promise.all([import("./projectBuffer-C7gRf4sD.js").then((n) => n.n), import("./projectionUtils-CmrwAiSI.js").then((n) => n.p)]);
	await d(l, u$1);
	const g = [
		0,
		0,
	...
	if ("georeferenced" === c$1.type && null == c$1.origin) {
		...
		const e = "georeferenced" === c$1.type ? c.fromJSON(c$1) : i$1.fromJSON(c$1), { projectMeshVertexPositions: r } = await import("./projectMeshVertexPositions-BqbMhJNn.js").then((n) => n.n), t = r({
...
//# sourceMappingURL=SceneLayerWorker-YVXj31yz.js.map