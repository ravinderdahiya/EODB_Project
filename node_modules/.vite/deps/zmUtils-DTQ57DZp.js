import { S as u$2, v as o$2 } from "./aaBoundingRect-DXOOBtNm.js";
import { t as n } from "./curveExtent-1Dkpx_J0.js";
import { p as v$2, r as e$1 } from "./curveUtils-BIVZ_WWm.js";
...
var m$1 = h$2(Math.min), a$1 = h$2(Math.max);
function f$1(n, t) {
	return s$1(t) ? y$1(n, t.curvePaths ?? t.paths, !1, !1) ?? n : l$1(t) ? y$1(n, t.curveRings ?? t.rings, !1, !1) ?? n : u$1(t) ? p(n, t.points, !1, !1, !1, !1) : o$1(t) ? d$1(n, t) : (c$1(t) && (n[0] = t.x, n[1] = t.y, n[2] = t.x, n[3] = t.y), n);
}
function x$1(n) {
	let i, r, e, o;
...
function v$1(n, t) {
	return s$1(t) ? y$1(n, t.curvePaths ?? t.paths, !0, !1) ?? n : l$1(t) ? y$1(n, t.curveRings ?? t.rings, !0, !1) ?? n : u$1(t) ? p(n, t.points, !0, !1, !0, !1) : o$1(t) ? d$1(n, t, !0, !1, !0, !1) : (c$1(t) && (n[0] = t.x, n[1] = t.y, n[2] = t.z, n[3] = t.x, n[4] = t.y, n[5] = t.z), n);
}
function y$1(t, o, u, c) {
	const s = u ? 3 : 2;
	...
	for (let p = 0; p < o.length; p++) {
		...
		for (let o = 0; o < t.length; o++) {
			...
			if (g = m$1(g, M), v = m$1(v, z), y = a$1(y, M), d = a$1(d, z), u && p.length > 2) {
				const n = p[2];
				l = m$1(l, n), h = a$1(h, n);
			}
			if (c && p.length > s) {
...
function p(n, t, i, r, e, o) {
	...
	for (let p = 0; p < t.length; p++) {
		const n = t[p], [i, r] = n;
		if (g = m$1(g, i), v = m$1(v, r), y = a$1(y, i), d = a$1(d, r), s && n.length > 2) {
			const t = n[2];
			l = m$1(l, t), h = a$1(h, t);
		}
		if (c && n.length > u) {
...
function l(n) {
	return n ? t(n) ? n : r(n) ? v(n) : o(n) ? d(n) : m(n) ? h$1(n) : u(n) ? y(n) : null : null;
}
function y(n) {
	const { hasZ: t, hasM: u, points: r } = n, m = p(x, r, t ?? !1, u ?? !1, t ?? !1, u ?? !1);
	return m ? f(m, t, u) : null;
}
function v(n) {
	const { x: i, y: t, z: u, m: r } = n, m = null != r;
	return null != u ? m ? e(i, t, u, r, i, t, u, r) : c(i, t, u, i, t, u) : m ? s(i, t, r, i, t, r) : a(i, t, i, t);
}
function d(i) {
	const { hasZ: t, hasM: u, rings: r, curveRings: m } = i, o = y$1(x, m ?? r, t ?? !1, u ?? !1);
	return o ? f(o, t, u) : null;
}
function h$1(i) {
	const { hasZ: t, hasM: u, paths: r, curvePaths: m } = i, o = y$1(x, m ?? r, t ?? !1, u ?? !1);
	return o ? f(o, t, u) : null;
}
//#endregion
...
//#endregion
export { y as a, v$1 as c, l as i, x$1 as l, d as n, f$1 as o, h$1 as r, g as s, h as t, y$1 as u };

//# sourceMappingURL=zmUtils-DTQ57DZp.js.map