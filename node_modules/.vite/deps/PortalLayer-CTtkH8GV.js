...
import { W as u, b as s$1, f as d, p as f } from "./promiseUtils-DQTPPyja.js";
import { a as o, i as r$1, n as c, t as a } from "./decorators-DNvoMvUC.js";
import { E as s$2, F as D, G as T, V as K, t as f$1 } from "./request-C9CBIkRO.js";
import { n as u$1, t as M } from "./Portal-CGQ-0P7E.js";
import { n as b } from "./asyncUtils-CF4XM__w.js";
import { r as F } from "./layerUtils-DqdiS7uu.js";
import { i as f$2 } from "./portalItemUtils-COVFoHh2.js";
	...
	let b$1 = class extends E {
		...
		async loadFromPortal(e, t) {
			if (this.portalItem?.id) try {
				const { load: r } = await import("./layersLoader-7EG65WjG.js");
				return s$1(t), await r({
					instance: this,
		...
		async finishLoadEditablePortalLayer(e) {
			this._set("userHasEditingPrivileges", await this._fetchUserHasEditingPrivileges(e).catch((e) => (f(e), !0)));
		}
		...
		async _fetchUserPrivileges(e, t) {
			...
			const i = !s$2?.findCredential(this.url), a = e === s.id;
			...
			try {
				...
				l = await s$2?.getCredential(`${o}/sharing`, {
					prompt: !1,
					signal: e
				});
			} catch (m) {
		...
		async _fetchUserHasEditingPrivileges(e) {
			const t = this.url ? s$2?.findCredential(this.url) : null;
			if (!t) return !0;
		...
		async _fetchEditingUser(e) {
			...
			if (t) return t;
			const a = s$2?.findServerInfo(this.url ?? "");
			...
			const u = await b(f$1(`${o}/community/self`, {
				authMode: "no-prompt",
				query: { f: "json" },
...
//# sourceMappingURL=PortalLayer-CTtkH8GV.js.map