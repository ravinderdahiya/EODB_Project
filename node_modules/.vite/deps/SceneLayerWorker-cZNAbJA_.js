import { t as n$1 } from "./assets-C7dYNrpc.js";
import { t as S$1 } from "./SpatialReference-BZmWVCQF.js";
import { s as T } from "./mathUtils-P0nOPmqm.js";
import { a as u, n as f } from "./DoubleArray-DdSij4mq.js";
import { n as c, t as i$1 } from "./MeshLocalVertexSpace-CF8g7KtT.js";
import { n as d$1, o as n$2 } from "./vec3-ghj9x5pI.js";
import { i as h$1, t as a } from "./SceneLayerWorkerHandle-Clxeabqz.js";
//#region node_modules/@arcgis/core/libs/i3s/I3SModule.js
function s() {
	return n ??= (async () => {
		return await (await import("./i3s-CAaTJ2pY.js")).default({ locateFile: (s) => n$1(`esri/libs/i3s/${s}`) });
	})(), n;
}
function i() {
	n = null;
...
async function g(e) {
	...
	let y;
	const [{ projectBuffer: h }, { initializeProjection: d }] = await Promise.all([import("./projectBuffer-ecexZ2mO.js").then((n) => n.n), import("./projectionUtils-ByFpjmtW.js").then((n) => n.p)]);
	await d(l, u$1);
	const g = [
		0,
		0,
	...
	if ("georeferenced" === c$1.type && null == c$1.origin) {
		...
		const e = "georeferenced" === c$1.type ? c.fromJSON(c$1) : i$1.fromJSON(c$1), { projectMeshVertexPositions: r } = await import("./projectMeshVertexPositions-D_XMZfkw.js").then((n) => n.n), t = r({
...
//# sourceMappingURL=SceneLayerWorker-cZNAbJA_.js.map