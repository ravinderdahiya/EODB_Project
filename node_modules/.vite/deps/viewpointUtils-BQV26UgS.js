...
import { a as m$1, i as c$1, r as a } from "./uid-BI1T_uZT.js";
import { n } from "./JSONSupport-C2nyciis.js";
import { i as G, l as T$1, u as U } from "./spatialReferenceUtils-BtA22Tuk.js";
import { A as re } from "./units-BF_YTgze.js";
import { t as S } from "./SpatialReference-BZmWVCQF.js";
import { m as s, t as _$1 } from "./Point-BumYnEDe.js";
import { t as z } from "./Extent-BU6jY2-x.js";
import { b as s$1 } from "./mathUtils-P0nOPmqm.js";
import { i as u } from "./common-Bk5As8oZ.js";
import { C as u$1, E as y, S as r, T as x, _ as l$1, c as S$1, h as j, p as e, t as B$1, w as v, x as q, y as o } from "./vec2-bUkL91WX.js";
...
import { g as tn, n as F, r as H$1, s as V } from "./projectionUtils-ByFpjmtW.js";
import { t as d } from "./Camera-BuBmssJv.js";
import { i as n$1, o as r$1 } from "./vec2f64-ZzLQFmIC.js";
import { a as f, l as s$3, o as h, r as c$2, s as i, t as M, u as u$3 } from "./mat2d-V4qWpPac.js";
import { t as e$1 } from "./mat2df64-DZD9ozuc.js";
import { n as L, o as z$1 } from "./normalizeUtils-C1gz60j_.js";
...
async function J(t, r, n, o) {
	...
	if (q$1.isCollection(t) && (t = t.toArray()), Array.isArray(t) && t.length && "object" == typeof t[0]) {
...
async function Y(e, r) {
	...
	const { constraints: o, padding: a, viewpoint: i, size: c$3 } = r, s$4 = [a ? c$3[0] - a.left - a.right : c$3[0], a ? c$3[1] - a.top - a.bottom : c$3[1]];
	let u = null;
	...
	let p = 0;
	p = null != u?.targetGeometry && "point" === u.targetGeometry.type ? u.scale : "scale" in e && e.scale ? e.scale : "zoom" in e && -1 !== e.zoom && o && o.effectiveLODs ? o.zoomToScale(e.zoom) : Array.isArray(l) || "point" === l.type || "extent" === l.type && 0 === l.width && 0 === l.height ? i.scale : H(X(l.extent, n), s$4, y);
...
function $(t, e, r) {
	return r ? o(t, .5 * (e[0] - r.right + r.left), .5 * (e[1] - r.bottom + r.top)) : l$1(t, e, .5);
}
var _ = function() {
	const t = n$1();
...
var rt = function() {
	...
	return function(r, n, o$1, a) {
		const c = ot(n), l = it(n);
		return o(e, c, c), h(t, e), s$3(t, t, l), i(t, t, rt(e, o$1, a)), i(t, t, [0, a.top - a.bottom]), o(r, t[4], t[5]);
	};
}();
function ot(t) {
...
var ut = function() {
	const t = n$1(), e = n$1(), r = n$1();
	return function(n, o$2, u, l, f$1, m) {
		return x(t, o$2), l$1(e, u, .5 * m), o(r, 1 / l * m, -1 / l * m), f(n, e), f$1 && s$3(n, n, f$1), c$2(n, n, r), i(n, n, t), n;
	};
}(), lt = function() {
	const t = n$1();
...
var pt = function() {
	...
	return function(n, o, a) {
		...
		let i = Math.acos(j(t, e$2) / (q(t) * q(e$2))) * T;
	...
	return function(e, r, n, o$3, a) {
		a || (a = "center"), B$1(t, n, o$3), l$1(t, t, .5);
		const i = t[0], c = t[1];
		switch (a) {
			case "center":
				o(t, 0, 0);
...
var Gt = function() {
	...
	return function(r, n, o) {
		...
		return M(e, it(n)), c$2(e, e, r$1(a, a)), S$1(t, o, e), i.x += t[0], i.y += t[1], r;
	};
}();
//#endregion
export { xt as C, wt as S, c as T, ot as _, Y as a, tt as b, at as c, gt as d, ht as f, mt as g, lt as h, Rt as i, bt as l, kt as m, Gt as n, Z as o, jt as p, H as r, _ as s, $ as t, ft as u, pt as v, yt as w, ut as x, rt as y };

//# sourceMappingURL=viewpointUtils-BQV26UgS.js.map