...
import { n as n$1, t as r$1 } from "./Error-DugVwGnI.js";
import { i as c$2, r as a$1 } from "./uid-BI1T_uZT.js";
import { b as s$1, d as a$2, n as A$2, x as u$4, y as p$2 } from "./promiseUtils-CsEq-Eti.js";
import { R as G$1, W as Rt } from "./request-D8neOagW.js";
import { m as s$2, t as _ } from "./Point-BumYnEDe.js";
import { t as z$1 } from "./Extent-BU6jY2-x.js";
import { t as j$2 } from "./Polygon-k6iGU-4W.js";
import { f as n$2 } from "./mat3-DHLlkzj7.js";
import { t as e$1 } from "./mat3f64-DNWQy00Z.js";
import { n as l$1, t as f$2 } from "./Clonable-DQVF7oi4.js";
import { t as q$1 } from "./Collection-DeIPuq8V.js";
import { r as a$3, s as l$2 } from "./reactiveUtils-COPg0EH3.js";
import { t as m$2 } from "./Promise-CboRAKLa.js";
import { n as p$3 } from "./Loadable-CDav2d-w.js";
import { l as r$2, n as _$1, r as a$4, s as n$3 } from "./vec3f64-NuZYD0Oc.js";
import { t as e$2 } from "./mat4f64-jePQO1qo.js";
import { t as e$3 } from "./DoubleArray-DdSij4mq.js";
import { C as i$1, E as m$3, S as h$3, b as f$3, g as U } from "./aaBoundingBox-CgpoG9d9.js";
import { D as p$4, c as O$2, h as c$3, i as D$1, s as I$1, v as f$4 } from "./mat4-BeR2siam.js";
import { r as u$5 } from "./spatialReferenceEllipsoidUtils-DYnGRhN5.js";
import { t as o } from "./projectBuffer-ecexZ2mO.js";
import { g as tn } from "./projectionUtils-ByFpjmtW.js";
import { F as z$2, N as x$4, _ as _$2, c as N$1, j as u$6, r as E$1, x as e$4, y as c$4 } from "./vec3-BZoYuGQ1.js";
import { n as r$3, t as e$5 } from "./quatf64-Dxp9-hKF.js";
import { l as y$2 } from "./quat-BHjh3Y80.js";
import { c as y$3, i as k$1, l as z$3, n as d$2, r as g$3 } from "./axisAngleDegrees-BkHc7Doq.js";
import { i as n$4, n as c$5, t as a$5 } from "./meshCloneUtils-BK2p11hT.js";
import { n as g$4 } from "./MeshComponent-DtJvI5yK.js";
import { n as c$6, t as i$2 } from "./MeshLocalVertexSpace-CF8g7KtT.js";
import { t as A$3 } from "./MeshTransform-B5hu3dJQ.js";
import { n as u$7 } from "./MeshVertexAttributes-BGZWZ8z_.js";
import { a as t$1, n as c$7, o as u$8, r as l$3 } from "./meshVertexSpaceUtils-CZK-RvY9.js";
import { t as c$8 } from "./triangulationUtils-BI7d4wLQ.js";
import { n as n$5 } from "./projectPointToVector-DgrDNl10.js";
import { t as f$5 } from "./computeTranslationToOriginAndRotation-Dhwbif7e.js";
import { s as r$4, t as a$6 } from "./vec3-ghj9x5pI.js";
import { a as E$2, d as _$3, f as k$2, h as x$5, m as w$2, n as nt, o as F$1, r as q$2, s as M$3, t as P$1, u as V$1 } from "./vertexSpaceConversion-BZ1vDO0p.js";
import { i as m$4, n as f$6, o as o$1 } from "./External-D7lBZvq2.js";
...
function l(r) {
	const { spatialReference: f, vertexSpace: l, untransformedBounds: d } = r, g = f$3(d, u$2);
...
async function u$1(r, o, n) {
	const { source: i } = o, { loadGLTFMesh: a } = await p$2(import("./loadGLTFMesh-CgKGAY-1.js"), n), c = await f$1(i, n);
	s$1(n);
	const u = a(new _({
		x: 0,
		y: 0,
...
async function w$1(t, i) {
	...
	if (a$2(i)) throw a.forEach((e) => e.source.dispose()), u$4();
	return T$1(a);
}
...
__decorate([a$1()], a.prototype, "externalSources", void 0), __decorate([a$1()], a.prototype, "displaySource", null), __decorate([a$1()], a.prototype, "_implicitDisplaySource", null), __decorate([a$1()], a.prototype, "_explicitDisplaySource", void 0), a = __decorate([c$2("esri.geometry.support.meshUtils.Metadata")], a);
//#endregion
...
function G(t, e, r) {
	...
	m.scale = O$2(n$3(), q), f$4(q, q, z$2(K, m.scale));
...
function L(e, s, f) {
	...
	x.scale = O$2(n$3(), L), f$4(L, L, z$2(V, x.scale));
...
var Y = Q = class extends l$1(p$3(m$2(s$2))) {
	constructor(e) {
	...
	async toBinaryGLTF(e) {
		const [{ toBinaryGLTF: t }] = await Promise.all([import("./gltfexport-CnGuzugM.js"), this.load(e)]);
	...
	static async createFromGLTF(e, t, r) {
		...
		const { loadGLTFMesh: o } = await p$2(import("./loadGLTFMesh-CgKGAY-1.js"), r);
...
__decorate([a$1({
	type: [g$4],
	json: { write: !0 }
})], Y.prototype, "components", void 0), __decorate([a$1({
	nonNullable: !0,
	types: X,
	constructOnly: !0,
	json: { write: !0 },
	clonable: (e, t) => n$4(t)?.vertexSpace ?? e.clone(t)
})], Y.prototype, "vertexSpace", void 0), __decorate([a$1({
	type: A$3,
	clonable: (e, t) => {
		const r = n$4(t);
	...
	json: { write: !0 }
})], Y.prototype, "transform", void 0), __decorate([a$1({
	constructOnly: !0,
	type: a,
	clonable: (e, t) => n$4(t)?.metadata ?? e.clone()
})], Y.prototype, "metadata", void 0), __decorate([a$1()], Y.prototype, "hasExtent", null), __decorate([a$1()], Y.prototype, "_transformedExtent", null), __decorate([a$1()], Y.prototype, "_untransformedBounds", null), __decorate([a$1()], Y.prototype, "origin", null), __decorate([a$1({
	readOnly: !0,
	json: { read: !1 }
})], Y.prototype, "extent", null), __decorate([a$1({
	readOnly: !0,
	json: {
		read: !1,
		write: !0,
...
})], Y.prototype, "hasZ", void 0), __decorate([a$1({
	readOnly: !0,
	json: {
		read: !1,
		write: !0,
...
})], Y.prototype, "hasM", void 0), __decorate([a$1({
	type: u$7,
	nonNullable: !0,
	json: { write: !0 },
...
//# sourceMappingURL=Mesh-rESI8KQ7.js.map