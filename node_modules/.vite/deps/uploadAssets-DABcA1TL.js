...
import { L as e$2, b as s, p as f$1, u as T } from "./promiseUtils-CsEq-Eti.js";
import { n as r, r as t, t as n$3 } from "./time-ztIgabWi.js";
...
import { c as m$2, f as s$1, n as a$1, p as u, t as F } from "./infoFor3D-BQtb6xJV.js";
import { m as rn } from "./projectionUtils-ByFpjmtW.js";
import { a as n$4, c as y, n as f$3, r as i$2, t as b } from "./External-D7lBZvq2.js";
import { c as n$5, d as t$2, f as u$1, i as d, l as p$2, n as a$2, o as l$2, r as c$2, t as t$1, u as r$2 } from "./meshSpatialReferenceScaleUtils-DlNo_UAG.js";
import { n as n$6, t as i$3 } from "./meshFeatureAttributes-JcOPOPOU.js";
...
var n$1 = class {
	...
	setProgress(s, e) {
		if (this._progressMap.set(s, e), has("enable-feature:esri-3dofl-upload-timings")) {
			...
			this._startTime ??= r;
			const o = e$1(this._timingsMap, s, () => ({
				start: r,
				end: 0
			}));
			1 === e && (o.end = r);
...
async function m({ data: m, name: f, description: d }, u, h$1) {
	let w = null;
	try {
		const y = V$1(u, "uploads"), { data: g } = await f$2(V$1(y, "info"), {
			query: { f: "json" },
			responseType: "json"
		});
		s(h$1);
		...
		const { data: E } = await f$2(V$1(y, "register"), {
			query: {
				f: "json",
				itemName: c(f),
				description: d
		...
		await Promise.all(x);
		const { data: C } = await f$2(V$1(w, "commit"), {
			query: {
				f: "json",
		...
		if (null != w) await f$2(V$1(w, "delete"), {
			query: { f: "json" },
			responseType: "json",
			method: "post"
		});
...
async function Z(e, s$6, r) {
	...
	try {
		...
		f$1(l), ce().warnOnce(`Service ${s$6.url} does not support the REST Uploads API.`);
	}
	if (!u) {
		const e = await Dt(n);
...
async function ee(s$8, r, o) {
	...
	try {
		const n = await f$2(V$1(r.parsedUrl.path, "uploadAssets"), {
			timeout: 0,
			query: {
				f: "json",
...
async function ne(s, t) {
	const o = (await f$2(s, t)).data.statusUrl;
	for (;;) {
		const s = (await f$2(o, {
			query: { f: "json" },
			responseType: "json"
		...
		switch (s.status) {
			case "Completed": return f$2(s.resultUrl, {
				query: { f: "json" },
				responseType: "json"
			});
...
//# sourceMappingURL=uploadAssets-DABcA1TL.js.map