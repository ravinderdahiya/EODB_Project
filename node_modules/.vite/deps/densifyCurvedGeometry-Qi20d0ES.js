...
import { C as o, T as u, b as h, c as h$1, d as l, i as p, n as d, w as r$1 } from "./curveExtent-1Dkpx_J0.js";
import { a as i, c as o$1, d as t, f as u$1, i as f, n as c, o as l$1, p as v, r as e, u as s } from "./curveUtils-BIVZ_WWm.js";
...
var y = class {
	...
	densify(t, { maxDeviation: e, maxSegmentLength: s, maxSegmentsPerCurve: n, minSegmentsPerCurve: i }) {
		const r = s * s, a = e * e, o$2 = 1 / n, c = this.interpolate(0), h = this.interpolate(1);
		o(this.curveStart, c) > k && t.push(c), this.initialize(c, h);
		const u = 1 / i;
		for (let p = i - 1; p > 0; p--) {
			const t = p * u;
			this.pop(), this.splitAt(t);
		}
		for (; this.stackSize > 0;) this.pop(), this.tStart === this.tEnd || this.tEnd - this.tStart < o$2 || (0 === r || !isFinite(r) || o(this.arcStart, this.arcEnd) < r) && (0 === a || !isFinite(a) || this.getDeviation2() < a) ? (t.push(this.arcEnd), this.next()) : this.splitInHalf();
		return o(this.curveEnd, h) > k && t.push([...this.curveEnd]), t;
	}
};
var R = class extends y {
	...
	getDeviation2() {
		...
		return Math.max(u(s, t, e), u(n, t, e));
	}
};
...
function b(t, e, s, { cx: n, cy: i, radius: r, thetaStart: a, thetaEnd: o$3, isInvalid: c }, { maxDeviation: h, maxSegmentLength: u, maxSegmentsPerCurve: p, minSegmentsPerCurve: l }) {
	if (c) return t.push([...s]), t;
	const m = 2 * r, d = [n + r * Math.cos(a), i + r * Math.sin(a)], f = [n + r * Math.cos(o$3), i + r * Math.sin(o$3)];
	o(e, d) > k && t.push(d);
	const S = Math.abs(o$3 - a), v = u > 0 && u < m ? 2 * Math.asin(u / m) : S, E = h > 0 && h <= r ? 2 * Math.acos(1 - h / r) : S, M = Math.min(p, Math.max(l, Math.ceil(Math.abs(S / Math.min(v, E))))), P = 1 / M;
	for (let x = 1; x < M; x++) {
		const e = x * P, s = a * (1 - e) + o$3 * e;
		t.push([n + r * Math.cos(s), i + r * Math.sin(s)]);
	}
	return t.push(f), o(s, f) > k && t.push([...s]), t;
}
function j(t, e, s, n) {
...
function A(t, e$1, s, n) {
	return e(s) ? (t.push([...s]), t) : i(s) ? j(t, e$1, s, n) : c(s) ? Z(t, e$1, s, n) : o$1(s) ? D(t, e$1, s, n) : z(t, e$1, s, n);
}
function L(t$2, e = {}) {
	if (!t(t$2)) return t$2;
	const s = _(e), n = u$1(t$2), i = [];
	for (const r of n) {
		const t = [];
...
function T(t$3, e$3, s$2) {
	if (!t(t$3)) return t$3;
	const n = new Set(e$3), i$1 = _(s$2), a = u$1(t$3), f = [];
	let S = !1;
	for (const r of a) {
		const t = [];
		for (let e$2 = 0; e$2 < r.length - 1; e$2++) {
			...
			0 === e$2 && t.push(a);
			const o = r[s$1];
			e(o) ? t.push([...o]) : i(o) && !n.has("cubic-bezier") ? j(t, a, o, i$1) : c(o) && !n.has("circular-arc") ? Z(t, a, o, i$1) : o$1(o) && !n.has("elliptic-arc") ? D(t, a, o, i$1) : s(o) && !n.has("elliptic-arc") ? z(t, a, o, i$1) : (t.push(l$1(o)), S = !0);
		}
		f.push(t);
	}
...
async function J(e, s, n) {
	...
	for (const o of e) if (o && t(o) && null == o.spatialReference.xyTolerance && f(o, s)) {
		...
		if (n.has(s)) o.spatialReference = n.get(s);
			...
			i || (i = await import("./apiConverter-CLaQ_zSO.js").then((n) => n.s));
...
//# sourceMappingURL=densifyCurvedGeometry-Qi20d0ES.js.map