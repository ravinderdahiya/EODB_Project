...
import { p as f$1 } from "./promiseUtils-DQTPPyja.js";
import { a as o$1, i as r$1, n as c, t as a$1 } from "./decorators-DNvoMvUC.js";
import { B as I$1, j as A$1, t as f$2 } from "./request-C9CBIkRO.js";
...
import { v as r$2 } from "./spatialReferenceUtils-DFtdTnNk.js";
import { H as R$1 } from "./units-XYZmVlT8.js";
import { t as _ } from "./Point-IZafMjJg.js";
import { t as z } from "./Extent-BLsNNw_-.js";
import { t as b$1 } from "./Layer-D9VPag9c.js";
import { n as U$1, r as a$2, s as l$1 } from "./reactiveUtils-Bd9X7q7v.js";
...
import { t as o$2 } from "./imageBitmapUtils-D9Baw38T.js";
import { n as l$4, t as z$1 } from "./TileInfo-YH9Iha1a.js";
import { t as e$1 } from "./TileInfoTilemapCache-B87JGJxU.js";
import U$2, { t as a$3 } from "./WebTileLayer-BZNmIxBE.js";
import { t as o$3 } from "./crsUtils-B4iX2SYj.js";
import { n as o$4 } from "./xmlUtils-Ymh12N5I.js";
...
var B = W = class extends p$3(l$2(l$3(g$1(_$1(e(b$1)))))) {
	...
	load(e) {
		return this.addResolvingPromise(this.loadFromPortal({ supportedTypes: ["WMTS"] }, e).catch(f$1).then(() => this._fetchService(e)).catch((e) => {
			throw f$1(e), new r("wmtslayer:unsupported-service-data", "Invalid response from the WMTS service.", { error: e });
	...
	async fetchTile(e, r, i, s = {}) {
		const { signal: a } = s, { data: l } = await f$2(this.getTileUrl(e, r, i), {
			responseType: "image",
			signal: a
		});
		return l;
	...
	async fetchImageBitmapTile(e, r, i, s = {}) {
		...
		const { data: l } = await f$2(this.getTileUrl(e, r, i), {
			responseType: "blob",
			signal: a
		});
	...
	async _getCapabilities(e, r) {
		return await f$2(this._getCapabilitiesUrl(e), {
			...r,
			responseType: "text"
		});
	}
...
//# sourceMappingURL=WMTSLayer-CTI8aTsT.js.map