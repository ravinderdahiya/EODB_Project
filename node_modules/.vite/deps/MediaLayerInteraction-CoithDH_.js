...
import { I as c$2, L as e, R as i, o as L } from "./promiseUtils-CsEq-Eti.js";
import { t as b } from "./Accessor-CPmfB7ST.js";
import { a as h } from "./reactiveUtils-COPg0EH3.js";
...
var u = class extends b {
	...
	initialize() {
		this.addHandles(c$2(this._updatingHandles)), this._updatingHandles.add(() => this.enabled, (e) => this._setEnabled(e), h), this._updatingHandles.add(() => this._preferredInteractionTool, () => this._preferredInteractionToolChanged());
	}
	...
	async _recreateTool() {
		...
		const { TransformTool: o, ControlPointsTransformTool: n } = await import("./editingTools-D31FsnYd.js");
...
__decorate([a()], u.prototype, "_validatedSelectedElement", null), __decorate([a()], u.prototype, "_preferredInteractionTool", null), __decorate([a({ constructOnly: !0 })], u.prototype, "view", void 0), __decorate([a({ constructOnly: !0 })], u.prototype, "layer", void 0), __decorate([a()], u.prototype, "selectedElement", void 0), __decorate([a()], u.prototype, "enabled", void 0), __decorate([a()], u.prototype, "options", void 0), __decorate([a()], u.prototype, "updating", null), u = __decorate([c$1("esri.views.2d.layers.support.MediaLayerInteraction")], u);
//#endregion
export { u as MediaLayerInteraction };

//# sourceMappingURL=MediaLayerInteraction-CoithDH_.js.map