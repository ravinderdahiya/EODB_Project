...
import { A as b, H as y$2, K as r$1 } from "./typedArrayUtil-BNfmp42K.js";
import { t as r$2 } from "./Error-DugVwGnI.js";
import { A as l$1, F as u$2, _ as l$2, b as s$2 } from "./promiseUtils-CsEq-Eti.js";
import { vt as t$2 } from "./request-D8neOagW.js";
import { l as T$1, u as U } from "./spatialReferenceUtils-BtA22Tuk.js";
import { A as re } from "./units-BF_YTgze.js";
import { i as l$3, o as r$3 } from "./Polygon-k6iGU-4W.js";
import { o as l$4, p as v, r as e$1 } from "./curveUtils-BmykpmD9.js";
import { S as u$3, v as o$1 } from "./aaBoundingRect-Bi41sAZb.js";
import { i as l$5, n as d$2, o as f$2 } from "./zmUtils-BblKGmkg.js";
import { i as DateTime } from "./UnknownTimeZone-C1IilYJu.js";
import "./timeZoneUtils-DbWavHW2.js";
import { B as we, C as Te, G as e$2, H as xe, k as be, m as Ie } from "./fieldUtils-MJDrZunq.js";
import { a as o$2, i as n$1 } from "./jsonTypeUtils-BSoxwy98.js";
import { n as u$4 } from "./jsonUtils-CShIFD4k.js";
import { C as i, c as M, f as Q$1, k as q } from "./aaBoundingBox-CgpoG9d9.js";
import { t as i$1 } from "./fieldType-DIQaPb5_.js";
import { s as V } from "./projectionUtils-ByFpjmtW.js";
import { t as _ } from "./FieldsIndex-BBYVRhkI.js";
import { r as P } from "./normalizeUtils-C1gz60j_.js";
import { n as D$1 } from "./Scheduler-B_QakgCB.js";
import { c as s$3 } from "./quantizationUtils-Ciqd0id-.js";
import { a as H } from "./featureConversionUtils-DbUOyYaF.js";
import { t as u$5 } from "./closestPointOnCurve-EBmwg7iY.js";
import { n as r$4 } from "./WhereClauseCache-DoT0E20w.js";
import { n as t$3 } from "./QueryEngineCapabilities-XnNKOgPp.js";
import { a as G, c as U$1, d as f$3, f as g$1, g as p$2, h as m$2, i as E, m as k$1, n as B, o as L$1, r as C, s as P$1, t as $, u as d$3, v as v$1 } from "./utils-DWoBrI2x.js";
import { a as w, c as s$4, i as h$1, n as n$2, o as i$2, r as I, s as o$3, t as l$6 } from "./timeSupport-BFCiw7Bl.js";
import { n as f$4, r as g$2, t as M$1 } from "./projectionSupport-BeEdzbTC.js";
import { n as F$1 } from "./utils-hPjfpwvm.js";
import { a as w$1, i as j, o as x, r as h$2, t as S } from "./queryUtils-C3UuP88s.js";
import { n as s$5, t as e$3 } from "./SnappingCandidate-C45T3cKA.js";
import { a as m$3, i as s$6, n as m$5, r as m$4, t as m$6 } from "./FixedIntervalBinParameters-GzgWHRwR.js";
...
function d$1(i, r, n = {}) {
	const o = c$2(r, i);
	if (!o) throw new r$2(t$1, "invalid SQL expression", {
		expression: r,
		error: s$1.getError(r, i)
	});
	const a = n.expressionName || "expression";
	if (n.validateStandardized && !o.isStandardized) throw new r$2(t$1, `${a} is not standard`, { expression: r });
	if (n.validateAggregate && !o.isAggregate) throw new r$2(t$1, `${a} does not contain a valid aggregate function`, { expression: r });
	return o.fieldNames;
}
...
function f$1(i, r, s, n, o) {
	...
	})) throw new r$2(t$1, "expressions in having clause should also exist in outStatistics", { having: s });
	return !0;
}
function c$2(e, i) {
...
function g(i, r, s, n = {}) {
	...
	if (m$1(o, i, r, n.allowedFieldTypes ?? l, s), o.size) throw new r$2(t$1, `${n.expressionName ?? "expression"} contains invalid or missing fields`, {
...
function T(e, i, s, t, n) {
	...
	o ? s.has(o.name) ? "all" !== t && !1 === t?.has(o.type) && e.set(n, {
		type: "invalid-type",
		fieldName: o.name,
		fieldType: i$1.fromJSON(o.type),
		allowedFieldTypes: Array.from(t, (e) => i$1.fromJSON(e))
	}) : e.set(n, {
		type: "missing-field",
		fieldName: o.name
	}) : e.set(n, {
...
var J = class {
	...
	async _getAggregateGeometry(e, n) {
		const { convexHull: r, union: o } = await import("./geometryEngineJSON-DZ514IrW.js"), { statisticType: l, outStatisticFieldName: u } = e, { featureAdapter: c, spatialReference: m, geometryType: d } = this, p = n.map((e) => i$2(d, c.getGeometry(e))), h = r(m, p, !0)[0], y = {
...
async function p(t, i) {
	const s = t.bin;
	if (!s.onField && !s.onExpression?.value || "autoIntervalBin" === s.type && null == s.parameters.numberOfBins || "dateBin" === s.type && (null == s.parameters.number || null == s.parameters.unit) || "fixedBoundariesBin" === s.type && null == s.parameters.boundaries || "fixedIntervalBin" === s.type && null == s.parameters.interval) throw new r$2(u, "Unsupported query options", { query: t });
	return d(t, i);
}
async function d(t, { fieldsIndex: i, geometryType: s, spatialReference: r, availableFields: o }) {
	if (null != t.geometryPrecision || t.multipatchOption && "xyFootprint" !== t.multipatchOption || t.pixelSize || t.relationParam || t.text) throw new r$2(u, "Unsupported query options", { query: t });
...
function c(s, r, o) {
	...
	if ("outFields" in o) {
		...
		else if (n) throw new r$2(u, "outFields should be specified for returnDistinctValues", { query: o });
	}
	p$1(s, r, o.where, o);
}
var f = new Set([...o, ...a]);
function m(i, r, o) {
	...
	if (l) {
		if (!p || !d) throw new r$2(u, "outStatistics and groupByFieldsForStatistics should be specified with having", { query: o });
		f$1(i, r, l, n, o);
	}
	if (d) {
		if (!h(n)) return;
		...
		for (const a of n) {
			...
			if (("percentile_disc" === n || "percentile_cont" === n) && "statisticParameters" in a) {
				...
				if (!t) throw new r$2(u, "statisticParameters should be set for percentile type", {
					definition: a,
					query: o
				});
...
async function y(t, i, { fieldsIndex: s, geometryType: r, spatialReference: o, availableFields: l }) {
	if (null != t.geometryPrecision || t.multipatchOption || t.pixelSize || t.relationParam || t.text || t.outStatistics || t.groupByFieldsForStatistics || t.having || t.orderByFields) throw new r$2(u, "Unsupported query options", { query: t });
...
async function F(i, s, r, o) {
	...
	if (r.field && n.push(r.field), r.field2 && n.push(r.field2), r.field3 && n.push(r.field3), r.normalizationField && n.push(r.normalizationField), !n.length && !r.valueExpression) throw new r$2(u, "field or valueExpression is required", { params: r });
	g(i, s, n, {
...
var W = class {
	...
	async executeQueryForLatestObservations(e, t) {
		const i = l$2(t);
		if (!this.timeInfo?.trackIdField) throw new r$2(D, "Missing timeInfo or timeInfo.trackIdField", {
			query: e,
	...
	async _getBounds(e, t, i$3) {
		const r = q(i(), Q$1);
		return await this.featureStore.forEachBounds(e, (e) => M(r, e)), Y(r, t, i$3, this.spatialReference, this.hasZ);
	}
	_getFullExtent() {
	...
	async _getAllFeatures() {
		if (null == this._allFeaturesPromise) {
			const e = [];
			this._allFeaturesPromise = (async () => await this.featureStore.forEach((t) => e.push(t)))().then(() => r$1(e));
		}
	...
	*_runSpatialFilter(e, t) {
	...
	async _project(e, t) {
		...
		return e.items = r$1((await M$1(e.items.map((e) => i$2(this.geometryType, r.getGeometry(e))), this.spatialReference, t, { areaOfInterestExtent: s })).map((t, i) => r.cloneWithGeometry(e.items[i], H(t, this.hasZ, this.hasM), this.geometryType))), e;
	}
...
//# sourceMappingURL=QueryEngine-IXYPs2FR.js.map