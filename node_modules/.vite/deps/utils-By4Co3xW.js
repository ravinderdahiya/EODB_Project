import { l as n$2 } from "./colorUtils-dA0PhAba.js";
import { r as e$3 } from "./screenUtils-BxUp6TCn.js";
import { A as s$1, k as r$1 } from "./mat4-BeR2siam.js";
...
var n = (n, o) => {
	const s = r$1(n, o, 0, 0, 0, 0, o, 0, 0, 0, 0, o, 0, 0, 0, 0, 1);
	return s$1(s, s);
}, o = (n, o) => {
	const s = r$1(n, o, 0, 0, .5 - .5 * o, 0, o, 0, .5 - .5 * o, 0, 0, o, .5 - .5 * o, 0, 0, 0, 1);
	return s$1(s, s);
}, s = (n, o) => {
	const s = 1 - o, c = r$1(n, .2126 + .7874 * s, .7152 - .7152 * s, .0722 - .0722 * s, 0, .2126 - .2126 * s, .7152 + .2848 * s, .0722 - .0722 * s, 0, .2126 - .2126 * s, .7152 - .7152 * s, .0722 + .9278 * s, 0, 0, 0, 0, 1);
	return s$1(c, c);
}, c$1 = (n, o) => {
	const s = Math.sin(o * Math.PI / 180), c = Math.cos(o * Math.PI / 180), e = r$1(n, .213 + .787 * c - .213 * s, .715 - .715 * c - .715 * s, .072 - .072 * c + .928 * s, 0, .213 - .213 * c + .143 * s, .715 + .285 * c + .14 * s, .072 - .072 * c - .283 * s, 0, .213 - .213 * c - .787 * s, .715 - .715 * c + .715 * s, .072 + .928 * c + .072 * s, 0, 0, 0, 0, 1);
	return s$1(e, e);
}, e$1 = (n, o) => {
	const s = 1 - 2 * o, c = r$1(n, s, 0, 0, o, 0, s, 0, o, 0, 0, s, o, 0, 0, 0, 1);
	return s$1(c, c);
}, a = (n, o) => {
	const s = r$1(n, .213 + .787 * o, .715 - .715 * o, .072 - .072 * o, 0, .213 - .213 * o, .715 + .285 * o, .072 - .072 * o, 0, .213 - .213 * o, .715 - .715 * o, .072 + .928 * o, 0, 0, 0, 0, 1);
	return s$1(s, s);
}, u = (n, o) => {
	const s = 1 - o, c = r$1(n, .393 + .607 * s, .769 - .769 * s, .189 - .189 * s, 0, .349 - .349 * s, .686 + .314 * s, .168 - .168 * s, 0, .272 - .272 * s, .534 - .534 * s, .131 + .869 * s, 0, 0, 0, 0, 1);
	return s$1(c, c);
};
//#endregion
...
//#endregion
export { d as a, m as c, c as i, p as l, l as n, f as o, t as r, l$1 as s, e as t };

//# sourceMappingURL=utils-By4Co3xW.js.map