...
import { c as s, i as c, l as u, o as n, r as R$1 } from "./pe-wDyh6dtG.js";
import { i as G$1 } from "./spatialReferenceUtils-DFtdTnNk.js";
import { A as re$1 } from "./units-XYZmVlT8.js";
...
var k, E, T, N = !1;
async function j() {
	return k || (k = $$1(), E = await import("./projectOperator-BhIAKepf.js").then((n) => n.r), T = await import("./geographicTransformationUtils-X2OPh35i.js"), E.isLoaded() || await E.load(), T.isLoaded() || await T.load(), N = !0, k.resolve()), k.promise;
}
function v(e, t, n) {
	if (p(), n) {
...
//# sourceMappingURL=rasterProjectionHelper-nFkxLe05.js.map