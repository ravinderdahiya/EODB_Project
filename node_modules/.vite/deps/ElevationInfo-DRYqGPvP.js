...
import { c as o, i as c, o as r, r as a } from "./uid-BI1T_uZT.js";
import { M as o$1 } from "./promiseUtils-CsEq-Eti.js";
import { n as o$2, t as i$1 } from "./jsonMap-C92NlAVM.js";
import { n as n$1 } from "./JSONSupport-C2nyciis.js";
import { n as l } from "./Clonable-DQVF7oi4.js";
import { L as v } from "./fieldUtils-MJDrZunq.js";
import { r as s } from "./unitConversionUtils-CEIx9NvO.js";
...
var x = class extends l(n$1) {
	...
	equals(e) {
		return this.mode === e.mode && this.offset === e.offset && this.unit === e.unit && o$1(this.featureExpressionInfo, e.featureExpressionInfo);
	}
};
__decorate([a({
	type: n,
	json: { write: !0 }
})], x.prototype, "featureExpressionInfo", void 0), __decorate([o("featureExpressionInfo", ["featureExpressionInfo", "featureExpression"])], x.prototype, "readFeatureExpressionInfo", null), __decorate([r("featureExpressionInfo", {
...
//# sourceMappingURL=ElevationInfo-DRYqGPvP.js.map