...
import { t as c } from "./PixelBlock-UOddVSCl.js";
...
async function r(t, e, n) {
	...
	if (!(await import("./intersectsOperator-BryALuiN.js")).execute(e, n)) return new c({
	...
	return (await import("./containsOperator-Y0zsEBUP.js")).execute(n, e) ? t : o(t, e, n);
}
function o(t, e, n) {
	if (!t) return t;
...
//# sourceMappingURL=clipUtils-DvhNfdfK.js.map