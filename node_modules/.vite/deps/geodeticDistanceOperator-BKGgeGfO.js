import { n as P, s as r$1, t as F } from "./pe-wDyh6dtG.js";
import { l as N } from "./units-XYZmVlT8.js";
import { t as e } from "./geodeticCurveType-BuuCzfPL.js";
...
async function s() {
	if (!i()) {
		const [n, i] = await Promise.all([
			import("./OperatorGeodeticDistance-C9jf8Pu2.js"),
			import("./SpatialReference-ClD8hQGk.js").then((n) => n.M).then((e) => e.aP).then(({ injectPe: e }) => e),
			P()
		]);
...
async function m() {
	if (!u()) {
		const [e] = await Promise.all([import("./apiConverter-CLaQ_zSO.js").then((n) => n.s), s()]);
...
//# sourceMappingURL=geodeticDistanceOperator-BKGgeGfO.js.map