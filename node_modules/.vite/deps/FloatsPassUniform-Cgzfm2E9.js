...
import { f as n } from "./mat3-DHLlkzj7.js";
import { t as e$2 } from "./mat3f64-DNWQy00Z.js";
import { r as n$1, s as u } from "./guards-BaTlF4tX.js";
import { c as o$1, i as c$1, s as n$2 } from "./vec3f64-NuZYD0Oc.js";
import { t as e$3 } from "./mat4f64-jePQO1qo.js";
import { C as l, E as o$2, T as n$3, h as c$2, j as x, k as r$3, v as f, w as m, x as i } from "./mat4-BeR2siam.js";
import { t as m$1 } from "./lengthUtils-ChaZ2ogt.js";
import { f as r$4 } from "./vec4-BcAkhOU9.js";
import { r as i$1 } from "./vec4f64-CNVTVVzP.js";
import { O as o$3, j as u$1 } from "./vec3-BZoYuGQ1.js";
import { t as i$2 } from "./Uniform-qtJW6-EL.js";
...
function D(t, o, e, s, i) {
	...
	return P(t.field) || P(t.valueExpression) ? P(t.stops) ? 2 === t.stops.length && n$1(t.stops[0].size) && n$1(t.stops[1].size) ? (F(t.stops[0].size, t.stops[1].size, t.stops[0].value, t.stops[1].value, o, e), o.type[e] = 1, !0) : (T(i, "Could not convert size info: stops only supported with 2 elements"), !1) : n$1(r) && n$1(n) && P(t.minDataValue) && P(t.maxDataValue) ? (F(r, n, t.minDataValue, t.maxDataValue, o, e), o.type[e] = 1, !0) : "unknown" === t.valueUnit ? (T(i, "Could not convert size info: proportional size not supported"), !1) : null != m$1[t.valueUnit] ? (o.minSize[e] = -Infinity, o.maxSize[e] = Infinity, o.offset[e] = 0, o.factor[e] = 1 / m$1[t.valueUnit], o.type[e] = 1, !0) : (T(i, "Could not convert size info: scale-dependent size not supported"), !1) : t.stops?.[0] && n$1(t.stops[0].size) ? (o.minSize[e] = t.stops[0].size, o.maxSize[e] = t.stops[0].size, o.offset[e] = o.minSize[e], o.factor[e] = 0, o.type[e] = 1, !0) : n$1(r) ? (o.minSize[e] = r, o.maxSize[e] = r, o.offset[e] = r, o.factor[e] = 0, o.type[e] = 1, !0) : (T(i, "Could not convert size info: unsupported variant of sizeInfo"), !1);
}
...
//# sourceMappingURL=FloatsPassUniform-Cgzfm2E9.js.map