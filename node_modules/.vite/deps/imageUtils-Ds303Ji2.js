...
import { mt as t, st as ot, t as f$1 } from "./request-D8neOagW.js";
...
async function p(t, e) {
	...
	if ("image/gif" === a) {
		const { isAnimatedGIF: t, parseGif: a } = await import("./gif-DMHQ48Yb.js");
		if (t(r)) return a(r, e);
	}
	if (n) {
		const { isAnimatedPNG: t, parseApng: a } = await import("./apng-DsHLUoxx.js");
		if (t(r)) return a(r, e);
	}
...
//# sourceMappingURL=imageUtils-Ds303Ji2.js.map