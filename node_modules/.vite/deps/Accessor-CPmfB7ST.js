import { c as a, l as h$1, u as j$1 } from "./config-C57gEaHo.js";
import { l as s$3, n as n$4 } from "./Error-DugVwGnI.js";
import { A as r$5, C as I, D as m$3, N as u$5, O as t$5, j as o$6, n as e$6, t as e$7, u as l$3, w as o$5 } from "./uid-BI1T_uZT.js";
import { F as u$6, L as e$8 } from "./promiseUtils-CsEq-Eti.js";
import { a as y$2, i as p$2, l as l$4, n as f$4, o as s$4, r as m$4, s as i$3, t as a$1 } from "./tracking--iwQUXaz.js";
import { t as s$5 } from "./ObservableBase-CcMlp5tJ.js";
import { t as F } from "./scheduling-B7aDBvOB.js";
...
function e$5(n) {
	...
	async function r() {
		...
		try {
			const n = await l;
			return l = null, n.done ? (u = !0, t$4) : (e.push(n.value), n);
		} catch (r) {
...
var r$4 = class {
	...
	add(r, e) {
		if (u$4(r)) {
			...
			for (const e of r) o$3(e) && t.push(e);
		} else if (o$3(r)) this._getOrCreateGroup(e).push(r);
		return this;
	}
	forEach(t, r) {
...
function s$2(t) {
	for (const e of t) e instanceof r$4 ? e.removeAll() : e.remove();
}
function o$3(t) {
	return null != t && (!!t.remove || t instanceof r$4);
}
//#endregion
...
var t$1 = class {
	constructor(t = 50, o = 50) {
		this._pool = new e$6(() => [], void 0, r$2, o, t);
	}
	acquire() {
...
function o(l, o) {
	...
	return s$6 = !0, i = f$4(e, l), s$6 = !1, e$8(m);
}
function e(u, l) {
...
var h = class h {
	constructor() {
		this.uid = e$7(), this.removed = !1, this.type = null, this.oldValue = null, this.callback = null, this.getValue = null, this.target = null, this.path = null, this.equals = null;
	}
	static {
	...
	acquire(e, t, r, l, o, i, n) {
		this.uid = e$7(), this.removed = !1, this.type = e, this.oldValue = t, this.callback = r, this.getValue = l, this.target = o, this.path = i, this.equals = n;
	}
	release() {
		this.target = this.path = this.oldValue = this.callback = this.getValue = null, this.uid = e$7(), this.removed = !0;
	}
};
var m$1 = new t$1(), p = /* @__PURE__ */ new Set();
var v$1;
function _(e) {
...
function E(e) {
	return V.add(e), e$8(() => V.delete(e));
}
function b$1(e$10, r, l) {
	let o = l$4(e$10, r, l, (e$9, r, l) => {
		let i, n, s = e(() => u$5(e$9, r), (t, s) => {
...
function S(e, r, l, o = !1) {
	return e.__accessor__ && e.__accessor__.lifecycle !== I.DESTROYED ? o ? D(e, r, l) : b$1(e, r, l) : e$8();
}
function w(e$11, r, l) {
...
var b = class b {
	...
	constructor(...e) {
		...
		Object.defineProperty(this, "__accessor__", {
			enumerable: !1,
			value: t
		}), e.length > 0 && (t.ctorArgs = this.normalizeCtorArgs?.apply(this, e) ?? e[0]), t$2()?.onInstanceConstruct(this);
	}
	postscript() {
	...
	destroy() {
		this.destroyed || (q(this), this.__accessor__.destroy(), t$2()?.onInstanceDestroy(this));
	}
	[Symbol.dispose]() {
		this.destroy();
	}
...
//#endregion
export { r$4 as C, o$4 as D, n$3 as E, u$4 as O, u$3 as S, l$2 as T, u$1 as _, g$1 as a, r$3 as b, c$1 as c, i$2 as d, l$1 as f, t as g, r$1 as h, U as i, e$2 as l, o$1 as m, E as n, i as o, n as p, O as r, s, b as t, f$2 as u, s$1 as v, e$5 as w, t$3 as x, t$1 as y };

//# sourceMappingURL=Accessor-CPmfB7ST.js.map