...
import { mt as t, st as ot, t as f$1 } from "./request-C9CBIkRO.js";
...
async function p(t, e) {
	...
	if ("image/gif" === a) {
		const { isAnimatedGIF: t, parseGif: a } = await import("./gif-CBJ-CHEs.js");
		if (t(r)) return a(r, e);
	}
	if (n) {
		const { isAnimatedPNG: t, parseApng: a } = await import("./apng-DRHNG8XL.js");
		if (t(r)) return a(r, e);
	}
...
//# sourceMappingURL=imageUtils-D5CqgklV.js.map