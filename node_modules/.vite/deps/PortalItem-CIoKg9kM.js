...
import { c as a, d as l } from "./config-BvnHHLFh.js";
import { n as n$1, t as r } from "./Error-BBuf4ybn.js";
import { t as b$1 } from "./Accessor-C495Hp5e.js";
import { A as m$1, a as o, n as c, r as m, t as a$1 } from "./decorators-DNvoMvUC.js";
import { Q as _, R as G, X as Y, m as R, ut as tt } from "./request-C9CBIkRO.js";
import { t as a$2 } from "./JSONSupport-BWDaFwRT.js";
import { t as n$2 } from "./assets-BLKGLVcU.js";
...
var n = class extends b$1 {
	...
	async update(t, r) {
		const { addOrUpdateResources: e } = await import("./resourceUtils-DRAFr-tQ.js").then((n) => n.r);
...
var k = v = class extends a$2(u$1) {
	...
	async fetchResources(e = {}, t) {
		const { fetchResources: i } = await import("./resourceUtils-DRAFr-tQ.js").then((n) => n.r);
		return i(this, e, t);
	}
	async addResource(e, t, i) {
		const { addOrUpdateResources: r } = await import("./resourceUtils-DRAFr-tQ.js").then((n) => n.r);
	...
	async removeResource(e, t) {
		const { removeResource: r$2 } = await import("./resourceUtils-DRAFr-tQ.js").then((n) => n.r);
	...
	async removeAllResources(e) {
		const { removeAllResources: t } = await import("./resourceUtils-DRAFr-tQ.js").then((n) => n.r);
		return t(this, e);
	}
	resourceFromPath(e) {
		return new n({
...
//# sourceMappingURL=PortalItem-CIoKg9kM.js.map