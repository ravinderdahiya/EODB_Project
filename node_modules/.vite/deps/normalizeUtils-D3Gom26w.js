import { t as s } from "./config-BvnHHLFh.js";
import { n, t as r } from "./Error-BBuf4ybn.js";
import { B as I, t as f } from "./request-C9CBIkRO.js";
import { f as d$1, i as G } from "./spatialReferenceUtils-DFtdTnNk.js";
import { t as S$1 } from "./SpatialReference-CmWpkrZX.js";
import { o as S$2, u as j$1 } from "./Point-IZafMjJg.js";
...
import { n as f$1 } from "./utils-CH9U4ZW0.js";
import { n as n$1 } from "./Cyclical-DH09D9Ei.js";
import { i as s$1, n as o, r as r$1, t as i$1 } from "./normalizeUtilsCommon-CsKajzLP.js";
import { n as r$2, t as o$1 } from "./utils-DMCuinMD.js";
...
async function p(p, m, f$2) {
	const n = "string" == typeof p ? I(p) : p, a = m[0].spatialReference, u$2 = u(m[0]), y = {
		...
		query: {
			...
			f: "json",
			sr: d$1(a),
			geometries: JSON.stringify(o$1(m))
		}
	}, { data: l } = await f(n.path + "/simplify", y);
	return r$2(l.geometries, u$2, a);
}
//#endregion
...
function v(t, e) {
	let n = -1;
	for (let o$3 = 0; o$3 < e.cutIndexes.length; o$3++) {
		const s = e.cutIndexes[o$3], r = e.geometries[o$3], i = o(r);
		...
		if (s === n) {
			if (d(t)) for (const e of o(r)) t[s] = t[s].addRing(e);
			else if (M(t)) for (const e of o(r)) t[s] = t[s].addPath(e);
		} else n = s, t[s] = r;
	}
	return t;
}
async function P(e, n, o) {
	...
	const S = [], U = [];
	for (const t of e) if (null != t) if (u || (u = t.spatialReference, h = G(u), x = u.isWebMercator, w = x ? 102100 : 4326, d = r$1[w].maxX, M = r$1[w].minX, b = r$1[w].plus180Line, z = r$1[w].minus180Line), h) if ("mesh" === t.type) U.push(t);
...
//# sourceMappingURL=normalizeUtils-D3Gom26w.js.map