...
import { l as T, m as g$1, o as O, t as A } from "./spatialReferenceUtils-BtA22Tuk.js";
import { O as oe } from "./units-BF_YTgze.js";
import { i as l } from "./zmUtils-BblKGmkg.js";
import { a as o$1, i as n, t as e } from "./jsonTypeUtils-BSoxwy98.js";
...
import { n as f, r as g$2 } from "./projectionSupport-BeEdzbTC.js";
...
async function v(e) {
	...
	const a = s.spatialReference, l = n ? g.fromJSON(n) : oe(a), m = a && (A(a) || O(a)) ? s : await f(a, g$1).then(() => g$2(s, g$1)), f$1 = await import("./geodesicBufferOperator-Crxtu3Hx.js");
	await f$1.load();
...
//# sourceMappingURL=queryUtils-C3UuP88s.js.map