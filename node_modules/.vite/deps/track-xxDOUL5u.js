...
import { j as n$3, r as C$2 } from "./promiseUtils-CsEq-Eti.js";
import { c as c$3, u as f$4 } from "./Accessor-CPmfB7ST.js";
import { F as D$3 } from "./request-D8neOagW.js";
import { t as S$2 } from "./SpatialReference-BZmWVCQF.js";
import { m as s$5, t as _$2 } from "./Point-BumYnEDe.js";
import { t as z$1 } from "./Extent-BU6jY2-x.js";
import { t as j$2 } from "./Polygon-k6iGU-4W.js";
import { a as g$4 } from "./coordsUtils-DpHTo7QO.js";
import { S as v$2 } from "./mathUtils-P0nOPmqm.js";
import { i as DateTime } from "./UnknownTimeZone-C1IilYJu.js";
import { a as r$2, i as o$1, o as t$2, r as n$4, t as e$1 } from "./guards-BaTlF4tX.js";
import { r as i$4 } from "./locale-DmYUJ136.js";
...
import { n as n$5 } from "./uuid-Dis-U6Ct.js";
import { n as t$3, o as n$6, s as s$6, t as o$2 } from "./enum-OrbGisF7.js";
import { a as h$2, i as i$5, o as m$4, t as r$3 } from "./TimeOnly-CZng0DZr.js";
import { t as r$4 } from "./arcadeEnvironment-BxgLln-Q.js";
import { t as t$4 } from "./ImmutableArray-BRnRlRhv.js";
import { $ as re$1, A as U$2, B as be, C as P$3, E as Qe, F as Xe, I as Y$1, J as ne$1, K as ie$1, M as W$2, N as We, P as X$1, R as Ze, T as Q$1, V as ce$1, W as ge, Y as oe$1, _ as Je, a as Ae, b as L$1, ct as z$2, dt as i$6, et as se$1, i as $e, j as V$1, k as Se, l as De, m as He, o as B$2, p as H$1, q as je, r as $$1, rt as ue$1, s as Be, st as ye, t as f$5, tt as te$1, u as E$2, v as K$1, y as Ke } from "./deepClone-aiDnUsbP.js";
import { o as P$4 } from "./shared-OSHalYuE.js";
import { r as p$4 } from "./number-VhAcjNnh.js";
import { t as p$5 } from "./Dictionary-CYjLcVIw.js";
import { a as a$3, r as I$2 } from "./Feature-DWXom0_g.js";
import { i as p$6, r as b$3, t as I$3 } from "./containerUtils-BMOxLSC2.js";
import { a as r$5, t as M$2 } from "./WhereClause-BDynIY4A.js";
import { r as i$7 } from "./streamLayerUtils-CzFTXymK.js";
import { a as Z$2, i as P$5, l as z$3, o as d$3 } from "./measures-BWuiWGQn.js";
import { t as l$4 } from "./fieldStats-DEI1rAxl.js";
import { t as t$5 } from "./ArcadePortal-BsQVLssp.js";
import { t as t$6 } from "./Attachment-Dzy8DAFV.js";
		...
		return w(r, t, (r, t, o) => {
			if (oe$1(o, 1, 1, r, t), H$1(o[0])) {
				if (o[0].hasField("__esri_time_received__")) {
					...
					return n$4(t) ? m$4.epochToArcadeDate(t, r.timeZone ?? "system") : ne$1(t) ? t : null;
				}
				return null;
			}
	...
	_.ringisclockwise = function(e, t) {
		...
		return E(e, t, (i, l, o) => {
			...
			if (1 === o.length) if (e$1(o[0])) f = I$2.fromJson(JSON.parse(o[0]), e.timeZone);
				...
				for (let n = 1; n < o.length; n += 2) {
					...
					if (!(null == i || e$1(i) || isNaN(i) || ne$1(i) || n$4(i) || ie$1(i) || re$1(i) || t$2(i))) throw new n$6(e, "InvalidParameter", t);
		...
		return E(e, t, (a, i, l) => {
			...
			for (let n = 0; n < l.length; n += 2) {
				...
				if (!(null == i || e$1(i) || isNaN(i) || ne$1(i) || n$4(i) || t$2(i) || re$1(i) || ie$1(i) || o$1(i) || te$1(i))) throw new n$6(e, "InvalidParameter", t);
...
function B(n, o, i) {
	if (null !== n) if (o$1(n)) {
		...
		if (t$2(n)) o.updateUint8Array([!0 === n ? 1 : 0, 113]);
			...
			if (n$4(n)) return o.updateFloatArray([n]), void o.updateUint8Array([173]);
	...
	e.guid = function(t, e) {
		return m(t, e, (r, n, a) => {
			...
			switch (a.length > 0 ? w.lookup(ge(a[0])) : null) {
				case "digits": return n$5().replace("-", "").replace("-", "").replace("-", "").replace("-", "");
				case "digits-hyphen": return n$5();
				case "digits-hyphen-parentheses": return "(" + n$5() + ")";
				default: return "{" + n$5() + "}";
			}
		});
...
var c;
async function s() {
	c ?? (c = await import("./geodeticDistanceOperator-BHVERC24.js"), await c.load());
}
function i(t) {
	const n = t.track;
...
//# sourceMappingURL=track-xxDOUL5u.js.map