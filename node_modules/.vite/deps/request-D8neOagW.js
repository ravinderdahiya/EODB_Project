import { c as a$4, m as has, t as s$3 } from "./config-C57gEaHo.js";
import { T as N$2 } from "./typedArrayUtil-BNfmp42K.js";
import { n as n$4, t as r$2 } from "./Error-DugVwGnI.js";
import { t as e$5 } from "./MapUtils-JZJyk-b6.js";
import { S as w$4, d as a$5, f as d$4, x as u } from "./promiseUtils-CsEq-Eti.js";
//#region node_modules/@arcgis/core/core/support/jsonUtils.js
function t$4(t) {
...
var l$1 = () => n$4.getLogger("esri.core.urlUtils"), c$3 = s$3.request, f$4 = "esri/config: esriConfig.request.proxyUrl is not set.", a$2 = /^\s*[a-z][a-z0-9-+.]*:(?![0-9])/i, h$3 = /^\s*http:/i, p$3 = /^\s*https:/i, m$4 = /^\s*file:/i, d$3 = /:\d+$/, y$4 = /^https?:\/\/[^/]+\.arcgis.com\/sharing(\/|$)/i, g$2 = /* @__PURE__ */ new RegExp("^(([^:/?#]+):)?(//([^/?#]*))?([^?#]*)(\\?([^#]*))?(#(.*))?$"), $$1 = /* @__PURE__ */ new RegExp("^((([^[:]+):)?([^@]+)@)?(\\[([^\\]]+)\\]|([^[:]*))(:([0-9]+))?$");
var x$1 = class {
	constructor(t = "") {
...
function B$1(t) {
	...
	}, e = c$3.proxyRules, r = n.urlPrefix;
	let o = e.length;
...
function H$1(t) {
	const n = c$3.proxyRules, e = S$1(t);
...
function N$1(t, n = c$3.interceptors) {
...
function Ut(t, n = !1) {
	return ht(t) ? t.slice(2) : (t = t.replace(a$2, ""), n && t.length > 1 && t.startsWith("/") && "/" === t[1] && (t = t.slice(2)), t);
}
function Ot(t) {
...
var e$2 = "20260408", c$2 = "42814086fee36c824cdfe45c9030212c4e8e8ff2";
//#endregion
...
r = "5.0.16", has("host-webworker") || globalThis.$arcgis || Object.defineProperty(globalThis, "$arcgis", {
	configurable: !1,
	enumerable: !0,
	writable: !1,
	value: {}
...
function p$2(e, s) {
	...
	if (e && o && (e = _$1(e, o, { preserveProtocolRelative: !0 }), s.portalItem && s.readResourcePaths)) {
		...
		null != t && t.startsWith(U$1) && s.readResourcePaths.push(s.portalItem.resourceFromPath(t).path);
	}
...
var d$2 = /\/items\/([^/]+)\/resources\/(.*)/, U$1 = "./resources/";
function v$1(e) {
...
function n(t, n) {
	...
	const u = m$2(t);
	if (!u || "FeatureServer" !== u.serverType || a$3(t)) return;
...
async function H(r) {
	...
	if (L && "HTMLFormElement" in globalThis && (i instanceof FormData ? l = i : i instanceof HTMLFormElement && (l = new FormData(i))), "string" == typeof i && (u = i), r.fetchOptions = {
		...
		redirect: "follow",
		signal: a
	}, (l || u) && (r.fetchOptions.body = l || u), (e$3.isForeignWorker || "anonymous" === o.authMode) && (r.useIdentity = !1), r.hasToken = !!(/token=/i.test(s) || o.query?.token || l?.get("token")), !r.hasToken) {
		const { getApiKey: e, getSessionToken: t } = await import("./apiKeyUtils-r870LtSO.js").then((n) => n.t), a = await t(s) ?? e(s);
		a && (o.query ??= {}, o.query.token = a, r.hasToken = !0);
	}
	if (r.useIdentity && !r.hasToken && !r.credential && !r.credentialToken && !N(s) && !a$5(a)) {
		let e;
...
async function I(r) {
	...
	if (!x) {
		...
		if (A ? (k.method = "delete" === n.method ? "DELETE" : "put" === n.method ? "PUT" : "POST", n.body ? s = Bt(s, a) : (k.body = A$1(a), k.headers || (k.headers = {}), k.headers["Content-Type"] = "application/x-www-form-urlencoded")) : s = Bt(s, a), g && (r.useProxy = !0, s = `${c}?${s}`), a.token && L && k.body instanceof FormData && !a$3(s) && k.body.set("token", a.token), n.hasOwnProperty("withCredentials")) r.withCredentials = n.withCredentials;
		else if (!F$1(s, C$1())) {
	...
	try {
		if ("native-request-init" === n.responseType) H = k, H.url = o, n.signal ? H.signal = n.signal : delete H.signal;
			...
			if (await e$3.beforeFetch?.(s, k), P = await fetch(o, k), await e$3.afterFetch?.(P), r.useProxy || D(s), "native" === n.responseType) H = P;
...
function D(e) {
	const t = X$1(e);
	t && !e$3.corsServers.includes(t) && e$3.corsServers.push(t);
}
function F(e) {
	const t = X$1(e);
	return !t || t.endsWith(".arcgis.com") || e$3.corsServers.includes(t) || M$1(t);
}
async function R() {
	s$1 || await import("./IdentityManager-qehaGTVm.js");
}
function N(e) {
...
function _(e, t, n, i) {
	...
	if (t instanceof r$2) return t.details ? (t.details = a$4(t.details), t.details.url = n.url, t.details.requestOptions = n.requestOptions) : t.details = u$1, t;
	if (t) {
...
async function a(t) {
	...
	if (!s) return null;
	const { QueueProcessor: c, SharedConcurrency: i } = await import("./QueueProcessor-DMIzZBEX.js").then((n) => n.t);
	return e$5(l, s.origin, () => {
		...
		return m$1 ??= new i(has("request-queue-concurrency-global") ?? 50), new c({
			...
			process: (r) => {
				if (a$5(r.parameters.requestOptions)) throw _("", u("Request canceled"), r.parameters);
				return P(r);
			}
		});
	});
...
async function h() {
	has("host-webworker") && (!d && globalThis.invokeStaticMessage ? d = await import("./request-L-kbuPl3.js") : e$3.isForeignWorker = !0);
}
...
//#endregion
export { et as $, $t as A, I$3 as B, t as C, t$1 as D, s$1 as E, D$1 as F, T$1 as G, N$1 as H, Dt as I, W$1 as J, Tt as K, F$1 as L, At as M, Bt as N, c$2 as O, Ct as P, _$1 as Q, G$1 as R, y$3 as S, r as T, P$1 as U, K$1 as V, Rt as W, Y as X, X$1 as Y, Z, h$2 as _, s$2 as _t, L$1 as a, mt as at, v$1 as b, d$1 as c, qt as ct, m$2 as d, ut as dt, ht as et, w$1 as f, vt as ft, g$1 as g, r$1 as gt, f$3 as h, a$3 as ht, I$1 as i, kt as it, A$1 as j, e$2 as k, h$1 as l, st as lt, R$1 as m, t$2 as mt, X as n, j$1 as nt, S as o, nt as ot, y$2 as p, x$1 as pt, V as q, C as r, jt as rt, T as s, ot as st, f as t, it as tt, j as u, tt as ut, m$3 as v, t$4 as vt, i$1 as w, x, p$2 as y, H$1 as z };

//# sourceMappingURL=request-D8neOagW.js.map