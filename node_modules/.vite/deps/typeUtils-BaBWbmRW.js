...
import { c as a$6 } from "./config-BvnHHLFh.js";
import { n as n$9, o as l$8 } from "./Error-BBuf4ybn.js";
import { t as b$5 } from "./Accessor-C495Hp5e.js";
import { b as s$4 } from "./promiseUtils-DQTPPyja.js";
import { E as D$1, P as x$1, a as o$4, d as s$5, i as r$2, n as c$8, o as r$3, r as m$6, t as a$7, v as t$4 } from "./decorators-DNvoMvUC.js";
import { n as l$9 } from "./Clonable-DA_4iBES.js";
import { F as D$2, V as K, X as Y, _ as h$6, h as f$3, lt as st, ut as tt, v as m$7, y as p$17 } from "./request-C9CBIkRO.js";
import { t as q } from "./Collection-YvtsTsOX.js";
import { n as n$10 } from "./JSONSupport-BWDaFwRT.js";
import { t as i$11 } from "./jsonMap-DEVWHgIV.js";
import { L as v$2 } from "./fieldUtils-Du6qy8H2.js";
import { t as g$4 } from "./Color-DUA_J43M.js";
import { a as d$3, c as n$11, i as i$12, n as m$8, o as e$4, s as n$12, t as u$5 } from "./SimpleMarkerSymbol-CEhD36qZ.js";
import { n as n$13, t as e$5 } from "./collectionUtils-C4iBtD2M.js";
import { t as M$1 } from "./Portal-CGQ-0P7E.js";
import { l as o$5, r as e$6 } from "./screenUtils-BMK0toVx.js";
import { n as r$4, t as n$14 } from "./opacityUtils-BREU4cxd.js";
import { a as u$6, n as i$13, r as l$10 } from "./symbolLayerUtils3D-_ySLA1Ka.js";
import { a as p$18, i as n$15, n as y$1, r as m$9, t as u$7 } from "./TextSymbol-DM_BCJOt.js";
import { n as c$9, r as m$10, t as c$10 } from "./PictureMarkerSymbol-geh9f4gk.js";
//#region node_modules/@arcgis/core/symbols/CIMSymbol.js
var n$8;
var m$5 = n$8 = class extends n$11 {
	constructor(r) {
...
var p$14 = class extends l$9(n$10) {
	constructor(o) {
...
var p$11 = class extends l$9(n$10) {
	constructor(r) {
		super(r);
	}
};
...
var p$10 = class extends l$9(n$10) {
	constructor() {
...
var u$4;
var c$4 = u$4 = class extends n$10 {
	constructor(t) {
...
var d$1 = l$4 = class extends n$10 {
	constructor(r) {
		super(r);
	}
	readHref(r, e, t) {
	...
	writeHref(r, e, t, p) {
		r && (tt(r) ? e.dataURI = r : (e.href = m$7(r, p), Y(e.href) && (e.href = K(e.href))));
	}
	clone() {
		return new l$4({
			href: this.href,
...
var i$5 = class extends l$9(n$10) {
	constructor(o) {
...
var n$6;
var u$3 = n$6 = class extends n$10 {
	constructor(o) {
...
var c$3 = class extends l$9(n$10) {
	constructor(o) {
...
var a$4 = n$5 = class extends n$10 {
	constructor(r) {
		super(r);
	}
	clone() {
...
var c$2;
var m$2 = c$2 = class extends n$10 {
	constructor(o) {
		super(o), this.color = new g$4([
			0,
			0,
...
var l$3 = class extends l$9(n$10) {
	constructor(o) {
...
var T$1 = class extends n$11 {
	...
	writeStyleOrigin(e, r, t, o) {
		if (e.styleUrl && e.name) {
			let t = m$7(e.styleUrl, o);
			Y(t) && (t = K(t)), r.styleOrigin = {
				styleUrl: t,
				name: e.name
			};
		} else e.styleName && e.name && (e.portal && o?.portal && !D$2(e.portal.restUrl, o.portal.restUrl) ? o?.messages && o.messages.push(new t$4("symbol:cross-portal", "The symbol style origin cannot be persisted because it refers to an item on a different portal than the one being saved to.", { symbol: this })) : r.styleOrigin = {
			styleName: e.styleName,
			name: e.name
		});
	}
...
__decorate([a$7({ json: {
	...
	nonNullable: !0,
	json: { write: !0 }
}), m$6(e$5)], T$1.prototype, "symbolLayers", null), __decorate([a$7({ type: p$5 })], T$1.prototype, "styleOrigin", void 0), __decorate([o$4("styleOrigin")], T$1.prototype, "readStyleOrigin", null), __decorate([r$2("styleOrigin", {
...
var i$1;
var p$3 = i$1 = class extends n$10 {
	constructor(o) {
...
var c = m = class extends n$11 {
	...
	async _fetchSymbol(t) {
		...
		const { resolveWebStyleSymbol: s } = await import("./webStyleSymbolUtils-j9-cOMe1.js").then((n) => n.r);
		s$4(t);
...
//# sourceMappingURL=typeUtils-BaBWbmRW.js.map