...
import { M as s$1, N as u$2, S as r$1, b as i$1, j as o, u as l, x as n$3 } from "./uid-BI1T_uZT.js";
import { f as u$3, u as n$4 } from "./tracking--iwQUXaz.js";
import { S as u$4, b as r$2, t as b } from "./Accessor-CPmfB7ST.js";
...
function g(r, e, t) {
	if (r && "function" == typeof r.toJSON && (!r.toJSON.isDefaultToJSON || !r.write)) return u$3(e, r.toJSON(t));
	...
	for (const u in f) {
		...
		Object.keys(d).length > 0 && (e = u$3(e, d), t?.resources?.pendingOperations?.length && t.resources.pendingOperations.push(Promise.all(t.resources.pendingOperations).then(() => u$3(e, d, () => "replace-arrays"))), t?.writtenProperties && t.writtenProperties.push({
			target: r,
			propName: u,
			oldOrigin: u$4(n.store.originOf(u)),
			newOrigin: t.origin
		}));
	}
	return e;
...
//# sourceMappingURL=JSONSupport-C2nyciis.js.map