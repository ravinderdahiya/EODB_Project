...
import { a as n$3, c as a$7 } from "./config-BvnHHLFh.js";
import { n as n$4 } from "./Error-BBuf4ybn.js";
import { t as b$2 } from "./Accessor-C495Hp5e.js";
import { E as D, M as u$4, a as o$1, d as s$4, f as a$9, i as r$2, n as c$2, p as i$5, r as m$4, s as s$3, t as a$8 } from "./decorators-DNvoMvUC.js";
...
import { K as e$1, L as v$3, V as x$1 } from "./fieldUtils-Du6qy8H2.js";
import { c as n$6 } from "./SimpleMarkerSymbol-CEhD36qZ.js";
import { f as x$2, h as f$3, n as D$1, r as F } from "./typeUtils-BaBWbmRW.js";
import { l as o$3 } from "./screenUtils-BMK0toVx.js";
import { n as r$3, t as n$7 } from "./opacityUtils-BREU4cxd.js";
import { n as p$2, t as m$5 } from "./colorRamps-BWMotyx7.js";
import { t as a$10 } from "./ColorStop-BZkRNbH4.js";
import { c as n$8, n as f$4, o as i$6, s as l$6 } from "./visualVariableUtils-3yW1nOtv.js";
import { n as s$5 } from "./jsonUtils-DmvfWDlB.js";
...
var u$2 = class extends n$5 {
	...
	castField(e) {
		return null == e ? e : "function" == typeof e ? (n$4.getLogger(this).error(".field: field must be a string value"), null) : u$4(e);
	}
	get arcadeRequired() {
...
var V$1 = z = class extends u$2 {
	...
	set maxDataValue(e) {
		e && this.stops && (n$4.getLogger(this).warn("cannot set maxDataValue when stops is not null."), e = null), this._set("maxDataValue", e);
	}
	get maxSize() {
		return this._get("maxSize");
	}
	set maxSize(e) {
		e && this.stops && (n$4.getLogger(this).warn("cannot set maxSize when stops is not null."), e = null), this._set("maxSize", v$1(e));
	}
	readMaxSize(e, t, i) {
		return g(e, t, i);
	}
	...
	set minDataValue(e) {
		e && this.stops && (n$4.getLogger(this).warn("cannot set minDataValue when stops is not null."), e = null), this._set("minDataValue", e);
	}
	get minSize() {
		return this._get("minSize");
	}
	set minSize(e) {
		e && this.stops && (n$4.getLogger(this).warn("cannot set minSize when stops is not null."), e = null), this._set("minSize", v$1(e));
	}
	readMinSize(e, t, i) {
		return g(e, t, i);
	}
	...
	set stops(e) {
		null == this.minDataValue && null == this.maxDataValue && null == this.minSize && null == this.maxSize ? e && Array.isArray(e) && (e = e.filter((e) => !!e)).sort((e, t) => e.value - t.value) : e && (n$4.getLogger(this).warn("cannot set stops when one of minDataValue, maxDataValue, minSize or maxSize is not null."), e = null), this._set("stops", e);
	}
...
var h = class extends b$2 {
	...
	readVariables(r, t, s) {
		...
		if (l && (r || (r = []), r.push({
			...
			o || (n$4.getLogger(this).warn(`Unknown variable type: ${t}`), a$9(s, "warning", "visual-variable", `visualVariable of type '${t}' is not supported`, { definition: r }));
			const e = new o();
			return e.read(r, s), e;
		});
	}
...
}, m = n$3({ json: { origins: { "web-scene": { write: { isRequired: !0 } } } } }, y), n = {
	types: {
		base: n$6,
		key: "type",
		typeMap: {
...
//#endregion
export { m$1 as a, s as c, a$3 as d, b$1 as f, y as i, a$1 as l, m as n, V$1 as o, n as r, l as s, a as t, u$2 as u };

//# sourceMappingURL=commonProperties-Dj1YMGeo.js.map