...
import { C as html, D as css, T as nothing, b as createEvent, f as stringOrBoolean, h as live, l as safeClassMap, m as ref, p as createRef, r as customElement, s as LitElement, t as CSS_UTILITY, u as safeStyleMap } from "./runtime-BXH9trC4.js";
import { i as useWatchAttributes } from "./controllers-mnbpiNLx.js";
import { t as useT9n } from "./useT9n-BVYBhsrm.js";
import { f as isPrimaryPointerButton, h as setRequestedIcon, i as getElementDir } from "./dom-Cm4WhhcM.js";
import "./calcite-icon-ouxoXzXo.js";
import { t as keyed } from "./keyed-CJhr5oKW.js";
import { n as getIconScale, t as useSetFocus } from "./useSetFocus-BClTUykE.js";
import { a as internalHiddenInputInputEvent, n as connectForm, r as disconnectForm, s as submitForm, t as HiddenFormInputSlot } from "./form-BE9sZaiD.js";
import { t as useInteractive } from "./useInteractive-rT7wiwIQ.js";
import { n as numberKeys } from "./key-DuBDcXtL.js";
import { i as getLabelText, n as connectLabel, r as disconnectLabel } from "./label-DYY0Ogn7.js";
import "./calcite-input-message-D4x9XhwJ.js";
//#region node_modules/@esri/calcite-components/dist/components/calcite-progress/customElement.js
var styles$1 = css`:host{position:relative;display:block;inline-size:100%}.track,.bar{position:absolute;inset-block-start:0px;block-size:2px}.track{z-index:var(--calcite-z-index);inline-size:100%;overflow:hidden;background-color:var(--calcite-progress-background-color, var(--calcite-color-border-3))}.bar{z-index:var(--calcite-z-index);background-color:var(--calcite-progress-fill-color, var(--calcite-color-brand))}@media(forced-colors:active){.track{background-color:highlightText}.bar{background-color:linkText}}.indeterminate{inline-size:20%;animation:looping-progress-bar-ani calc(var(--calcite-internal-animation-timing-medium) / var(--calcite-internal-duration-factor) * 11 / var(--calcite-internal-duration-factor)) linear infinite}.indeterminate.calcite--rtl{animation-name:looping-progress-bar-ani-rtl}.reversed{animation-direction:reverse}.text{padding-inline:0px;padding-block:1rem 0px;text-align:center;font-size:var(--calcite-font-size-relative-sm);line-height:var(--calcite-font-line-height-sm);font-weight:var(--calcite-font-weight-medium);color:var(--calcite-progress-text-color, var(--calcite-color-text-2))}@keyframes looping-progress-bar-ani{0%{transform:translate3d(-100%,0,0)}50%{inline-size:40%}to{transform:translate3d(600%,0,0)}}@keyframes looping-progress-bar-ani-rtl{0%{transform:translate3d(100%,0,0)}50%{inline-size:40%}to{transform:translate3d(-600%,0,0)}}:host([hidden]){display:none}[hidden]{display:none}`;
var CSS$3 = {
	track: "track",
	bar: "bar",
	text: "text"
...
var Progress = class extends LitElement {
	...
	render() {
		...
		return html`<div .ariaLabel=${this.label || this.text} .ariaValueMax=${isDeterminate ? "100" : void 0} .ariaValueMin=${isDeterminate ? "0" : void 0} .ariaValueNow=${isDeterminate ? this.value : void 0} role=progressbar><div class=${safeClassMap(CSS$3.track)}><div class=${safeClassMap({
			[CSS$3.bar]: true,
			indeterminate: this.type === "indeterminate",
			[CSS_UTILITY.rtl]: dir === "rtl",
			reversed: this.reversed
		})} style=${safeStyleMap(barStyles)}></div></div>${this.text ? html`<div class=${safeClassMap(CSS$3.text)}>${this.text}</div>` : null}</div>`;
	}
};
...
//#endregion
export { numberStringFormatter as n, calcite_input_exports as t };

//# sourceMappingURL=calcite-input-C8ajG6Zh.js.map