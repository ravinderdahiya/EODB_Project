...
import { h as m, m as l } from "./mathUtils-Dq5Y4VHb.js";
import { n as e } from "./common-BrBjj0mE.js";
import { b as p, d as b, f as d, h as j, n as E$1, p as e$1, t as B, u as _$1, x as q, y as o } from "./vec2-DD9Lt6SG.js";
import { l as p$1, p as v } from "./curveUtils-BIVZ_WWm.js";
import { d as t, l as r, s as n, t as N$1 } from "./vec3f64-C0R7gEMc.js";
import { n as i } from "./geodesicConstants-B9wOqL9o.js";
import { i as _$2, l as o$1 } from "./vec4-BUvMTBW6.js";
import { i as n$1 } from "./vec4f64-CNVTVVzP.js";
import { i as n$2, o as r$1, r as l$1 } from "./vec2f64-DBnievnq.js";
import { C as g, M as v$1, O as o$2, T as j$1, _ as _$3, i as F$1, j as u, k as p$2, l as P, m as W, n as C, o as H$1, t as A, x as e$2 } from "./vec3-BsfrqlWE.js";
import { t as u$1 } from "./closestPointOnCurve-BFCiB9jF.js";
import { c as O$1, d as R$1, g as X$1, h as W$1, i as J, m as U, w as y, x as v$2, y as k } from "./plane-BksdM5qJ.js";
import { i as p$3 } from "./mathUtils-HF_yfSIc.js";
import { a as f, c as l$2, d as s, i as d$1, n as a, r as c } from "./normalizedPoint-C8ByNQEK.js";
import { i as q$1, n as b$1, r as j$2 } from "./geodesicUtils-5yZGcWHU.js";
import { n as w } from "./sphere-CKg38q4n.js";
import { r as g$1 } from "./geometry2dUtils-o1zUUjW2.js";
//#region node_modules/@arcgis/core/views/support/geometry3dUtils.js
function E({ start: t, end: n, type: e }, i, u) {
	const a = [], f = e$1(nt, n, t), m = e$1(st, t, i), d$2 = p(f), h = 2 * j(f, m), l = h * h - 4 * d$2 * (p(m) - u * u);
	if (0 === l) {
		const r = -h / (2 * d$2);
...
function S({ start: t, end: n$7, type: s }, e, i) {
	const u = [], a = e$2(et, n$7, t), f = e$1(st, t, e), p$4 = p(a), m = 2 * j(a, f), d = m * m - 4 * p$4 * (p(f) - i * i);
	if (0 === d) {
		const r = -m / (2 * p$4);
		(1 === s || r >= 0) && u.push(g(n(), t, a, r));
	} else if (d > 0) {
		const r = Math.sqrt(d), n$8 = (-m + r) / (2 * p$4);
...
var gt = class extends ft {
	...
	equals(t) {
		return this === t || xe(t) && C(this.start, t.start) && p$1(this.curve, t.curve);
	}
};
...
//# sourceMappingURL=constraints-Ruuf18sN.js.map