...
import { a as o, n as c, t as a } from "./decorators-DNvoMvUC.js";
import { t as f$1, y as p } from "./request-C9CBIkRO.js";
...
import { n as U, r as a$1 } from "./reactiveUtils-Bd9X7q7v.js";
import { t as M } from "./Portal-CGQ-0P7E.js";
import { t as s } from "./APIKeyMixin-DP47T0kQ.js";
import { t as l } from "./ArcGISService-BO8mwMCa.js";
import { t as s$1 } from "./CustomParametersMixin-C7lCgnMy.js";
import { h as y, l as m } from "./commonProperties-BAS6ewmU.js";
import { T as t } from "./layerUtils-DqdiS7uu.js";
...
import { t as j } from "./persistable-8L7c9ZrD.js";
import { o as R, p as j$1, y as w } from "./elevationInfoUtils-C1mGP2nk.js";
import { i as y$1, n as d, r as x } from "./tiles3DUtils-DLrPWsDS.js";
import { i as r$1, r as l$2 } from "./Lyr3DWorker-Dx_NO6Rz.js";
import { a as u, n as f$2 } from "./SceneLayerWorkerHandle-DtO_O5vS.js";
import { t as p$1 } from "./SceneModifications-zsb7hOOf.js";
		...
		return this._rootRequestPromise || (this._rootRequestPromise = new Promise((o, a) => {
			...
			new Promise((e, o) => {
				if (this.replacesTerrain && !this._key) {
					...
					r.signIn().then(() => {
						r.g3dTilesEnabled ? f$1(r.restUrl + "/portals/self/modules/g3dtiles", {
							responseType: "json",
							query: { f: "json" }
						}).then((t) => {
				...
				f$1(this.url, {
					...
					f(e), a(i("root-load-failed", "Error loading root tile")), this._rootRequestPromise = null, n.getLogger("IntegratedMesh3DTilesLayer").error("Layer loading failed", e);
				});
			}, (e) => a(e));
...
//# sourceMappingURL=IntegratedMesh3DTilesLayer-fBp-sM1u.js.map