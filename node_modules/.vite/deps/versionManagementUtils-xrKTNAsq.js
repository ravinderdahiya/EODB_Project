...
async function i(e, r, n = !1) {
	...
	if (o) {
		for (const [s, i] of o) if (i.name === r) {
			...
			if (!e && n) {
				const [{ deleteForwardEdits: e }, { default: r }] = await Promise.all([import("./deleteForwardEdits-DlIUqBgZ.js"), import("./DeleteForwardEditsParameters-DqRbHs3V.js")]), n = await e(a, s, new r({
					sessionId: t,
					moment: i.moment
				}));
...
//# sourceMappingURL=versionManagementUtils-xrKTNAsq.js.map