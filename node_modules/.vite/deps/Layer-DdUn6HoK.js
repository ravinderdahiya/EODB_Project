...
import { r as n$1 } from "./Evented-BAHt7IWa.js";
import { t as o$1 } from "./Identifiable-DLvrlmJB.js";
import { r as u } from "./Loadable-CDav2d-w.js";
import { t as m } from "./TimeExtent-D_kBC_AE.js";
//#region node_modules/@arcgis/core/layers/support/fromPortalItem.js
async function o(o) {
	const a = "portalItem" in o ? o : { portalItem: o }, { fromItem: e } = await import("./portalLayers-FuVNF6W-.js").then((n) => n.n);
	try {
		return await e(a);
	} catch (p) {
...
var c = 0, b = class extends n$1(o$1(u)) {
	...
	static async fromArcGISServerUrl(t) {
		...
		return (await import("./arcgisLayers-CBHoflAy.js")).fromUrl(e);
	}
...
//# sourceMappingURL=Layer-DdUn6HoK.js.map