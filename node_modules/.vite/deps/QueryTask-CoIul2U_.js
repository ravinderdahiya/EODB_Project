...
import { y as p } from "./promiseUtils-CsEq-Eti.js";
...
import { t as n } from "./DynamicDataLayer-uBlZOjnL.js";
import { t as R } from "./Query-B3EKjSMn.js";
import { i as d } from "./infoFor3D-BQtb6xJV.js";
import { n as f } from "./utils-DJDn3Hpd.js";
import { n as m$1, r as m, t as i } from "./executeForIds-DYIFinV6.js";
import { t as n$1 } from "./executeQueryJSON-h8Oc0f6e.js";
import { t as n$2 } from "./executeQueryPBF-Jjq7wx9j.js";
...
var S = class extends b {
	...
	async featureSetFromJSON(e, t, r) {
		...
		const { meshFeatureSetFromJSON: s } = await p(import("./meshFeatureSet-PNzrIeU-.js"), r);
	...
	async executeRelationshipQuery(e, t) {
		const [{ default: r }, { executeRelationshipQuery: s }] = await p(Promise.all([import("./RelationshipQuery-sWRg462w.js").then((n) => n.t), import("./executeRelationshipQuery-Dk_W6_5H.js")]), t);
		let i = r.from(e);
	...
	async executeRelationshipQueryForCount(e, t) {
		const [{ default: r }, { executeRelationshipQueryForCount: s }] = await p(Promise.all([import("./RelationshipQuery-sWRg462w.js").then((n) => n.t), import("./executeRelationshipQuery-Dk_W6_5H.js")]), t);
		let i = r.from(e);
		return (this.gdbVersion || this.dynamicDataSource) && (i = i.clone(), i.gdbVersion = i.gdbVersion || this.gdbVersion, i.dynamicDataSource = i.dynamicDataSource || this.dynamicDataSource), s(this.url, i, t);
	}
	async executeAttachmentQuery(e, t) {
		const { executeAttachmentQuery: r, fetchAttachments: s, processAttachmentQueryResult: i } = await p(import("./queryAttachments-JHavI4xf.js"), t), u = f(this.url);
		return i(u, await (this.queryAttachmentsSupported ? r(u, e, t) : s(u, e, t)));
	}
	async executeAttributeBinsQuery(e, t) {
		const { executeAttributeBinsQuery: r } = await p(import("./executeAttributeBinsQuery-KrWXL49c.js"), t);
		return r(this.parsedUrl, e, t);
	}
	async executePivotQuery(e, t) {
		const { executePivotQuery: r } = await p(import("./executePivotQuery-DyouZLiq.js"), t);
		return r(this.parsedUrl, e, t);
	}
	async executeTopFeaturesQuery(e, t) {
		const { executeTopFeaturesQuery: r } = await p(import("./executeTopFeaturesQuery-9kOXDDvX.js"), t);
		return r(this.parsedUrl, e, this.sourceSpatialReference, t);
	}
	async executeForTopIds(e, t) {
		const { executeForTopIds: r } = await p(import("./executeForTopIds-C0v4UAe7.js"), t);
		return r(this.parsedUrl, e, t);
	}
	async executeForTopExtents(e, t) {
		const { executeForTopExtents: r } = await p(import("./executeForTopExtents-CSw4Vawt.js"), t);
		return r(this.parsedUrl, e, t);
	}
	async executeForTopCount(e, t) {
		const { executeForTopCount: r } = await p(import("./executeForTopCount--ANVoI_w.js"), t);
		return r(this.parsedUrl, e, t);
	}
	_normalizeQuery(e) {
		let t = R.from(e);
...
//# sourceMappingURL=QueryTask-CoIul2U_.js.map