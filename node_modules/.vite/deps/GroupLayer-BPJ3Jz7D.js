...
import { a as o, i as r, n as c, t as a } from "./decorators-DNvoMvUC.js";
...
import { c as w, n as U, r as a$1, s as l } from "./reactiveUtils-Bd9X7q7v.js";
import { n as p } from "./BlendLayer-Bpmi1XVm.js";
import { t as g } from "./OperationalLayer-BxguAHEc.js";
import { n as k } from "./PortalItem-CIoKg9kM.js";
import { t as _ } from "./PortalLayer-CTtkH8GV.js";
import { t as l$1 } from "./ScaleRangeLayer-D76TyAvh.js";
import { n as l$2 } from "./loadAll-DivbBt7x.js";
import { t as w$1 } from "./writeUtils-BH6VOTXa.js";
import { t as l$3 } from "./CollectionFlattener-XzP_ikUG.js";
import { i as t, n as d, t as n$2 } from "./TablesMixin-Chij_x-E.js";
import { n as s } from "./saveUtils-DrHSc6Ij.js";
import { t as a$2 } from "./lazyLayerLoader-CXipStcz.js";
import { populateGroupLayer as C } from "./layersCreator-cXHfCNnW.js";
...
var V = class extends p(l$1(g(_(n$2(d(e$1(b))))))) {
	constructor(e) {
		super(e), this._allLayers = new l$3({
			...
			const { save: r, saveAs: s } = await import("./groupLayerUtils-BYTdp735.js");
			switch (e) {
	...
	layerAdded(e) {
		e.visible && "exclusive" === this.visibilityMode ? this._turnOffOtherLayers(e) : "inherited" === this.visibilityMode && (e.visible = this.visible), this.hasHandles(e.uid) ? console.error(`Layer read to Grouplayer: uid=${e.uid}`) : this.addHandles(l(() => e.visible, (t) => this._onChildVisibilityChange(e, t), U), e.uid);
	}
	layerRemoved(e) {
...
//# sourceMappingURL=GroupLayer-BPJ3Jz7D.js.map