...
import { c as a$1, m as has } from "./config-BvnHHLFh.js";
...
import { t as $ } from "./promiseUtils-DQTPPyja.js";
import { n as c, t as a$2 } from "./decorators-DNvoMvUC.js";
import { t as a$3 } from "./tracking-DYGZck8O.js";
import { i as r$2 } from "./Evented-BHes3AIJ.js";
import { t as s$1 } from "./SimpleObservable-CPiqJioh.js";
import { r as t, t as e$1 } from "./utils-DFX90Dxd.js";
import { t as g } from "./parser-6ViBxJgd.js";
import { h as e$2 } from "./util-DKyIVDQp.js";
import "./Texture-kQ-4z2Ry.js";
import { h as _$1, u as R } from "./enums-DTcJjWAa.js";
import { t as t$1 } from "./VertexElementDescriptor-uU8ibFb-.js";
import { t as o$2 } from "./BufferObject-BX5ZcdcA.js";
import "./Program-JfA-tSp6.js";
import { t as h$1 } from "./VertexArrayObject-CuvTUDAe.js";
import { t as r$3 } from "./VertexBuffer-DcatbgS_.js";
	...
	set effect(t) {
		if (this._get("effect") !== (t = t || "")) {
			...
			try {
				...
				this._transitionTo([]), n$1.getLogger(this).warn("Invalid Effect", {
					effect: t,
					error: e
				});
			}
...
function u(t$2, e, s) {
	if (!t$2[0]?.effects || !e[0]?.effects) return !0;
	return !((t$2[0]?.scale === l || e[0]?.scale === l) && (t$2.length > 1 || e.length > 1) && s <= 0) && t(t$2[0].effects, e[0].effects);
}
function _(t, e, s) {
	const i = t.length > e.length ? t : e, r = t.length > e.length ? e : t, n = r[r.length - 1], c = n?.scale ?? s, f = n?.effects ?? [];
	for (let o = r.length; o < i.length; o++) r.push({
		scale: c,
		effects: [...f]
	});
	for (let h = 0; h < i.length; h++) r[h].scale = r[h].scale === l ? s : r[h].scale, i[h].scale = i[h].scale === l ? s : i[h].scale, e$1(r[h].effects, i[h].effects);
}
function p(t, e, s) {
	return t + (e - t) * s;
}
...
__decorate([a$2()], r.prototype, "computedOpacity", void 0), __decorate([a$2()], r.prototype, "computedVisible", void 0), __decorate([a$2()], r.prototype, "opacity", void 0), __decorate([a$2()], r.prototype, "visible", void 0), __decorate([a$2()], r.prototype, "transitioning", null), __decorate([a$2()], r.prototype, "_fadeOutResolver", void 0), __decorate([a$2()], r.prototype, "_fadeInResolver", void 0), r = __decorate([c("esri.views.2d.engine.transitions.FadeTransition")], r);
//#endregion
...
var n = class extends e {
	...
	get children() {
		return a$3(this._childrenObservable), this._children;
	}
	get clips() {
		return this._clips;
	}
	...
	contains(t) {
		return a$3(this._childrenObservable), this._childrenSet.has(t);
	}
	removeAllChildren() {
...
var s = class s extends o$1 {
	static create(e, r) {
		...
		for (const [s, { count: d, offset: f, type: m, normalized: x }] of Object.entries(r.layout)) {
			null != f && (a = f);
			const e = new t$1(s, d, m, a, o, null != x && x, 0);
			i.push(e), a += d * T[m];
		}
...
//#endregion
export { h as a, e as i, o$1 as n, n as r, s as t };

//# sourceMappingURL=SimpleMesh-CKUc6YOf.js.map