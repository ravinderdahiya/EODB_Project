...
import { t as c } from "./PixelBlock-bC_q_hQ4.js";
...
async function r(t, e, n) {
	...
	if (!(await import("./intersectsOperator-fpq8BP-i.js")).execute(e, n)) return new c({
	...
	return (await import("./containsOperator-BbggXDk8.js")).execute(n, e) ? t : o(t, e, n);
}
function o(t, e, n) {
	if (!t) return t;
...
//# sourceMappingURL=clipUtils-DNhwPV7X.js.map