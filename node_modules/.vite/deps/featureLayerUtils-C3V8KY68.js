...
import { N as w, d as s, i as r$1, n as c, t as a$2 } from "./decorators-DNvoMvUC.js";
import { E as s$1, o as S$1 } from "./request-C9CBIkRO.js";
import { n } from "./JSONSupport-BWDaFwRT.js";
import { n as o } from "./jsonMap-DEVWHgIV.js";
import { r as c$1 } from "./sql-D5tftSMw.js";
import { j as ge, k as be } from "./fieldUtils-Du6qy8H2.js";
import { a as c$2, s as i } from "./Field-Tv6GBBbl.js";
import { n as D$1 } from "./typeUtils-BaBWbmRW.js";
import { t as e } from "./uuid-Dis-U6Ct.js";
import { t as R$1 } from "./Query-f0pWdGs2.js";
import { r as d } from "./asyncUtils-CF4XM__w.js";
import { t as r$2 } from "./featureQueryAll-DZvEOaS-.js";
import { o as J$1, r as F$1 } from "./layerUtils-DqdiS7uu.js";
import { t as n$1 } from "./SimpleRenderer-D4z9Ei2T.js";
import { t as $$1 } from "./UniqueValueRenderer-WslDfkHh.js";
import { t as n$2 } from "./NormalizationBinParametersMixin-CBWC9E9l.js";
...
async function S(e, t, r) {
	const { applyEdits: n } = await import("./editingSupport-BhM1rFAF.js"), o = await e.load();
	let i = r;
...
async function v(e, t, r) {
	const { uploadAssets: n } = await import("./editingSupport-BhM1rFAF.js"), o = await e.load();
...
async function Z(t, r) {
	if (!s$1) return;
	const n = s$1.findCredential(t);
	if (n) return n.userId;
	let o;
	try {
		const n = await F$1(t, r);
		n && (o = await s$1.checkSignInStatus(`${n}/sharing`));
	} catch (i) {}
	return o ? o.userId : null;
}
async function H(t, r) {
	if (!s$1) return;
	if (s$1.findCredential(t)) return;
	let n;
	try {
		const o = await F$1(t, r);
		o && (n = await s$1.checkSignInStatus(`${o}/sharing`));
	} catch (o) {}
	if (n) try {
		const n = null != r ? r.signal : null;
		await s$1.getCredential(t, { signal: n });
	} catch (o) {}
}
...
//# sourceMappingURL=featureLayerUtils-C3V8KY68.js.map