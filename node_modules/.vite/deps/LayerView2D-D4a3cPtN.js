...
import { g as s$2, n as n$2, t as r } from "./Error-BBuf4ybn.js";
...
import { m as s$3 } from "./Point-IZafMjJg.js";
import { t as z } from "./Extent-BLsNNw_-.js";
import { c as w$1, s as l$1 } from "./reactiveUtils-Bd9X7q7v.js";
import { t as j } from "./Polygon-DVpFKUwp.js";
import { n as u } from "./jsonUtils-Ctwrsphe.js";
import { n as n$4 } from "./collectionUtils-C4iBtD2M.js";
import { r as H$1 } from "./projectionUtils-CmrwAiSI.js";
import { t as e$2 } from "./ReactiveMap-DmUuyxzn.js";
import { n as c$1 } from "./HighlightDefaults-CLDs1Qa7.js";
import { _ as u$1, n as h } from "./util-DKyIVDQp.js";
import { i as n$5 } from "./vec2f64-DBnievnq.js";
import { h as _$2, u as R } from "./enums-DTcJjWAa.js";
import { n as n$6 } from "./clippingUtils-D_lJ5hBd.js";
import { l as S$1, t as A, y as nt } from "./featureConversionUtils-wlx19X5q.js";
import { a as r$1 } from "./layerViewUtils-Z-rgrF3-.js";
import { n as f$1 } from "./projectionSupport-htUqS4x4.js";
import { r as n$7, t as s$4 } from "./SimpleMesh-CKUc6YOf.js";
import { r as g$1, t as a$1 } from "./templateUtils-BMZGCxVt.js";
//#region node_modules/@arcgis/core/linkChart/utils.js
function e(e) {
	return null != e && "object" == typeof e && "2d" === e.type && "linkchart" === e.view2dType;
}
//#endregion
...
var i$1 = class extends b {
	constructor() {
		super(...arguments), this._idToCounters = new e$2();
	}
	get size() {
	...
	add(e, t) {
		let s = !1;
		for (const r of e) {
			const e = e$1(this._idToCounters, r, () => (s = !0, /* @__PURE__ */ new Map())), i = e.get(t) ?? 0;
			i || (s = !0), e.set(t, i + 1);
		}
		return s;
	}
...
var _ = q.ofType({
	...
	let y = class extends f$2 {
		...
		canResume() {
			...
			switch (this.layer?.type) {
				...
				case "graphics": break;
				default: if (e(this.view) && !this.view.inGeographicLayout) return !1;
			}
	...
	return __decorate([a()], y.prototype, "attached", void 0), __decorate([a({
		type: _,
		set(t) {
			const e = n$4(t, this._get("clips"), _);
			this._set("clips", e);
		}
...
//# sourceMappingURL=LayerView2D-D4a3cPtN.js.map