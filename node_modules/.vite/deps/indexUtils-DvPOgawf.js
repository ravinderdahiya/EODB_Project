import { _ as t, d as l$2, f as m, i as U, t as A } from "./typedArrayUtil-BNfmp42K.js";
import { t as r } from "./Error-DugVwGnI.js";
import { b as s, p as f$1 } from "./promiseUtils-CsEq-Eti.js";
import { ot as nt, t as f$2, ut as tt } from "./request-D8neOagW.js";
import { n as b } from "./asyncUtils-CkOE2Ohe.js";
import { h as _ } from "./enums-Bdb_FU7M.js";
import { i as l$3, t as a } from "./Indices-ePtZ22ZM.js";
...
var l = class {
	...
	async _load(s, a, i) {
		...
		const l = await b(f$2(a, {
			responseType: s,
			...i
		}));
		if (l.ok) return l.value.data;
		throw f$1(l.error), new r("gltf-loader-request-error", `Request for resource failed: ${l.error}`);
	}
};
//#endregion
...
//# sourceMappingURL=indexUtils-DvPOgawf.js.map