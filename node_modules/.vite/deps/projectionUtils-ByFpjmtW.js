...
import { b as s, s as O } from "./promiseUtils-CsEq-Eti.js";
import { t as a } from "./tracking--iwQUXaz.js";
import { l as T, n as C$1, o as O$1, s as P, u as U } from "./spatialReferenceUtils-BtA22Tuk.js";
import { I as A, V as O$2 } from "./units-BF_YTgze.js";
import { t as S } from "./SpatialReference-BZmWVCQF.js";
import { f as o, m as s$1, p as r$1, t as _$1 } from "./Point-BumYnEDe.js";
import { t as z } from "./Extent-BU6jY2-x.js";
import { t as j } from "./Polygon-k6iGU-4W.js";
import { a as i, n as c, p as v, t as a$1 } from "./curveUtils-BmykpmD9.js";
import { t as s$2 } from "./SimpleObservable-D9fUp0fM.js";
import { t as m } from "./Multipoint-DmEBWnpo.js";
import { t as y } from "./Polyline-BReR2xtn.js";
import { a as o$1, c as t$1, i as n, n as i$1, t as e$1 } from "./jsonTypeUtils-BSoxwy98.js";
import { s as n$1 } from "./vec3f64-NuZYD0Oc.js";
import { t as a$2 } from "./spatialReferenceEllipsoidUtils-DYnGRhN5.js";
import { t as a$3 } from "./GeographicTransformation-CMOdSadu.js";
import { r as C$2, t as o$2 } from "./projectBuffer-ecexZ2mO.js";
//#region node_modules/@arcgis/core/geometry/projection/projectXYZToVector.js
function t(r, t, f, c, i, m) {
	return e[0] = r, e[1] = t, e[2] = f, o$2(e, c, 0, i, m, 0);
}
var e = n$1();
//#endregion
...
async function F(n) {
	C ??= Promise.all([
		import("./projectOperator-CH5uykH-.js").then((n) => n.r).then((n) => (D = n, D.load())),
		import("./projectOperator-Dw1GROFE.js").then((n) => (W = n, W.load())),
		import("./geographicTransformationUtils-BjafyhKF.js").then((n) => (I = n, I.load()))
...
function J(n, e, r, t) {
	...
	return n[0].spatialReference || (n[0].spatialReference = e), n[0] instanceof s$1 ? D.executeMany(n, r, t) : W.executeMany(n, r, t);
}
function K(n, e) {
	return [
		n.wkid?.toString() ?? "-1",
...
function an(n$2, e, r) {
	return n$2 ? t$1(n$2) ? un(n$2, e, new _$1(), r, 0) : n(n$2) ? jn(n$2, e, new z(), r, 0) : o$1(n$2) ? gn(n$2, e, new j(), r, 0) : e$1(n$2) ? mn(n$2, e, new y(), r, 0) : i$1(n$2) ? fn(n$2, e, new m(), r, 0) : null : null;
}
...
function un(n, e, r, t, o) {
	wn[0] = n.x, wn[1] = n.y;
	const i = n.z;
	return wn[2] = void 0 !== i ? i : o, o$2(wn, e, 0, wn, t, 0) ? (r.x = wn[0], r.y = wn[1], r.spatialReference = t, void 0 !== i || O$2(t) ? (r.z = wn[2], r.hasZ = !0) : (r.z = void 0, r.hasZ = !1), void 0 === n.m ? (r.m = void 0, r.hasM = !1) : (r.m = n.m, r.hasM = !0), r) : null;
}
...
function fn(n, e, r, t, o) {
	...
	if (!o$2(c, e, 0, c, t, 0, u)) return null;
	const f = xn(s, t);
	for (let p = 0; p < u; ++p) {
...
//# sourceMappingURL=projectionUtils-ByFpjmtW.js.map