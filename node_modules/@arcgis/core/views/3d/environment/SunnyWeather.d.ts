...
export interface SunnyWeatherProperties extends Partial<Pick<SunnyWeather, "cloudCover">> {}
 ...
 */
export default class SunnyWeather extends JSONSupport {
  constructor(properties?: SunnyWeatherProperties);
  /**
