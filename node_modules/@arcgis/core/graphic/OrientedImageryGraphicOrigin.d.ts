...
/**
 * Provides information about the [OrientedImageryLayer](https://developers.arcgis.com/javascript/latest/references/core/layers/OrientedImageryLayer/) from which a graphic originates.
 ...
 * [hitTest()](https://developers.arcgis.com/javascript/latest/references/core/views/MapView/#hitTest) or [queryFeatures()](https://developers.arcgis.com/javascript/latest/references/core/layers/OrientedImageryLayer/#queryFeatures).
 *
 * @since 5.0
 ...
 * @see [OrientedImageryLayer.queryFeatures()](https://developers.arcgis.com/javascript/latest/references/core/layers/OrientedImageryLayer/#queryFeatures)
 * @example
 ...
 *  });
 */
export default class OrientedImageryGraphicOrigin extends GraphicOrigin {
  constructor(layer: OrientedImageryLayer);
  /** A layer from which a graphic originates. */
  readonly layer: OrientedImageryLayer;
  /**
   * Indicates the type of layer the graphic originated from.
   *
   * @default "oriented-imagery"
   */
  readonly type: OrientedImageryLayer["type"];
}