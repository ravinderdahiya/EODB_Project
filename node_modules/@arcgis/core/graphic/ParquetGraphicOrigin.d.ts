...
/**
 * Provides information about the [ParquetLayer](https://developers.arcgis.com/javascript/latest/references/core/layers/ParquetLayer/) from which a graphic originates.
 ...
 *  });
 */
export default class ParquetGraphicOrigin extends GraphicOrigin {
  constructor(layer: ParquetLayer);
  /** A layer from which a graphic originates. */
  readonly layer: ParquetLayer;
  /**
   * Indicates the type of layer the graphic originated from.
   *
   * @default "parquet"
   */
  readonly type: ParquetLayer["type"];
}