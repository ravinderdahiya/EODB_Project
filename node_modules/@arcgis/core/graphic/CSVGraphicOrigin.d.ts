...
/**
 * Provides information about the [CSVLayer](https://developers.arcgis.com/javascript/latest/references/core/layers/CSVLayer/) from which a graphic originates.
 ...
 * [hitTest()](https://developers.arcgis.com/javascript/latest/references/core/views/MapView/#hitTest) or [queryFeatures()](https://developers.arcgis.com/javascript/latest/references/core/layers/CSVLayer/#queryFeatures).
 *
 * @since 5.0
 ...
 * @see [CSVLayerView.queryFeatures()](https://developers.arcgis.com/javascript/latest/references/core/views/layers/CSVLayerView/#queryFeatures)
 * @example
